...
type cb_1 from w_reinscripcion_2014`cb_1 within w_preinscripción_2014
integer y = 1904
end type

type dw_pase_ingreso from w_reinscripcion_2014`dw_pase_ingreso within w_preinscripción_2014
end type

type st_inic from w_reinscripcion_2014`st_inic within w_preinscripción_2014
integer y = 1976
end type
...
type dw_mat_pase_ingreso from w_reinscripcion_2014`dw_mat_pase_ingreso within w_preinscripción_2014
integer y = 2048
end type
...
event uo_nombre::constructor;m_preinscripcion_2014.objeto = this
dw_nombre_alumno.settransobject(sqlca)
dw_nombre_alumno.insertrow(0)
iw_ventana = parent

end event

type dw_grupos_disponibles from w_reinscripcion_2014`dw_grupos_disponibles within w_preinscripción_2014
integer x = 343
integer y = 852
end type
...
string dataobject = "dw_mat_preinscritas_2014"
