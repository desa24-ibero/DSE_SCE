...
type cb_1 from commandbutton within w_reinscripcion
end type
type dw_pase_ingreso from datawindow within w_reinscripcion
end type
type p_uia from picture within w_reinscripcion
end type
type st_inic from statictext within w_reinscripcion
end type
...
type dw_mat_pase_ingreso from datawindow within w_reinscripcion
end type
type dw_grupos_disponibles from datawindow within w_reinscripcion
end type
