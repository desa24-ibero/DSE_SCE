...
type cb_1 from w_reinscripcion`cb_1 within w_preinscripción
end type

type dw_pase_ingreso from w_reinscripcion`dw_pase_ingreso within w_preinscripción
end type

type p_uia from w_reinscripcion`p_uia within w_preinscripción
end type

type st_inic from w_reinscripcion`st_inic within w_preinscripción
end type
...
type dw_mat_pase_ingreso from w_reinscripcion`dw_mat_pase_ingreso within w_preinscripción
end type

type dw_grupos_disponibles from w_reinscripcion`dw_grupos_disponibles within w_preinscripción
end type
