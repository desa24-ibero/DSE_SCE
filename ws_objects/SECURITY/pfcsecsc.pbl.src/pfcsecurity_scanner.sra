...
inv_trans.DBMS = ProfileString(ls_ini_file,"SCE_Database","DBMS", "NA")
...
inv_trans.Database		= ProfileString(ls_ini_file,"SCE_Database","DataBase",         " ")
inv_trans.LogID			= ProfileString(ls_ini_file,"SCE_Database","LogID",            " ")
inv_trans.LogPass			= ProfileString(ls_ini_file,"SCE_Database","LogPass",      " ")
inv_trans.ServerName		= ProfileString(ls_ini_file,"SCE_Database","ServerName",       " ")
inv_trans.UserID			= ProfileString(ls_ini_file,"SCE_Database","UserID",           " ")
inv_trans.DBPass			= ProfileString(ls_ini_file,"SCE_Database","DatabasePassword", " ")
inv_trans.Lock				= ProfileString(ls_ini_file,"SCE_Database","Lock",             " ")
inv_trans.DbParm			= ProfileString(ls_ini_file,"SCE_Database","DbParm",           " ")
