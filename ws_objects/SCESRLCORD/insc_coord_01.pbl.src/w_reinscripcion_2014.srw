...
/*
//	Oscar Sánchez, 14 Dic 2019.	La variable gi_nivel usuario no tiene un uso practico para coordinadores, se quitan las referencias a la variable
...
*/
	...
	//	Oscar Sánchez, 14 Dic 2019.	A solicitud de Fantine, se eliminan todas las referencias a la tabla activacion_su y se reemplazan por referencias a la tabla activacion
	 SELECT activacion.nivel    //Revisa el nivel actual de inscripción
         INTO :niv  
      FROM activacion  
		WHERE tipo_periodo = :gs_tipo_periodo ;
...
*/
	 ...
	 */
	 ...
	 SELECT activacion.tipo_inscripcion  
     	    INTO :tipo_insc  
	 FROM activacion  
	 WHERE tipo_periodo = :gs_tipo_periodo;
...
//	Oscar Sánchez, 11 Dic 2019.	A solicitud de Fantine, se eliminan todas las referencias a la tabla activacion_su y se reemplazan por referencias a la tabla activacion
//	Oscar Sánchez, 11 Dic 2019.	Los coordinadores tienen permitido exceder cupo ...

/* El siguiente bloque fue puesto en comentarios por: Oscar Sánchez, 11 Dic 2019
cont = 0
intento:
 if gi_nivel_usuario > 10 then   
...
SELECT activacion.materias_encimadas  
		INTO :mat_enci
FROM activacion  
WHERE tipo_periodo = :gs_tipo_periodo;
...
/*
//	Oscar Sánchez, 14 Dic 2019.	La variable g_nivel usuario no tiene un uso practico para coordinadores, se quitan las referencias a la variable
if gi_nivel_usuario < 10 then
...
intento:
	...
	INTO :tipo_insc, :permit  
	FROM activacion_su  
	WHERE tipo_periodo = :gs_tipo_periodo;
	*/
	SELECT activacion.tipo_inscripcion,   
    	activacion.bajas_periodo_distinto  
	INTO :tipo_insc, :permit  
	FROM activacion  
	WHERE tipo_periodo = :gs_tipo_periodo;
	if sqlca.sqlcode <> 0 then
...
/*
//	Oscar Sánchez, 14 Dic 2019.	Los coordinadores no pueden forzar la baja de una materia de un periodo distinto (tabla activacion.bajas_periodo_distinto)
if permit = 1 then 
	return 0		
else
*/
...
SELECT pregunta_nip INTO :li_pregunta_nip FROM activacion WHERE tipo_periodo = :gs_tipo_periodo;
if sqlca.sqlcode <> 0 then
	messagebox("Error de Comunicación","Error con la consulta de activacion BD. Favor de intentar nuevamente", None!)
	return -1
end if
...
//	Oscar Sánchez, 14 Dic 2019.	La variable gi_nivel usuario no tiene un uso practico para coordinadores, se quitan las referencias a la variable
if gi_nivel_usuario >= 10 then 
	SELECT revisa_grupos_bloqueados 
	INTO :i_revisa_grupos_bloqueados 
	FROM activacion_su
	WHERE tipo_periodo = :gs_tipo_periodo;
	if sqlca.sqlcode <> 0 then
		messagebox("Error de Comunicación","Error con la consulta de activacion_su BD. Favor de intentar nuevamente", None!)
...
//		commit;
//		
//		// Se agregan las areas 8977, 8978, 8979, 8990 que corresponden a Tijuana (Cambio Temporal)  
...
////   	 FROM area_mat  
////    WHERE area_mat.cve_mat = :mat 
////	 AND area_mat.cve_area  IN (8061, 8062, 8063, 8064, 2200, 2201, 2202, 2203, 2204, 2205, 335,336)
////	 ; //Revisión del area de la materia a inscribir
////	 
////	revisa_rows()			//verifica que el error no se deba a exceso de renglones
////	 
...
if cuenta > 0 then
	...
	*/
	...
	SELECT revisa_teoria_lab INTO :li_revisa_teoria_lab FROM activacion WHERE tipo_periodo = :gs_tipo_periodo;
	if sqlca.sqlcode <> 0 then
		messagebox("Error de Comunicación","Error con la consulta de activacion BD. Favor de intentar nuevamente", None!)
		return 1
	end if
...
public subroutine wf_establece_integracion (boolean ab_es_coordinacion_integ_ru);boolean lb_bandera = false
...
if isvalid(m_preinscripcion_2014) then
	m_preinscripcion_2014.m_integracin.visible = lb_bandera
	m_preinscripcion_2014.m_integracin.m_temafundamental.visible = lb_bandera
	m_preinscripcion_2014.m_integracin.m_temai.visible = lb_bandera
	m_preinscripcion_2014.m_integracin.m_temaii.visible = lb_bandera
	m_preinscripcion_2014.m_integracin.m_temaiii.visible = lb_bandera
	m_preinscripcion_2014.m_integracin.m_temaiv.visible = lb_bandera
	
	m_preinscripcion_2014.m_integracin.ToolbarItemVisible = lb_bandera
	m_preinscripcion_2014.m_integracin.m_temafundamental.ToolbarItemVisible	 = lb_bandera
	m_preinscripcion_2014.m_integracin.m_temai.ToolbarItemVisible	 = lb_bandera
	m_preinscripcion_2014.m_integracin.m_temaii.ToolbarItemVisible	 = lb_bandera
	m_preinscripcion_2014.m_integracin.m_temaiii.ToolbarItemVisible	 = lb_bandera
	m_preinscripcion_2014.m_integracin.m_temaiv.ToolbarItemVisible	 = lb_bandera

	m_preinscripcion_2014.m_integracin.enabled = lb_bandera

elseif isvalid (m_reinscripcion_2014) then
	m_reinscripcion_2014.m_integracin.visible = lb_bandera
	m_reinscripcion_2014.m_integracin.m_temafundamental.visible = lb_bandera
	m_reinscripcion_2014.m_integracin.m_temai.visible = lb_bandera
	m_reinscripcion_2014.m_integracin.m_temaii.visible = lb_bandera
	m_reinscripcion_2014.m_integracin.m_temaiii.visible = lb_bandera
	m_reinscripcion_2014.m_integracin.m_temaiv.visible = lb_bandera
	
	m_reinscripcion_2014.m_integracin.ToolbarItemVisible = lb_bandera
	m_reinscripcion_2014.m_integracin.m_temafundamental.ToolbarItemVisible = lb_bandera
	m_reinscripcion_2014.m_integracin.m_temai.ToolbarItemVisible = lb_bandera
	m_reinscripcion_2014.m_integracin.m_temaii.ToolbarItemVisible = lb_bandera
	m_reinscripcion_2014.m_integracin.m_temaiii.ToolbarItemVisible = lb_bandera
	m_reinscripcion_2014.m_integracin.m_temaiv.ToolbarItemVisible = lb_bandera

	m_reinscripcion_2014.m_integracin.enabled = lb_bandera
...
if gs_nivel_coordinacion = 'L' then
	dw_cursada.dataobject = "dw_cursada"
else
	dw_cursada.dataobject = "dw_cursada_pos"
end if
...
string text = "Otoño 2017  06/11/17"
boolean focusrectangle = false
end type
...
INTO :ll_cve_area_integ_fundamental, :ll_cve_area_integ_tema1,  :ll_cve_area_integ_tema2,  :ll_cve_area_integ_tema3,  :ll_cve_area_integ_tema4 
FROM plan_estudios 
...
//	else
//		choose case area
//				// Se agregan los casos 8977, 8978, 8979, 8990 para considerar 
//			case 2201, 8977, 8978, 8979, 8990
//				numarea = "fundamental"
//				dw_mat_integ.title ="Grupos disponibles para materias de Integración"
//			case 2202
