$PBExportHeader$w_revision_estudios_rediseño.srw
forward
global type w_revision_estudios_rediseño from window
end type
type st_17 from statictext within w_revision_estudios_rediseño
end type
type st_16 from statictext within w_revision_estudios_rediseño
end type
type st_guion from statictext within w_revision_estudios_rediseño
end type
type em_final from editmask within w_revision_estudios_rediseño
end type
type em_inicial from editmask within w_revision_estudios_rediseño
end type
type cbx_intervalo from checkbox within w_revision_estudios_rediseño
end type
type st_regularizacion from statictext within w_revision_estudios_rediseño
end type
type cbx_legal from checkbox within w_revision_estudios_rediseño
end type
type em_fecha from editmask within w_revision_estudios_rediseño
end type
type st_nivel from statictext within w_revision_estudios_rediseño
end type
type em_numero from editmask within w_revision_estudios_rediseño
end type
type st_con_fecha from statictext within w_revision_estudios_rediseño
end type
type rb_expediente from radiobutton within w_revision_estudios_rediseño
end type
type rb_folio from radiobutton within w_revision_estudios_rediseño
end type
type rb_oficio from radiobutton within w_revision_estudios_rediseño
end type
type st_prerrequisito from statictext within w_revision_estudios_rediseño
end type
type st_plan from statictext within w_revision_estudios_rediseño
end type
type st_carrera from statictext within w_revision_estudios_rediseño
end type
type st_subsistema from statictext within w_revision_estudios_rediseño
end type
type st_18 from statictext within w_revision_estudios_rediseño
end type
type st_15 from statictext within w_revision_estudios_rediseño
end type
type st_14 from statictext within w_revision_estudios_rediseño
end type
type st_1 from statictext within w_revision_estudios_rediseño
end type
type uo_1 from uo_nombre_alumno within w_revision_estudios_rediseño
end type
type cb_2 from commandbutton within w_revision_estudios_rediseño
end type
type st_13 from statictext within w_revision_estudios_rediseño
end type
type st_12 from statictext within w_revision_estudios_rediseño
end type
type st_11 from statictext within w_revision_estudios_rediseño
end type
type st_10 from statictext within w_revision_estudios_rediseño
end type
type st_9 from statictext within w_revision_estudios_rediseño
end type
type st_8 from statictext within w_revision_estudios_rediseño
end type
type st_7 from statictext within w_revision_estudios_rediseño
end type
type st_6 from statictext within w_revision_estudios_rediseño
end type
type st_5 from statictext within w_revision_estudios_rediseño
end type
type st_4 from statictext within w_revision_estudios_rediseño
end type
type st_3 from statictext within w_revision_estudios_rediseño
end type
type st_2 from statictext within w_revision_estudios_rediseño
end type
type dw_revision_est_fmc from datawindow within w_revision_estudios_rediseño
end type
type dw_prueba from datawindow within w_revision_estudios_rediseño
end type
type gb_revalidacion from groupbox within w_revision_estudios_rediseño
end type
type r_1 from rectangle within w_revision_estudios_rediseño
end type
end forward
...
global w_revision_estudios_rediseño w_revision_estudios_rediseño
...
on w_revision_estudios_rediseño.destroy
if IsValid(MenuID) then destroy(MenuID)
destroy(this.st_17)
destroy(this.st_16)
destroy(this.st_guion)
destroy(this.em_final)
destroy(this.em_inicial)
destroy(this.cbx_intervalo)
...
rev = hist_alumno_areas_plantel(cue,car,pla,sub,dw_prueba, dw_revision_est_fmc,nivel)
...
long backcolor = 16777215
boolean enabled = false
string text = "Síntesis Eval Optl."
boolean border = true
borderstyle borderstyle = stylelowered!
boolean focusrectangle = false
end type
...
string facename = "Arial"
long backcolor = 12632256
string text = "Intervalo de Años"
boolean lefttext = true
end type

event clicked;if this.checked then
	em_inicial.visible = true
	em_final.visible = true
	st_guion.visible = true
else
	em_inicial.visible = false
	em_final.visible = false
	st_guion.visible = false	
end if
...
event clicked;long ll_row_count

ll_row_count = dw_prueba.rowcount()

if ll_row_count >= 2 then
	open(w_opciones_imprimir_rediseño,w_revision_estudios_rediseño)
...
string facename = "Arial"
long backcolor = 12632256
string text = "Materias equivalentes según "
end type
