$PBExportHeader$w_genera_bloque_certificados.srw
forward
global type w_genera_bloque_certificados from w_main
end type
type rb_ambos_origen from radiobutton within w_genera_bloque_certificados
end type
type rb_ventanilla from radiobutton within w_genera_bloque_certificados
end type
type rb_internet from radiobutton within w_genera_bloque_certificados
end type
type rb_ambos_papeleria from radiobutton within w_genera_bloque_certificados
end type
type rb_simple from radiobutton within w_genera_bloque_certificados
end type
type rb_legalizado from radiobutton within w_genera_bloque_certificados
end type
type rb_ambos from radiobutton within w_genera_bloque_certificados
end type
type rb_posgrado from radiobutton within w_genera_bloque_certificados
end type
type rb_licenciatura from radiobutton within w_genera_bloque_certificados
end type
type cb_genera from u_cb within w_genera_bloque_certificados
end type
type cb_cargar from u_cb within w_genera_bloque_certificados
end type
type dw_1 from uo_dw_reporte within w_genera_bloque_certificados
end type
type st_2 from statictext within w_genera_bloque_certificados
end type
type st_1 from statictext within w_genera_bloque_certificados
end type
type em_fecha_final from u_em within w_genera_bloque_certificados
end type
type em_fecha_inicial from u_em within w_genera_bloque_certificados
end type
type gb_1 from groupbox within w_genera_bloque_certificados
end type
type gb_3 from groupbox within w_genera_bloque_certificados
end type
type rb_totales from radiobutton within w_genera_bloque_certificados
end type
type rb_parciales from radiobutton within w_genera_bloque_certificados
end type
type rb_todos from radiobutton within w_genera_bloque_certificados
end type
type gb_2 from groupbox within w_genera_bloque_certificados
end type
type gb_4 from groupbox within w_genera_bloque_certificados
end type
end forward
...
integer width = 3104
integer height = 1784
string title = "Generación de Bloque de Certificados"
...
global w_genera_bloque_certificados w_genera_bloque_certificados
...
on w_genera_bloque_certificados.create
int iCurrent
call super::create
...
this.Control[iCurrent+1]=this.rb_ambos_origen
this.Control[iCurrent+2]=this.rb_ventanilla
this.Control[iCurrent+3]=this.rb_internet
this.Control[iCurrent+4]=this.rb_ambos_papeleria
this.Control[iCurrent+5]=this.rb_simple
this.Control[iCurrent+6]=this.rb_legalizado
...
this.Control[iCurrent+10]=this.cb_genera
this.Control[iCurrent+11]=this.cb_cargar
this.Control[iCurrent+12]=this.dw_1
this.Control[iCurrent+13]=this.st_2
this.Control[iCurrent+14]=this.st_1
this.Control[iCurrent+15]=this.em_fecha_final
this.Control[iCurrent+16]=this.em_fecha_inicial
this.Control[iCurrent+17]=this.gb_1
this.Control[iCurrent+18]=this.gb_3
this.Control[iCurrent+19]=this.rb_totales
this.Control[iCurrent+20]=this.rb_parciales
this.Control[iCurrent+21]=this.rb_todos
this.Control[iCurrent+22]=this.gb_2
this.Control[iCurrent+23]=this.gb_4
end on

on w_genera_bloque_certificados.destroy
call super::destroy
...
integer li_aplica_pago = 1, li_egresa_completos = 1
...
ll_certificados_generados= iuo_reporte_dw.f_genera_bloque_certificados(ldttm_fecha_inicial, ldttm_fecha_final,ii_cve_doc_control_sep, is_nivel, ii_legalizado,ii_origen_internet)
if ll_certificados_generados>0 then
//2018-01-25	
//	ll_certificados_impresos= iuo_reporte_dw.f_imprime_bloque_certificados(ldttm_fecha_inicial, ldttm_fecha_final, ii_cve_doc_control_sep, is_nivel, ii_legalizado, ii_origen_internet, li_aplica_pago, li_egresa_completos)
...
string dataobject = "d_reporte_bloque_certificados"
