$PBExportHeader$w_genera_bloque_cert_sin_status_redis.srw
forward
global type w_genera_bloque_cert_sin_status_redis from w_main
end type
type cbx_actualiza_fechas from checkbox within w_genera_bloque_cert_sin_status_redis
end type
type cb_1 from u_cb within w_genera_bloque_cert_sin_status_redis
end type
type rb_ambos_origen from radiobutton within w_genera_bloque_cert_sin_status_redis
end type
type rb_ventanilla from radiobutton within w_genera_bloque_cert_sin_status_redis
end type
type rb_internet from radiobutton within w_genera_bloque_cert_sin_status_redis
end type
type rb_ambos_papeleria from radiobutton within w_genera_bloque_cert_sin_status_redis
end type
type rb_simple from radiobutton within w_genera_bloque_cert_sin_status_redis
end type
type rb_legalizado from radiobutton within w_genera_bloque_cert_sin_status_redis
end type
type rb_ambos from radiobutton within w_genera_bloque_cert_sin_status_redis
end type
type rb_posgrado from radiobutton within w_genera_bloque_cert_sin_status_redis
end type
type rb_licenciatura from radiobutton within w_genera_bloque_cert_sin_status_redis
end type
type cb_genera from u_cb within w_genera_bloque_cert_sin_status_redis
end type
type cb_cargar from u_cb within w_genera_bloque_cert_sin_status_redis
end type
type dw_1 from uo_dw_reporte within w_genera_bloque_cert_sin_status_redis
end type
type st_2 from statictext within w_genera_bloque_cert_sin_status_redis
end type
type st_1 from statictext within w_genera_bloque_cert_sin_status_redis
end type
type em_fecha_final from u_em within w_genera_bloque_cert_sin_status_redis
end type
type em_fecha_inicial from u_em within w_genera_bloque_cert_sin_status_redis
end type
type gb_1 from groupbox within w_genera_bloque_cert_sin_status_redis
end type
type gb_3 from groupbox within w_genera_bloque_cert_sin_status_redis
end type
type rb_totales from radiobutton within w_genera_bloque_cert_sin_status_redis
end type
type rb_parciales from radiobutton within w_genera_bloque_cert_sin_status_redis
end type
type rb_todos from radiobutton within w_genera_bloque_cert_sin_status_redis
end type
type gb_2 from groupbox within w_genera_bloque_cert_sin_status_redis
end type
type gb_4 from groupbox within w_genera_bloque_cert_sin_status_redis
end type
end forward
...
global w_genera_bloque_cert_sin_status_redis w_genera_bloque_cert_sin_status_redis
...
on w_genera_bloque_cert_sin_status_redis.create
int iCurrent
call super::create
...
on w_genera_bloque_cert_sin_status_redis.destroy
call super::destroy
...
if ll_certificados_generados>0 then	
	ll_certificados_impresos= iuo_reporte_dw.f_imprime_bloque_cert_sin_status_redis(ldttm_fecha_inicial, ldttm_fecha_final, ii_cve_doc_control_sep, is_nivel, ii_legalizado, ii_origen_internet, li_aplica_pago, li_egresa_completos, li_actualiza_fechas)
