$PBExportHeader$w_asignacion_hologramas_cert.srw
forward
global type w_asignacion_hologramas_cert from w_main
end type
type dw_3 from u_dw_captura within w_asignacion_hologramas_cert
end type
type dw_1 from u_dw_captura within w_asignacion_hologramas_cert
end type
type dw_2 from u_dw_captura within w_asignacion_hologramas_cert
end type
end forward
...
integer width = 3383
integer height = 1814
string title = "Asignación de Hologramas a Certificados"
...
global w_asignacion_hologramas_cert w_asignacion_hologramas_cert

type variables
string is_orden_cobro
long il_cve_relacion, il_cve_tipo_relacion, il_row, ii_num_docs_existentes_total
long il_holograma_inicial, il_cve_doc_control_sep
end variables

on w_asignacion_hologramas_cert.create
int iCurrent
call super::create
...
on w_asignacion_hologramas_cert.destroy
call super::destroy
...
integer height = 701
integer taborder = 10
string dataobject = "d_relacion_consulta_cert"
boolean hscrollbar = true
end type
...
long ll_cve_relacion, ll_holograma_inicial, ll_cve_doc_control_sep
string ls_orden_cobro

string ls_dw_fechas = "d_atendidos_cert_fechas"
...
IF row > 0 THEN
	...
	ll_cve_doc_control_sep = this.GetItemNumber(row,"relacion_documentos_cve_doc_control_sep")
	...
	IF li_confirmación = 1 THEN
		...
		dw_3.Reset()
		IF li_cve_tipo_relacion = 1 or li_cve_tipo_relacion = 4 THEN
...
integer height = 310
integer taborder = 20
string dataobject = "d_atendidos_cert_fechas"
boolean hscrollbar = true
end type
...
li_cve_doc_control_sep=il_cve_doc_control_sep
...
li_siguiente_holograma= of_obten_siguiente_holog_n2(li_cve_doc_control_sep, rowcount, ll_hologramas,il_holograma_inicial )
