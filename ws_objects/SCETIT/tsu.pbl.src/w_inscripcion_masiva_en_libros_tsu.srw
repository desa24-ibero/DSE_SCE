$PBExportHeader$w_inscripcion_masiva_en_libros_tsu.srw
forward
global type w_inscripcion_masiva_en_libros_tsu from w_main
end type
type cb_inscribir from u_cb within w_inscripcion_masiva_en_libros_tsu
end type
type cb_cargar from u_cb within w_inscripcion_masiva_en_libros_tsu
end type
type dw_1 from uo_dw_reporte within w_inscripcion_masiva_en_libros_tsu
end type
type st_2 from statictext within w_inscripcion_masiva_en_libros_tsu
end type
type st_1 from statictext within w_inscripcion_masiva_en_libros_tsu
end type
type em_fecha_final from u_em within w_inscripcion_masiva_en_libros_tsu
end type
type em_fecha_inicial from u_em within w_inscripcion_masiva_en_libros_tsu
end type
end forward
...
global w_inscripcion_masiva_en_libros_tsu w_inscripcion_masiva_en_libros_tsu

on w_inscripcion_masiva_en_libros_tsu.create
int iCurrent
call super::create
...
on w_inscripcion_masiva_en_libros_tsu.destroy
call super::destroy
...
if li_confirmacion= 1 then
	...
	FOR ll_row = 1 to ll_rows_totales
		...
		if ll_cuenta>0 and ll_cve_carrera>0 and ll_cve_plan>0 then
			li_insercion= luo_atencion_tsu.of_inserta_hoja_libro_carrera(ll_cuenta,ll_cve_carrera, ll_cve_plan )
...
integer height = 1052
integer taborder = 30
string dataobject = "d_inscripcion_masiva_en_libros_tsu"
