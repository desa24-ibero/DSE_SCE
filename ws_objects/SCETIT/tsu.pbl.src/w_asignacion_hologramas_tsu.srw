$PBExportHeader$w_asignacion_hologramas_tsu.srw
forward
global type w_asignacion_hologramas_tsu from w_main
end type
type dw_3 from u_dw_captura within w_asignacion_hologramas_tsu
end type
type dw_1 from u_dw_captura within w_asignacion_hologramas_tsu
end type
type dw_2 from u_dw_captura within w_asignacion_hologramas_tsu
end type
end forward
...
integer width = 3383
integer height = 1816
string title = "Asignación de Hologramas a Opción Cero TSU"
...
global w_asignacion_hologramas_tsu w_asignacion_hologramas_tsu
...
on w_asignacion_hologramas_tsu.create
int iCurrent
call super::create
...
on w_asignacion_hologramas_tsu.destroy
call super::destroy
...
string ls_dw_fechas = "d_atendidos_opc_cero_fechas_tsu"
...
integer height = 312
integer taborder = 20
string dataobject = "d_atendidos_opc_cero_fechas_tsu"
boolean hscrollbar = true
end type
