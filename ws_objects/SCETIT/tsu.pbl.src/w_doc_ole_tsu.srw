$PBExportHeader$w_doc_ole_tsu.srw
forward
global type w_doc_ole_tsu from w_main
end type
type uo_datos_tsu_i from uo_datos_tsu within w_doc_ole_tsu
end type
type cb_seleccion from commandbutton within w_doc_ole_tsu
end type
type st_3 from statictext within w_doc_ole_tsu
end type
type uo_tipo_documento from uo_clase_documento within w_doc_ole_tsu
end type
type ole_documento from u_oc_impresion_word within w_doc_ole_tsu
end type
type dw_documento_titulacion from u_dw within w_doc_ole_tsu
end type
end forward
...
global w_doc_ole_tsu w_doc_ole_tsu
...
string binarykey = "w_doc_ole_tsu.win"
end type
