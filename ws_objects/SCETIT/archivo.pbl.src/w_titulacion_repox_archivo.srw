...
forward
global type w_titulacion_repox_archivo from w_master_main_rep
end type
...
li_result = tab_1.tabpage_opcion.uo_nivel_3.of_carga_arreglo_nivel( )
tab_1.tabpage_opcion.uo_nivel_3.of_obtiene_array(ls_array_aux[])
