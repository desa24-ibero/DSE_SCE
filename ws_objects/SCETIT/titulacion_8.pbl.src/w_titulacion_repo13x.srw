$PBExportHeader$w_titulacion_repo13x.srw
$PBExportComments$Esta ventana ofrece el reporte de Alumnos con Proceso Cancelado en titulacion
forward
global type w_titulacion_repo13x from w_master_main_rep
end type
type tab_1 from tab within w_titulacion_repo13x
end type
...
integer width = 3822
integer height = 3008
string title = "Reportes de Alumnos con Proceso de Titulación Cancelado"
string menuname = "m_titulacion2"
boolean resizable = true
tab_1 tab_1
end type
global w_titulacion_repo13x w_titulacion_repo13x

type variables
int carrerax
end variables

on w_titulacion_repo13x.create
int iCurrent
call super::create
...
on w_titulacion_repo13x.destroy
call super::destroy
...
type st_sistema from w_master_main_rep`st_sistema within w_titulacion_repo13x
end type

type p_ibero from w_master_main_rep`p_ibero within w_titulacion_repo13x
end type
...
integer height = 364
integer taborder = 5
string dataobject = "dw_tit_cuenta13"
...
integer height = 1724
integer taborder = 5
string dataobject = "dw_titulacion_rep13"
boolean resizable = true
end type
...
integer height = 308
integer taborder = 4
string dataobject = "dw_tit_cuenta13x"
boolean livescroll = true
end type
...
integer height = 1748
integer taborder = 4
string dataobject = "dw_titulacion_rep13x"
boolean resizable = true
end type
