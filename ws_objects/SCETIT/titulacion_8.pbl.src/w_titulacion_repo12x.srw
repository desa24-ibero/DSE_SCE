$PBExportHeader$w_titulacion_repo12x.srw
$PBExportComments$Esta ventana ofrece el reporte de Alumnos Suspendidos en titulacion
forward
global type w_titulacion_repo12x from w_master_main_rep
end type
type tab_1 from tab within w_titulacion_repo12x
end type
...
integer width = 3963
integer height = 3008
string title = "Reportes de Alumnos Suspendidos"
string menuname = "m_titulacion2"
boolean resizable = true
tab_1 tab_1
end type
global w_titulacion_repo12x w_titulacion_repo12x

type variables
int carrerax
end variables

on w_titulacion_repo12x.create
int iCurrent
call super::create
...
on w_titulacion_repo12x.destroy
call super::destroy
...
type st_sistema from w_master_main_rep`st_sistema within w_titulacion_repo12x
end type

type p_ibero from w_master_main_rep`p_ibero within w_titulacion_repo12x
end type
...
integer height = 364
integer taborder = 5
string dataobject = "dw_tit_cuenta12"
...
integer height = 1744
integer taborder = 5
string dataobject = "dw_titulacion_rep12"
end type
...
integer height = 428
integer taborder = 4
string dataobject = "dw_tit_cuenta12x"
boolean livescroll = true
end type
...
integer height = 1748
integer taborder = 4
string dataobject = "dw_titulacion_rep12x"
end type
