$PBExportHeader$w_titulacion_etix.srw
$PBExportComments$Esta ventana ofrece etiquetas de los alumnos titulados con Mención.
forward
global type w_titulacion_etix from w_master_main_rep
end type
type tab_1 from tab within w_titulacion_etix
end type
...
integer width = 3840
integer height = 2580
string title = "Impresion de Etiquetas de los Alumnos con Mención Honorífica"
string menuname = "m_titulacion"
boolean resizable = true
tab_1 tab_1
end type
global w_titulacion_etix w_titulacion_etix

type variables
int carrerax
end variables

on w_titulacion_etix.create
int iCurrent
call super::create
...
type st_sistema from w_master_main_rep`st_sistema within w_titulacion_etix
end type

type p_ibero from w_master_main_rep`p_ibero within w_titulacion_etix
end type
...
if (rb_3.checked=TRUE) then
   dw_1.setsort("cfecha_examen A")
	dw_1.sort()
	if (cbx_2.checked=TRUE) then
      dw_1.setsort("carreras_carrera A, cfecha_examen A")
		dw_1.sort()
	end if	
end if
...
integer height = 1076
integer taborder = 5
string dataobject = "dw_etiqueta_tit_nvo"
...
integer height = 1284
integer taborder = 4
string dataobject = "dw_etiqueta_titx_nvo"
boolean hscrollbar = true
boolean vscrollbar = true
end type
