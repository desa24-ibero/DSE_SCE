$PBExportHeader$uo_relacion_tit_2013_e.sru
forward
global type uo_relacion_tit_2013_e from userobject
end type
type st_1 from statictext within uo_relacion_tit_2013_e
end type
type em_fecha_fin from editmask within uo_relacion_tit_2013_e
end type
type em_fecha_ini from editmask within uo_relacion_tit_2013_e
end type
type dw_relaciones from datawindow within uo_relacion_tit_2013_e
end type
type gb_1 from groupbox within uo_relacion_tit_2013_e
end type
end forward
...
global uo_relacion_tit_2013_e uo_relacion_tit_2013_e
...
If il_filtro_tipo_relacion > 0 Then
	if dwcRelacion.Retrieve(ar_i_anio, il_filtro_tipo_relacion) <= 0 then 
		//messagebox('Información', 'No existen Tipos')
		return -1
	else
...
on uo_relacion_tit_2013_e.create
...
on uo_relacion_tit_2013_e.destroy
destroy(this.st_1)
