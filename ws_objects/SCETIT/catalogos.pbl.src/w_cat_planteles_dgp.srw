$PBExportHeader$w_cat_planteles_dgp.srw
forward
global type w_cat_planteles_dgp from w_catalogo_ancestro
end type
end forward
...
integer width = 3003
integer height = 1092
string title = "Catalogo de Planteles Claves DGP"
string menuname = "m_cat_carreras_ant_nvo"
boolean resizable = false
long backcolor = 16777215
end type
global w_cat_planteles_dgp w_cat_planteles_dgp

on w_cat_planteles_dgp.create
call super::create
if IsValid(this.MenuID) then destroy(this.MenuID)
if this.MenuName = "m_cat_carreras_ant_nvo" then this.MenuID = create m_cat_carreras_ant_nvo
end on

on w_cat_planteles_dgp.destroy
call super::destroy
...
type dw_catalogo from w_catalogo_ancestro`dw_catalogo within w_cat_planteles_dgp
...
integer width = 2939
integer height = 876
string dataobject = "dw_cat_planteles_dgp"
