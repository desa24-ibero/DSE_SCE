...
IF gs_plantel = "PLANTEL CIUDAD DE MÉXICO" THEN 
	dw_key.MODIFY("plan_estudios_plan_estatal.protect = 1")
	dw_key.SETITEM(1, "plan_estudios_plan_estatal", 0)
END IF 	
...
if not f_existe_plan_2(plan)  then
