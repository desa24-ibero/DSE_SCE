$PBExportHeader$w_inscripcion_masiva_en_lib_pos_rg.srw
forward
global type w_inscripcion_masiva_en_lib_pos_rg from w_main
end type
type cb_inscribir from u_cb within w_inscripcion_masiva_en_lib_pos_rg
end type
type cb_cargar from u_cb within w_inscripcion_masiva_en_lib_pos_rg
end type
type dw_1 from uo_dw_reporte within w_inscripcion_masiva_en_lib_pos_rg
end type
type st_2 from statictext within w_inscripcion_masiva_en_lib_pos_rg
end type
type st_1 from statictext within w_inscripcion_masiva_en_lib_pos_rg
end type
type em_fecha_final from u_em within w_inscripcion_masiva_en_lib_pos_rg
end type
type em_fecha_inicial from u_em within w_inscripcion_masiva_en_lib_pos_rg
end type
end forward
...
global w_inscripcion_masiva_en_lib_pos_rg w_inscripcion_masiva_en_lib_pos_rg

on w_inscripcion_masiva_en_lib_pos_rg.create
int iCurrent
call super::create
...
on w_inscripcion_masiva_en_lib_pos_rg.destroy
call super::destroy
...
if li_confirmacion= 1 then
	...
	FOR ll_row = 1 to ll_rows_totales
		...
		if ll_cuenta>0 and ll_cve_carrera>0 and ll_cve_plan>0 then
			li_insercion= luo_atencion_posgrado.of_inserta_hoja_libro_posg_rg(ll_cuenta,ll_cve_carrera, ll_cve_plan )
...
integer height = 1052
integer taborder = 30
string dataobject = "d_inscripcion_masiva_en_lib_pos_rg"
boolean border = true
