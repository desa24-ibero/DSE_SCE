$PBExportHeader$uo_nombre_alumno_posgrado.sru
...
forward
global type uo_nombre_alumno_posgrado from userobject
end type
type em_digito from editmask within uo_nombre_alumno_posgrado
end type
type st_2 from statictext within uo_nombre_alumno_posgrado
end type
type st_1 from statictext within uo_nombre_alumno_posgrado
end type
type r_2 from rectangle within uo_nombre_alumno_posgrado
end type
type dw_nombre_alumno from datawindow within uo_nombre_alumno_posgrado
end type
type r_3 from rectangle within uo_nombre_alumno_posgrado
end type
type cbx_nuevo from checkbox within uo_nombre_alumno_posgrado
end type
type r_1 from rectangle within uo_nombre_alumno_posgrado
end type
type em_cuenta from editmask within uo_nombre_alumno_posgrado
end type
end forward
...
global uo_nombre_alumno_posgrado uo_nombre_alumno_posgrado
...
on uo_nombre_alumno_posgrado.create
...
on uo_nombre_alumno_posgrado.destroy
