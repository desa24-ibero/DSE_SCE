$PBExportHeader$w_asignacion_hologramas_pos.srw
forward
global type w_asignacion_hologramas_pos from w_main
end type
type dw_3 from u_dw_captura within w_asignacion_hologramas_pos
end type
type dw_1 from u_dw_captura within w_asignacion_hologramas_pos
end type
type dw_2 from u_dw_captura within w_asignacion_hologramas_pos
end type
end forward
...
integer width = 3383
integer height = 1816
string title = "Asignación de Hologramas a Posgrado"
...
global w_asignacion_hologramas_pos w_asignacion_hologramas_pos
...
on w_asignacion_hologramas_pos.create
int iCurrent
call super::create
...
on w_asignacion_hologramas_pos.destroy
call super::destroy
...
integer height = 820
integer taborder = 20
string dataobject = "d_control_sep_asigna_holog_pos"
...
integer height = 700
integer taborder = 10
string dataobject = "d_relacion_consulta_pos"
boolean hscrollbar = true
end type
...
string ls_dw_fechas = "d_atendidos_posgrado_fechas"
...
integer height = 312
integer taborder = 20
string dataobject = "d_atendidos_posgrado_fechas"
boolean hscrollbar = true
end type
