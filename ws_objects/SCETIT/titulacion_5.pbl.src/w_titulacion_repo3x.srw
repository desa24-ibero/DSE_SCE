$PBExportHeader$w_titulacion_repo3x.srw
$PBExportComments$Esta ventana ofrece el reporte de Alumnos con mención para titulacion
forward
global type w_titulacion_repo3x from w_master_main_rep
end type
type tab_1 from tab within w_titulacion_repo3x
end type
...
integer width = 3808
integer height = 2452
string title = "Reportes de Alumnos Titulados con Mención Honorifica"
string menuname = "m_titulacion2"
boolean resizable = true
tab_1 tab_1
end type
global w_titulacion_repo3x w_titulacion_repo3x

type variables
int carrerax
end variables

on w_titulacion_repo3x.create
int iCurrent
call super::create
...
on w_titulacion_repo3x.destroy
call super::destroy
...
type st_sistema from w_master_main_rep`st_sistema within w_titulacion_repo3x
end type

type p_ibero from w_master_main_rep`p_ibero within w_titulacion_repo3x
end type
...
integer height = 364
integer taborder = 5
string dataobject = "dw_tit_cuenta3"
...
integer height = 1748
integer taborder = 5
string dataobject = "dw_titulacion_rep3"
boolean resizable = true
end type
...
integer height = 204
integer taborder = 4
string dataobject = "dw_tit_cuenta3x"
boolean livescroll = true
end type
...
integer height = 1744
integer taborder = 4
string dataobject = "dw_titulacion_rep3x"
boolean resizable = true
end type
