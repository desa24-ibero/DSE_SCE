$PBExportHeader$w_registra_entrega_titulo.srw
forward
global type w_registra_entrega_titulo from w_main
end type
type cb_registrar from commandbutton within w_registra_entrega_titulo
end type
type uo_datos_opc_cero_i from uo_datos_opc_cero within w_registra_entrega_titulo
end type
type cb_seleccion from commandbutton within w_registra_entrega_titulo
end type
type st_3 from statictext within w_registra_entrega_titulo
end type
type uo_tipo_documento from uo_clase_documento within w_registra_entrega_titulo
end type
type ole_documento from u_oc_impresion_word within w_registra_entrega_titulo
end type
type dw_documento_titulacion from u_dw within w_registra_entrega_titulo
end type
end forward
...
global w_registra_entrega_titulo w_registra_entrega_titulo
...
on w_registra_entrega_titulo.create
int iCurrent
call super::create
...
on w_registra_entrega_titulo.destroy
call super::destroy
...
string binarykey = "w_registra_entrega_titulo.win"
end type
...
03w_registra_entrega_titulo.bin 
...
13w_registra_entrega_titulo.bin 
