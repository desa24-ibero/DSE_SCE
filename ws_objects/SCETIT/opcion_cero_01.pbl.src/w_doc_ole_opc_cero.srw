$PBExportHeader$w_doc_ole_opc_cero.srw
forward
global type w_doc_ole_opc_cero from w_main
end type
type uo_datos_opc_cero_i from uo_datos_opc_cero within w_doc_ole_opc_cero
end type
type cb_seleccion from commandbutton within w_doc_ole_opc_cero
end type
type st_3 from statictext within w_doc_ole_opc_cero
end type
type uo_tipo_documento from uo_clase_documento within w_doc_ole_opc_cero
end type
type ole_documento from u_oc_impresion_word within w_doc_ole_opc_cero
end type
type dw_documento_titulacion from u_dw within w_doc_ole_opc_cero
end type
end forward
...
global w_doc_ole_opc_cero w_doc_ole_opc_cero
...
string binarykey = "w_doc_ole_opc_cero.win"
end type
