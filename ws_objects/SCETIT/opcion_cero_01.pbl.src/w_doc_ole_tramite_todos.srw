$PBExportHeader$w_doc_ole_tramite_todos.srw
forward
global type w_doc_ole_tramite_todos from w_main
end type
type uo_datos_opc_cero_i from uo_datos_opc_cero_sin_rev2 within w_doc_ole_tramite_todos
end type
type cb_seleccion from commandbutton within w_doc_ole_tramite_todos
end type
type st_3 from statictext within w_doc_ole_tramite_todos
end type
type uo_tipo_documento from uo_clase_documento within w_doc_ole_tramite_todos
end type
type ole_documento from u_oc_impresion_word within w_doc_ole_tramite_todos
end type
type dw_documento_titulacion from u_dw within w_doc_ole_tramite_todos
end type
end forward
...
global w_doc_ole_tramite_todos w_doc_ole_tramite_todos
...
on w_doc_ole_tramite_todos.create
int iCurrent
call super::create
...
on w_doc_ole_tramite_todos.destroy
call super::destroy
...
uo_datos_opc_cero_i.of_set_texto_boton("Elegir")
...
string binarykey = "w_doc_ole_tramite_todos.win"
end type
