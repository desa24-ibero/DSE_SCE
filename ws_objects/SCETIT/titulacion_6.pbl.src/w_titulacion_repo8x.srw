$PBExportHeader$w_titulacion_repo8x.srw
$PBExportComments$Esta ventana ofrece el reporte de Titulos devueltos de SEP
forward
global type w_titulacion_repo8x from w_master_main_rep
end type
type tab_1 from tab within w_titulacion_repo8x
end type
...
integer width = 3963
integer height = 2600
string title = "Reporte de los Titulos Devueltos de Legalizar de SEP"
string menuname = "m_titulacion2"
boolean resizable = true
tab_1 tab_1
end type
global w_titulacion_repo8x w_titulacion_repo8x

type variables
int carrerax
end variables

on w_titulacion_repo8x.create
int iCurrent
call super::create
...
on w_titulacion_repo8x.destroy
call super::destroy
...
type st_sistema from w_master_main_rep`st_sistema within w_titulacion_repo8x
end type

type p_ibero from w_master_main_rep`p_ibero within w_titulacion_repo8x
end type
...
if (rb_3.checked=TRUE) then
   dw_1.setsort("legalizacion_fecha_regreso_sep A")
	dw_1.sort()
	if (cbx_2.checked=TRUE) then
      dw_1.setsort("carreras_carrera A, legalizacion_fecha_regreso_sep A")
		dw_1.sort()
	end if	
end if
...
integer height = 364
integer taborder = 5
string dataobject = "dw_tit_cuenta8"
...
integer height = 1292
integer taborder = 5
string dataobject = "dw_titulacion_rep8"
boolean resizable = true
end type
...
integer height = 204
integer taborder = 4
string dataobject = "dw_tit_cuenta8x"
boolean livescroll = true
end type
...
if (rb_3x.checked=TRUE) then
   dw_1x.setsort("legalizacion_fecha_regreso_sep A")
	dw_1x.sort()
	if (cbx_2x.checked=TRUE) then
      dw_1x.setsort("carreras_carrera A, legalizacion_fecha_regreso_sep A")
		dw_1x.sort()
	end if	
end if
...
integer height = 1292
integer taborder = 4
string dataobject = "dw_titulacion_rep8x"
boolean resizable = true
end type
