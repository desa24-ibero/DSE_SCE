$PBExportHeader$w_titulacion_repo6x.srw
$PBExportComments$Esta ventana ofrece el reporte de titulos devueltos de diseño
forward
global type w_titulacion_repo6x from w_master_main_rep
end type
type tab_1 from tab within w_titulacion_repo6x
end type
...
integer width = 3982
integer height = 2596
string title = "Reporte de los Titulos Devueltos de Diseño"
string menuname = "m_titulacion2"
boolean resizable = true
tab_1 tab_1
end type
global w_titulacion_repo6x w_titulacion_repo6x

type variables
int carrerax
end variables

on w_titulacion_repo6x.create
int iCurrent
call super::create
...
on w_titulacion_repo6x.destroy
call super::destroy
...
type st_sistema from w_master_main_rep`st_sistema within w_titulacion_repo6x
end type

type p_ibero from w_master_main_rep`p_ibero within w_titulacion_repo6x
end type
...
if (rb_3.checked=TRUE) then
   dw_1.setsort("dise_o_titulacion_fecha_regreso A")
	dw_1.sort()
	if (cbx_2.checked=TRUE) then
      dw_1.setsort("carreras_carrera A, dise_o_titulacion_fecha_regreso A")
		dw_1.sort()
	end if	
end if
...
integer height = 364
integer taborder = 5
string dataobject = "dw_tit_cuenta6"
...
integer height = 1292
integer taborder = 5
string dataobject = "dw_titulacion_rep6"
end type
...
integer height = 204
integer taborder = 4
string dataobject = "dw_tit_cuenta6x"
boolean livescroll = true
end type
...
if (rb_3x.checked=TRUE) then
   dw_1x.setsort("dise_o_titulacion_fecha_regreso A")
	dw_1x.sort()
	if (cbx_2x.checked=TRUE) then
      dw_1x.setsort("carreras_carrera A, dise_o_titulacion_fecha_regreso A")
		dw_1x.sort()
	end if	
end if
...
integer height = 1292
integer taborder = 4
string dataobject = "dw_titulacion_rep6x"
end type
