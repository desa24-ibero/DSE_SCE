$PBExportHeader$w_rep_holograma.srw
forward
global type w_rep_holograma from window
end type
type rb_nuevo from radiobutton within w_rep_holograma
end type
type st_2 from statictext within w_rep_holograma
end type
type st_fecha from statictext within w_rep_holograma
end type
type em_fecha from editmask within w_rep_holograma
end type
type st_folio_acta from statictext within w_rep_holograma
end type
type st_1 from statictext within w_rep_holograma
end type
type uo_1 from uo_orden_cobro within w_rep_holograma
end type
type dw_1 from uo_dw_captura_holograma within w_rep_holograma
end type
type gb_formato from groupbox within w_rep_holograma
end type
type rb_anterior from radiobutton within w_rep_holograma
end type
end forward
...
string title = "Reporte de Hologramas / Titulación"
...
global w_rep_holograma w_rep_holograma
...
event clicked;dw_1.dataobject = 'd_rep_holograma_jul'
...
integer height = 1364
integer taborder = 30
string dataobject = "d_rep_holograma_jul"
...
event clicked;dw_1.dataobject = 'd_rep_holograma'
dw_1.SetTransObject(gtr_sce)
ib_nuevo= false
end event
