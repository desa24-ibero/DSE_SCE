$PBExportHeader$w_reporte_sep_planteles.srw
forward
global type w_reporte_sep_planteles from Window
end type
type cb_1 from commandbutton within w_reporte_sep_planteles
end type
type st_1 from statictext within w_reporte_sep_planteles
end type
type uo_w_planteles from uo_planteles within w_reporte_sep_planteles
end type
type cb_guardar from commandbutton within w_reporte_sep_planteles
end type
type dw_reporte_sep from datawindow within w_reporte_sep_planteles
end type
type cb_imprimir from commandbutton within w_reporte_sep_planteles
end type
type cb_nuevo from commandbutton within w_reporte_sep_planteles
end type
type cb_eliminar from commandbutton within w_reporte_sep_planteles
end type
type cb_agregar from commandbutton within w_reporte_sep_planteles
end type
type lb_orden_cobro from uolb_datastorenum_plant within w_reporte_sep_planteles
end type
type lb_reporte_sep_con_orden from uolb_datastorenum_plant within w_reporte_sep_planteles
end type
type lb_reporte_sep_sin_orden from uolb_datastorenum_plant within w_reporte_sep_planteles
end type
end forward
...
string Title="Reporte escrito de las listas capturadas de Planteles (Titulación)"
...
global w_reporte_sep_planteles w_reporte_sep_planteles
...
string ls_null
SetNull(ls_null)
lb_reporte_sep_sin_orden.llena("d_reporte_sep_planteles",gtr_sce,3,0,'0',il_cve_plantel)
lb_orden_cobro.llena("d_orden_cobro_planteles",gtr_sce,1,1,ls_null,il_cve_plantel)

end event

on w_reporte_sep_planteles.create
...
on w_reporte_sep_planteles.destroy
...
int Height=35
int TabOrder=60
string DataObject="d_reporte_sep_planteles"
...
if lb_reporte_sep_con_orden.SelectedIndex() > 0 then
	...
	lb_reporte_sep_sin_orden.llena("d_reporte_sep_planteles",gtr_sce,3,0,'0',il_cve_plantel)
	lb_reporte_sep_con_orden.llena("d_reporte_sep_planteles",gtr_sce,3,0,lb_orden_cobro.Text(lb_orden_cobro.SelectedIndex()),il_cve_plantel)
	lb_orden_cobro.llena("d_orden_cobro_planteles",gtr_sce,1,1,ls_null,il_cve_plantel)
else
...
event selectionchanged;call super::selectionchanged;lb_reporte_sep_con_orden.llena("d_reporte_sep_planteles",gtr_sce,3,0,text(index),il_cve_plantel)
end event
