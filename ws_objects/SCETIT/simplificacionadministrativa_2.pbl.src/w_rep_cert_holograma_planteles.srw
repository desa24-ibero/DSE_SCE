$PBExportHeader$w_rep_cert_holograma_planteles.srw
forward
global type w_rep_cert_holograma_planteles from Window
end type
type rb_nuevo from radiobutton within w_rep_cert_holograma_planteles
end type
type rb_anterior from radiobutton within w_rep_cert_holograma_planteles
end type
type st_3 from statictext within w_rep_cert_holograma_planteles
end type
type st_plantel from statictext within w_rep_cert_holograma_planteles
end type
type st_2 from statictext within w_rep_cert_holograma_planteles
end type
type st_fecha from statictext within w_rep_cert_holograma_planteles
end type
type em_fecha from editmask within w_rep_cert_holograma_planteles
end type
type st_folio_acta from statictext within w_rep_cert_holograma_planteles
end type
type st_1 from statictext within w_rep_cert_holograma_planteles
end type
type uo_1 from uo_orden_cobro within w_rep_cert_holograma_planteles
end type
type dw_1 from uo_dw_captura_holograma within w_rep_cert_holograma_planteles
end type
type gb_formato from groupbox within w_rep_cert_holograma_planteles
end type
end forward
...
string Title="Reporte de Hologramas / Certificación (PLANTELES)"
...
global w_rep_cert_holograma_planteles w_rep_cert_holograma_planteles
...
on w_rep_cert_holograma_planteles.create
...
on w_rep_cert_holograma_planteles.destroy
...
event clicked;dw_1.dataobject = 'd_rep_cert_holograma_plant_jul'
...
event clicked;dw_1.dataobject = 'd_rep_cert_holograma_planteles'
dw_1.SetTransObject(gtr_sce)
ib_nuevo= false
...
int Height=1363
int TabOrder=30
string DataObject="d_rep_cert_holograma_planteles"
