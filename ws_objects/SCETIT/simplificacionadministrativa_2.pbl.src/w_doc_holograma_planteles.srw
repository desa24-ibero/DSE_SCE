$PBExportHeader$w_doc_holograma_planteles.srw
forward
global type w_doc_holograma_planteles from Window
end type
type st_plantel from statictext within w_doc_holograma_planteles
end type
type st_plantel1 from statictext within w_doc_holograma_planteles
end type
type st_1 from statictext within w_doc_holograma_planteles
end type
type st_folio_acta from statictext within w_doc_holograma_planteles
end type
type uo_1 from uo_orden_cobro within w_doc_holograma_planteles
end type
type dw_1 from uo_dw_captura_holograma within w_doc_holograma_planteles
end type
end forward
...
string Title="Captura de Hologramas / Titulación (PLANTELES)"
...
global w_doc_holograma_planteles w_doc_holograma_planteles
...
on w_doc_holograma_planteles.create
...
on w_doc_holograma_planteles.destroy
...
int Height=1363
int TabOrder=10
string DataObject="d_doc_holograma_planteles"
end type
