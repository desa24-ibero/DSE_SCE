$PBExportHeader$uo_dw_captura_base_docs.sru
forward
global type uo_dw_captura_base_docs from datawindow
end type
end forward
...
global uo_dw_captura_base_docs uo_dw_captura_base_docs
...
on uo_dw_captura_base_docs.create
end on

on uo_dw_captura_base_docs.destroy
end on
