...
Function string clavex(Long an_titulo, integer an_acta, integer an_libro, integer an_hoja, date af_examen, date af_exped, string a_nombres, string a_a_pat, string a_a_mat, integer a_id_plantel, integer a_id_univ, integer a_id_titulo, integer a_id_carrera) library "SEGURO.DLL"
...
public function string uf_get_codigo (long an_titulo, integer an_acta, integer an_libro, integer an_hoja, date af_examen, date af_exped, string a_nombres, string a_a_pat, string a_a_mat, integer a_id_plantel, integer a_id_univ, integer a_id_titulo, integer a_id_carrera);//win32 uf_get_codigo
