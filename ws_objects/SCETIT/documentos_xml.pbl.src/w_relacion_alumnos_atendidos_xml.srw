$PBExportHeader$w_relacion_alumnos_atendidos_xml.srw
forward
global type w_relacion_alumnos_atendidos_xml from w_main
end type
type cb_generar_xml from u_cb within w_relacion_alumnos_atendidos_xml
end type
type cb_cargar from u_cb within w_relacion_alumnos_atendidos_xml
end type
type dw_1 from uo_dw_reporte within w_relacion_alumnos_atendidos_xml
end type
type st_2 from statictext within w_relacion_alumnos_atendidos_xml
end type
type st_1 from statictext within w_relacion_alumnos_atendidos_xml
end type
type em_fecha_final from u_em within w_relacion_alumnos_atendidos_xml
end type
type em_fecha_inicial from u_em within w_relacion_alumnos_atendidos_xml
end type
end forward
...
integer width = 4119
integer height = 2700
string title = "Relación de Alumnos Atendidos Licenciatura (Opción Cero)"
...
global w_relacion_alumnos_atendidos_xml w_relacion_alumnos_atendidos_xml

on w_relacion_alumnos_atendidos_xml.create
int iCurrent
call super::create
...
this.Control[iCurrent+1]=this.cb_generar_xml
...
on w_relacion_alumnos_atendidos_xml.destroy
call super::destroy
...
uo_genera_xml_cuenta luo_genera_xml_cuenta
string ls_cuenta 
...
if not ISVALID(luo_genera_xml_cuenta) then
	luo_genera_xml_cuenta = CREATE uo_genera_xml_cuenta
	SQLCA = gtr_sce
end if
...
for ll_row_actual=1 to ll_rows
	...
	luo_genera_xml_cuenta.of_calcula_titulo(ll_cuenta, ll_cve_carrera, ll_cve_plan)
	luo_genera_xml_cuenta.genera_xml(ls_cuenta)  
