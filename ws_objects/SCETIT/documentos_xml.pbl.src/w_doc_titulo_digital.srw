$PBExportHeader$w_doc_titulo_digital.srw
forward
global type w_doc_titulo_digital from w_main
end type
type uo_datos_titulo_digital_i from uo_datos_titulo_digital within w_doc_titulo_digital
end type
type cb_seleccion from commandbutton within w_doc_titulo_digital
end type
type st_3 from statictext within w_doc_titulo_digital
end type
type uo_tipo_documento from uo_clase_documento within w_doc_titulo_digital
end type
type ole_documento from u_oc_impresion_word within w_doc_titulo_digital
end type
type dw_documento_titulacion from u_dw within w_doc_titulo_digital
end type
end forward
...
uo_datos_titulo_digital_i uo_datos_titulo_digital_i
...
global w_doc_titulo_digital w_doc_titulo_digital
...
on w_doc_titulo_digital.create
int iCurrent
call super::create
if this.MenuName = "m_genera_documento_alumno" then this.MenuID = create m_genera_documento_alumno
this.uo_datos_titulo_digital_i=create uo_datos_titulo_digital_i
...
this.Control[iCurrent+1]=this.uo_datos_titulo_digital_i
...
on w_doc_titulo_digital.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
destroy(this.uo_datos_titulo_digital_i)
...
on uo_datos_titulo_digital_i.destroy
call uo_datos_titulo_digital::destroy
end on
...
string binarykey = "w_doc_titulo_digital.win"
end type
