$PBExportHeader$uo_nombre_alumno_titulo_digital.sru
...
forward
global type uo_nombre_alumno_titulo_digital from userobject
end type
type em_digito from editmask within uo_nombre_alumno_titulo_digital
end type
type st_2 from statictext within uo_nombre_alumno_titulo_digital
end type
type st_1 from statictext within uo_nombre_alumno_titulo_digital
end type
type r_2 from rectangle within uo_nombre_alumno_titulo_digital
end type
type dw_nombre_alumno from datawindow within uo_nombre_alumno_titulo_digital
end type
type r_3 from rectangle within uo_nombre_alumno_titulo_digital
end type
type cbx_nuevo from checkbox within uo_nombre_alumno_titulo_digital
end type
type r_1 from rectangle within uo_nombre_alumno_titulo_digital
end type
type em_cuenta from editmask within uo_nombre_alumno_titulo_digital
end type
end forward
...
global uo_nombre_alumno_titulo_digital uo_nombre_alumno_titulo_digital
...
on uo_nombre_alumno_titulo_digital.create
...
on uo_nombre_alumno_titulo_digital.destroy
...
integer height = 168
integer taborder = 30
string dataobject = "dw_nombre_alumno_opc_cero"
boolean border = false
end type
