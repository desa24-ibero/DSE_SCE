$PBExportHeader$uo_datos_titulo_digital.sru
forward
global type uo_datos_titulo_digital from userobject
end type
type cb_elegir from commandbutton within uo_datos_titulo_digital
end type
type st_3 from statictext within uo_datos_titulo_digital
end type
type uo_carreras_alumno_i from uo_carreras_alumno_titulo_digital within uo_datos_titulo_digital
end type
type uo_nombre_alumno_i from uo_nombre_alumno_titulo_digital within uo_datos_titulo_digital
end type
end forward
...
global uo_datos_titulo_digital uo_datos_titulo_digital
...
on uo_datos_titulo_digital.create
...
on uo_datos_titulo_digital.destroy
...
if li_res = 1 then
	...
	OpenWithParm(w_diagnostico_acad_titulo_digital, lst_parametros, iw_padre)
...
call uo_carreras_alumno_titulo_digital::destroy
end on
...
call uo_nombre_alumno_titulo_digital::destroy
end on
