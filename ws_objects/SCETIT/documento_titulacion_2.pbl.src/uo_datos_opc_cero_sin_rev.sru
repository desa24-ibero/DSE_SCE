$PBExportHeader$uo_datos_opc_cero_sin_rev.sru
forward
global type uo_datos_opc_cero_sin_rev from userobject
end type
type cb_elegir from commandbutton within uo_datos_opc_cero_sin_rev
end type
type st_3 from statictext within uo_datos_opc_cero_sin_rev
end type
type uo_carreras_alumno_i from uo_carreras_alumno_opc_cero within uo_datos_opc_cero_sin_rev
end type
type uo_nombre_alumno_i from uo_nombre_alumno_opc_cero within uo_datos_opc_cero_sin_rev
end type
end forward
...
global uo_datos_opc_cero_sin_rev uo_datos_opc_cero_sin_rev
...
on uo_datos_opc_cero_sin_rev.create
...
on uo_datos_opc_cero_sin_rev.destroy
