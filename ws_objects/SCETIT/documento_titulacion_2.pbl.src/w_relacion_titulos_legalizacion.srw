$PBExportHeader$w_relacion_titulos_legalizacion.srw
forward
global type w_relacion_titulos_legalizacion from window
end type
type cb_1 from commandbutton within w_relacion_titulos_legalizacion
end type
type st_2 from statictext within w_relacion_titulos_legalizacion
end type
type st_fecha_final from statictext within w_relacion_titulos_legalizacion
end type
type st_1 from statictext within w_relacion_titulos_legalizacion
end type
type em_fecha_final from editmask within w_relacion_titulos_legalizacion
end type
type em_fecha_inicial from editmask within w_relacion_titulos_legalizacion
end type
type dw_1 from datawindow within w_relacion_titulos_legalizacion
end type
end forward
...
string title = "Relación de Títulos Enviados a Legalizar"
...
global w_relacion_titulos_legalizacion w_relacion_titulos_legalizacion
...
on w_relacion_titulos_legalizacion.create
...
on w_relacion_titulos_legalizacion.destroy
...
integer height = 896
integer taborder = 60
string dataobject = "d_relacion_titulos_legalizacion"
