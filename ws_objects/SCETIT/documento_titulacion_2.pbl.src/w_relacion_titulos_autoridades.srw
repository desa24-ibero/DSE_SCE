$PBExportHeader$w_relacion_titulos_autoridades.srw
forward
global type w_relacion_titulos_autoridades from window
end type
type cb_1 from commandbutton within w_relacion_titulos_autoridades
end type
type st_2 from statictext within w_relacion_titulos_autoridades
end type
type st_1 from statictext within w_relacion_titulos_autoridades
end type
type em_fecha_inicial from editmask within w_relacion_titulos_autoridades
end type
type dw_1 from datawindow within w_relacion_titulos_autoridades
end type
end forward
...
string title = "Relación de Títulos Enviados a Diseñar (Autoridades UIA)"
...
global w_relacion_titulos_autoridades w_relacion_titulos_autoridades
...
on w_relacion_titulos_autoridades.create
...
on w_relacion_titulos_autoridades.destroy
...
integer height = 896
integer taborder = 60
string dataobject = "d_relacion_titulos_autoridades"
...
li_num_registros= dw_1.retrieve(ldttm_fecha_inicial)
