$PBExportHeader$uo_clave_texto.sru
forward
global type uo_clave_texto from userobject
end type
type dw_1 from datawindow within uo_clave_texto
end type
end forward
...
global uo_clave_texto uo_clave_texto
...
on uo_clave_texto.create
this.dw_1=create dw_1
this.Control[]={this.dw_1}
end on

on uo_clave_texto.destroy
destroy(this.dw_1)
end on
...
integer height = 93
integer taborder = 10
string dataobject = "duo_area_coordinacion"
