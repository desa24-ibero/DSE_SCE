$PBExportHeader$w_password_rest.srw
$PBExportComments$Ventana de verificación de Password
forward
global type w_password_rest from window
end type
type st_plantel from statictext within w_password_rest
end type
type st_6 from statictext within w_password_rest
end type
type st_8 from statictext within w_password_rest
end type
type p_3 from picture within w_password_rest
end type
type st_ver from statictext within w_password_rest
end type
type st_1 from statictext within w_password_rest
end type
type sle_pass from singlelineedit within w_password_rest
end type
type cb_close from commandbutton within w_password_rest
end type
type cb_login from commandbutton within w_password_rest
end type
type sle_password from singlelineedit within w_password_rest
end type
type sle_userid from singlelineedit within w_password_rest
end type
type st_3 from statictext within w_password_rest
end type
type st_2 from statictext within w_password_rest
end type
type r_1 from rectangle within w_password_rest
end type
type st_4 from statictext within w_password_rest
end type
end forward
...
global w_password_rest w_password_rest
...
if (conecta_bd_n_tr(gtr_sce,gs_sce,gs_usuario,gs_password) = 1) then
	...
	//**//
	//Valida 
//	if Not f_valida_login(gtr_sce.logid, gtr_sce.logpass, gtr_sce) then
...
String ls_plantel, ls_info_periodo, ls_logo
...
long backcolor = 12632256
boolean enabled = false
string text = "Sistema de Titulación PB 12"
alignment alignment = center!
boolean focusrectangle = false
end type
