$PBExportHeader$w_certificado_todos.srw
$PBExportComments$Esta ventana hace operaciones con certificados
forward
global type w_certificado_todos from window
end type
type st_1 from statictext within w_certificado_todos
end type
type vsb_dw_certificado from vscrollbar within w_certificado_todos
end type
type dw_1 from datawindow within w_certificado_todos
end type
type uo_nombre from uo_nombre_carrera within w_certificado_todos
end type
end forward
...
global w_certificado_todos w_certificado_todos

on w_certificado_todos.create
...
on w_certificado_todos.destroy
...
integer height = 964
integer taborder = 20
string dataobject = "dw_certificado_todos"
end type
