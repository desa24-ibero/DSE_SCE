$PBExportHeader$w_titulacion4.srw
$PBExportComments$Ventana de Profesiones en Titulación
forward
global type w_titulacion4 from window
end type
type dw_1 from datawindow within w_titulacion4
end type
type vsb_dw_certificado from vscrollbar within w_titulacion4
end type
type st_1 from statictext within w_titulacion4
end type
type uo_nombre from uo_nombre_carr_tit4 within w_titulacion4
end type
end forward

global type w_titulacion4 from window
string tag = "En esta ventana se muestran las fechas de envio y regreso a Profesiones"
integer x = 5
integer y = 4
integer width = 3579
integer height = 1428
boolean titlebar = true
string title = "Profesiones"
...
global w_titulacion4 w_titulacion4

on w_titulacion4.create
...
titulacion.toolbarsheettitle="Profesiones"
...
integer height = 568
integer taborder = 20
string dataobject = "dw_profesiones"
end type
...
if currentrow>0 then
	...
	if parent.uo_nombre.cbx_navega.checked then
		w_titulacion4.uo_nombre.em_cuenta. event busqueda_simple(string(Object.cuenta[currentrow]))
	end if
...
long ll_renglon, ll_num_relacion_nula, ll_num_rows
integer li_sin_tramite
datetime ldttm_fecha_nula

setnull(ll_num_relacion_nula)
setnull(ldttm_fecha_nula)
/*Ve si nos hay cambios que no se hayan guardado*/
event actualiza()
ll_num_rows = retrieve(long(cuenta),long(carrera), long(plan))
...
If ll_num_rows =0 &
   then
		...
		li_sin_tramite = integer(this.Object.sin_tramite[ll_renglon])
//Propiedad DisplayOnly
//No - Permite editar
//Protect
//1 - Protegido

		if li_sin_tramite = 0 then
			this.Object.fecha_envio_prof.Protect = 0
			this.Object.fecha_regreso_prof.Protect = 0
			this.Object.num_relacion.Protect = 0

			this.Object.fecha_envio_prof.Edit.DisplayOnly = "no"
			this.Object.fecha_regreso_prof.Edit.DisplayOnly = "no"
			this.Object.num_relacion.Edit.DisplayOnly = "no"

			this.Object.fecha_envio_prof.EditMask.Mask= "DD/MM/YYYY"
			this.Object.fecha_regreso_prof.EditMask.Mask= "DD/MM/YYYY"	

		elseif li_sin_tramite = 1 then
			this.Object.fecha_envio_prof.Protect = 1
			this.Object.fecha_regreso_prof.Protect = 1
			this.Object.num_relacion.Protect = 1

			this.Object.fecha_envio_prof.Edit.DisplayOnly = "yes"
			this.Object.fecha_regreso_prof.Edit.DisplayOnly = "yes"
			this.Object.num_relacion.Edit.DisplayOnly = "yes"

			this.Object.fecha_envio_prof[ll_renglon]= ldttm_fecha_nula
			this.Object.fecha_regreso_prof[ll_renglon]= ldttm_fecha_nula
			this.Object.num_relacion[ll_renglon] = ll_num_relacion_nula
			...
			if this. EVENT verifica_2() = 1 then
			    if this. EVENT verifica() = 1 then
	              if update(true) = 1 then
   	   		      ...
   	   		      w_titulacion4.uo_nombre.em_cuenta.setfocus ( )
			        else
...
Object.cuenta[RowCount()]=long(w_titulacion4.uo_nombre.em_cuenta.Text)
Object.sin_tramite[RowCount()]=integer(0)
...
if isnull(object.fecha_regreso_prof[getrow()]) then
	   return 1
		/* Como fue nulo es posible guardarlo */
else	
	   /* Como no fue nula, se verifica que la fecha de envio sea menor o igual*/
	   if date(Object.fecha_regreso_prof[getrow()]) >= &
	      date(Object.fecha_envio_prof[getrow()]) then		
...
fecha1=string(Object.fecha_envio_prof[getrow()],"dd/mm/yyyy")
fecha2=string(Object.fecha_regreso_prof[getrow()],"dd/mm/yyyy")

if isnull(Object.fecha_regreso_prof[getrow()]) AND isnull(Object.fecha_envio_prof[getrow()]) then
...
return 1
	...
	SELECT legalizacion.fecha_regreso_sep
	INTO :VarX
	FROM legalizacion
	WHERE legalizacion.cuenta=:Var_Cuenta and 
	      legalizacion.cve_carrera = :Var_Carrera and 
			legalizacion.cve_plan = : Var_Plan using gtr_sce;

	
	if gtr_sce.SQLCode = 100 then
		/* Not found*/
	         messagebox("!!! Aviso !!!",&
				" El Alumno NO TIENE REGISTRO en Legalización de Titulo, ~r~ "+&
		...
		if gtr_sce.SQLCode = 0 then
   		  ...
   		  if isnull(VarX) then
			   messagebox("!!! Aviso !!!",&
				" El Alumno si tiene registro en Legalización de Titulo,  ~r~ "+&
...
event itemchanged;int li_columna
int li_sin_tramite
long ll_num_relacion_nula
datetime ldttm_fecha_nula

li_columna = getcolumn()

setnull(ll_num_relacion_nula)
setnull(ldttm_fecha_nula)


//Cambio la columna  sin_tramite
if li_columna = 8 then
	li_sin_tramite = integer(data)
//Propiedad DisplayOnly
//No - Permite editar
//Protect
//1 - Protegido
	...
	elseif li_sin_tramite = 1 then
		...
		this.Object.fecha_envio_prof[row]= ldttm_fecha_nula
		this.Object.fecha_regreso_prof[row]= ldttm_fecha_nula
		this.Object.num_relacion[row] = ll_num_relacion_nula
...
call uo_nombre_carr_tit4::destroy
end on
