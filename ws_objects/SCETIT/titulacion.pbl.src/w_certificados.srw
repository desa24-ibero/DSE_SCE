...
if dw_1.ModifiedCount()+dw_1.DeletedCount() > 0 Then
	...
	int respuesta
	respuesta = messagebox("Atención","Desea actualizar los cambios:",question!,YesNo!,2)
...
//			dw_1.object.no_sep.visible=FALSE
			SetTabOrder("legalizado", 20)
	else
//Esta carrera y plan NO estan validados por la SEP  
			messagebox("¡INFORMACION !",&
			"La carrera esta como estudio no incorporado a la SEP~n El certificado será SIMPLE",StopSign!)
			//Asigna certificado simple y deshabilita la columna
			SetItem(GetRow(),"legalizado", 0)
			SetTabOrder("legalizado", 0)
