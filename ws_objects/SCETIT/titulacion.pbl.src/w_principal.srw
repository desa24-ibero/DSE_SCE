...
title=ProfileString (gs_startupfile, gs_datos, "APLICACION","")+' '+gs_usuario
//Comentado para que no haya errores durante migrcion sin padlock
//+' '+ls_nombre
//Comentado para migrar sin padlock
...
li_return = gnv_app.inv_security.of_InitSecurity(gnv_app.itr_security, "titulacion", &
gs_usuario, "Default")
