$PBExportHeader$w_informa_entregado.srw
forward
global type w_informa_entregado from w_contesta_tramite_internet
end type
end forward
...
integer x = 466
integer y = 372
string title = "Informa Documentos Entregados"
end type
global w_informa_entregado w_informa_entregado

on w_informa_entregado.create
call super::create
end on

on w_informa_entregado.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type ddlb_estado_general from w_contesta_tramite_internet`ddlb_estado_general within w_informa_entregado
boolean visible = false
string item[] = {"EN TRAMITE","PUEDES RECOGERLO","PROCESO CANCELADO"}
end type

type st_5 from w_contesta_tramite_internet`st_5 within w_informa_entregado
boolean visible = false
end type

type cb_responder from w_contesta_tramite_internet`cb_responder within w_informa_entregado
integer y = 339
end type

type st_4 from w_contesta_tramite_internet`st_4 within w_informa_entregado
end type

type em_respuesta_base from w_contesta_tramite_internet`em_respuesta_base within w_informa_entregado
end type

type st_3 from w_contesta_tramite_internet`st_3 within w_informa_entregado
end type

type dw_resultado from w_contesta_tramite_internet`dw_resultado within w_informa_entregado
end type

type cb_1 from w_contesta_tramite_internet`cb_1 within w_informa_entregado
end type

type cb_establece from w_contesta_tramite_internet`cb_establece within w_informa_entregado
end type

type st_2 from w_contesta_tramite_internet`st_2 within w_informa_entregado
end type

type st_1 from w_contesta_tramite_internet`st_1 within w_informa_entregado
end type

type em_fecha_final from w_contesta_tramite_internet`em_fecha_final within w_informa_entregado
end type

type em_fecha_inicial from w_contesta_tramite_internet`em_fecha_inicial within w_informa_entregado
end type

type gb_1 from w_contesta_tramite_internet`gb_1 within w_informa_entregado
end type

type dw_1 from w_contesta_tramite_internet`dw_1 within w_informa_entregado
string dataobject = "d_informa_entregado"
end type
