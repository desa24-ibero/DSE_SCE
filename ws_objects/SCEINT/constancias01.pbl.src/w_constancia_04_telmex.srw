$PBExportHeader$w_constancia_04_telmex.srw
forward
global type w_constancia_04_telmex from window
end type
type uo_nombre from uo_nombre_alumno_const within w_constancia_04_telmex
end type
type uo_1 from uo_per_ani within w_constancia_04_telmex
end type
type st_numero from statictext within w_constancia_04_telmex
end type
type st_decimal from statictext within w_constancia_04_telmex
end type
type cb_promedio from commandbutton within w_constancia_04_telmex
end type
type st_3 from statictext within w_constancia_04_telmex
end type
type em_precision_prom from editmask within w_constancia_04_telmex
end type
type st_texto_fecha from statictext within w_constancia_04_telmex
end type
type st_fecha from statictext within w_constancia_04_telmex
end type
type em_fecha from editmask within w_constancia_04_telmex
end type
type cb_redactar from commandbutton within w_constancia_04_telmex
end type
type dw_constancia from datawindow within w_constancia_04_telmex
end type
type mle_texto_libre from multilineedit within w_constancia_04_telmex
end type
type st_2 from statictext within w_constancia_04_telmex
end type
type st_1 from statictext within w_constancia_04_telmex
end type
type mle_dirigido_a from multilineedit within w_constancia_04_telmex
end type
end forward
...
global w_constancia_04_telmex w_constancia_04_telmex
...
select descripcion into :ls_periodo_texto from periodo where periodo=:li_periodo_actual using gtr_sce;
...
ls_texto_final="Asimismo se hace constar que actualmente está "+ls_inscrit+" en su "+ &
  ...
  " al "+lower(string(ls_dia_mes_final))+")."+ "~r~n"

return ls_texto_final

end function

on w_constancia_04_telmex.create
...
on w_constancia_04_telmex.destroy
...
event doubleclicked;long ll_cuenta
string ls_texto_libre

ll_cuenta = long(uo_nombre.em_cuenta.text)

ls_texto_libre = wf_obten_texto_final(ll_cuenta)
