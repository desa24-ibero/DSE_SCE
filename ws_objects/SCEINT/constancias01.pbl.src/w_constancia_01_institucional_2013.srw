$PBExportHeader$w_constancia_01_institucional_2013.srw
forward
global type w_constancia_01_institucional_2013 from w_master_main
end type
type st_1 from statictext within w_constancia_01_institucional_2013
end type
type st_fecha from statictext within w_constancia_01_institucional_2013
end type
type em_fecha from editmask within w_constancia_01_institucional_2013
end type
type cb_redactar from commandbutton within w_constancia_01_institucional_2013
end type
type cbx_1 from checkbox within w_constancia_01_institucional_2013
end type
type st_2 from statictext within w_constancia_01_institucional_2013
end type
type st_texto_fecha from statictext within w_constancia_01_institucional_2013
end type
type dw_constancia from uo_master_dw within w_constancia_01_institucional_2013
end type
type mle_dirigido_a from multilineedit within w_constancia_01_institucional_2013
end type
type mle_texto_libre from multilineedit within w_constancia_01_institucional_2013
end type
type uo_nombre from uo_carreras_alumno_lista_const2 within w_constancia_01_institucional_2013
end type
type st_version2 from statictext within w_constancia_01_institucional_2013
end type
type st_version1 from statictext within w_constancia_01_institucional_2013
end type
type uo_pdf from uo_imprime_pdf within w_constancia_01_institucional_2013
end type
end forward
...
integer width = 3717
integer height = 3012
string title = "Inscripción sin Promedio y sin Créditos Institucional"
...
global w_constancia_01_institucional_2013 w_constancia_01_institucional_2013
...
on w_constancia_01_institucional_2013.create
int iCurrent
call super::create
...
this.Control[iCurrent+12]=this.st_version2
this.Control[iCurrent+13]=this.st_version1
this.Control[iCurrent+14]=this.uo_pdf
end on

on w_constancia_01_institucional_2013.destroy
call super::destroy
...
type st_sistema from w_master_main`st_sistema within w_constancia_01_institucional_2013
end type

type p_ibero from w_master_main`p_ibero within w_constancia_01_institucional_2013
end type
...
event constructor;this.text = "A QUIEN CORRESPONDA:"
end event
