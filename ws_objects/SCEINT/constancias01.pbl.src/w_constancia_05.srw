$PBExportHeader$w_constancia_05.srw
$PBExportComments$Terminación
forward
global type w_constancia_05 from window
end type
type uo_nombre from uo_nombre_alumno_const within w_constancia_05
end type
type cbx_social from checkbox within w_constancia_05
end type
type cbx_terminal from checkbox within w_constancia_05
end type
type dw_revision_est from datawindow within w_constancia_05
end type
type dw_certificado from datawindow within w_constancia_05
end type
type st_numero from statictext within w_constancia_05
end type
type st_decimal from statictext within w_constancia_05
end type
type cb_promedio from commandbutton within w_constancia_05
end type
type st_3 from statictext within w_constancia_05
end type
type em_precision_prom from editmask within w_constancia_05
end type
type st_texto_fecha from statictext within w_constancia_05
end type
type st_fecha from statictext within w_constancia_05
end type
type em_fecha from editmask within w_constancia_05
end type
type cb_redactar from commandbutton within w_constancia_05
end type
type dw_constancia from datawindow within w_constancia_05
end type
type mle_texto_libre from multilineedit within w_constancia_05
end type
type st_2 from statictext within w_constancia_05
end type
type st_1 from statictext within w_constancia_05
end type
type mle_dirigido_a from multilineedit within w_constancia_05
end type
end forward
...
global w_constancia_05 w_constancia_05

type variables
str_impresion_constancias istr_constancias 
end variables

on w_constancia_05.create
...
//Usado para probar las opciones terminales y serv social
...
ll_renglones = dw_constancia.Retrieve(ll_cuenta, ldttm_fecha, ls_dirigido_a, ls_texto2,ld_promedio,&
					...
					li_pend_creditos, li_pend_opcion_terminal, li_pend_servicio_social, li_num_lineas)

ll_renglon_actual =dw_constancia.GetRow()

istr_constancias.sl_cuenta = ll_cuenta
istr_constancias.si_num_constancia = 5
