$PBExportHeader$w_constancia_01_institucional.srw
forward
global type w_constancia_01_institucional from window
end type
type cbx_1 from checkbox within w_constancia_01_institucional
end type
type uo_nombre from uo_nombre_alumno_const within w_constancia_01_institucional
end type
type st_texto_fecha from statictext within w_constancia_01_institucional
end type
type st_fecha from statictext within w_constancia_01_institucional
end type
type em_fecha from editmask within w_constancia_01_institucional
end type
type cb_redactar from commandbutton within w_constancia_01_institucional
end type
type dw_constancia from datawindow within w_constancia_01_institucional
end type
type mle_texto_libre from multilineedit within w_constancia_01_institucional
end type
type st_2 from statictext within w_constancia_01_institucional
end type
type st_1 from statictext within w_constancia_01_institucional
end type
type mle_dirigido_a from multilineedit within w_constancia_01_institucional
end type
end forward
...
global w_constancia_01_institucional w_constancia_01_institucional
...
on w_constancia_01_institucional.create
...
on w_constancia_01_institucional.destroy
