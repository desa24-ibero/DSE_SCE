$PBExportHeader$w_constancia_05_2013.srw
$PBExportComments$Inscripción sin Promedio y sin Créditos
forward
global type w_constancia_05_2013 from w_master_main
end type
type st_1 from statictext within w_constancia_05_2013
end type
type mle_dirigido_a from multilineedit within w_constancia_05_2013
end type
type st_fecha from statictext within w_constancia_05_2013
end type
type em_fecha from editmask within w_constancia_05_2013
end type
type cb_redactar from commandbutton within w_constancia_05_2013
end type
type mle_texto_libre from multilineedit within w_constancia_05_2013
end type
type st_2 from statictext within w_constancia_05_2013
end type
type st_texto_fecha from statictext within w_constancia_05_2013
end type
type dw_constancia from uo_master_dw within w_constancia_05_2013
end type
type st_numero from statictext within w_constancia_05_2013
end type
type st_decimal from statictext within w_constancia_05_2013
end type
type st_3 from statictext within w_constancia_05_2013
end type
type em_precision_prom from editmask within w_constancia_05_2013
end type
type cb_promedio from commandbutton within w_constancia_05_2013
end type
type uo_nombre from uo_carreras_alumno_lista_const2 within w_constancia_05_2013
end type
type dw_certificado from datawindow within w_constancia_05_2013
end type
type dw_revision_est from datawindow within w_constancia_05_2013
end type
type uo_pdf from uo_imprime_pdf within w_constancia_05_2013
end type
type st_version1 from statictext within w_constancia_05_2013
end type
type st_version2 from statictext within w_constancia_05_2013
end type
end forward
...
global w_constancia_05_2013 w_constancia_05_2013
...
on w_constancia_05_2013.create
int iCurrent
call super::create
...
this.Control[iCurrent+18]=this.uo_pdf
this.Control[iCurrent+19]=this.st_version1
this.Control[iCurrent+20]=this.st_version2
end on

on w_constancia_05_2013.destroy
call super::destroy
...
type st_sistema from w_master_main`st_sistema within w_constancia_05_2013
end type

type p_ibero from w_master_main`p_ibero within w_constancia_05_2013
end type
...
dw_constancia.reset() // cph oct 2021
...
li_rows_child = dwr_tabla.Retrieve(il_cuenta,li_periodo_actual,li_anio_actual, il_carrera,il_plan)
...
//Validacion adicional para que se revise que el plan de estudio este correctamente cargado
//lo cual se detecta porque al menos un registro tien los créditos minimos en diferente de 0
if li_rows_revision > 0 then
	li_row = 0
	lb_error_plan= true
	do 
		li_row = li_row+1
	   ...
	   if li_cred_minimos <>0 then		
			lb_error_plan=false		
		end if
	loop until li_cred_minimos <> 0 or li_row = li_rows_revision
end if

if lb_error_plan  then
	MessageBox("Plan de estudios erroneo", "El plan de estudios no esta cargado completamente")
	m_menu_constancias_2013.m_archivo.m_imprimir.Disable() // se le pone 2013 porque si no tronaba cph oct/2021
...
if li_pend_creditos = 1 then
	MessageBox("Créditos Pendientes", "La constancia no puede generarse ya que el alumno tiene créditos pendientes")
...
ll_renglones = dw_constancia.Retrieve(il_cuenta, ldttm_fecha, ls_dirigido_a, ls_texto2,ld_promedio,&
					ldc_creditos, li_precision,ldc_creditos_totales,li_periodo_actual,li_anio_actual,li_rows_child, li_pend_creditos, li_pend_opcion_terminal, li_pend_servicio_social,li_num_lineas,il_carrera, il_plan)
...
integer taborder = 40
boolean bringtotop = true
string dataobject = "d_constancias_05"
