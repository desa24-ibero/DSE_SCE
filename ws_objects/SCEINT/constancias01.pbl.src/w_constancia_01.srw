$PBExportHeader$w_constancia_01.srw
$PBExportComments$Inscripción sin Promedio y sin Créditos
forward
global type w_constancia_01 from window
end type
type cbx_1 from checkbox within w_constancia_01
end type
type uo_nombre from uo_nombre_alumno_const within w_constancia_01
end type
type st_texto_fecha from statictext within w_constancia_01
end type
type st_fecha from statictext within w_constancia_01
end type
type em_fecha from editmask within w_constancia_01
end type
type cb_redactar from commandbutton within w_constancia_01
end type
type dw_constancia from datawindow within w_constancia_01
end type
type mle_texto_libre from multilineedit within w_constancia_01
end type
type st_2 from statictext within w_constancia_01
end type
type st_1 from statictext within w_constancia_01
end type
type mle_dirigido_a from multilineedit within w_constancia_01
end type
end forward
...
global w_constancia_01 w_constancia_01
...
ll_renglones = dw_constancia.Retrieve(ll_cuenta, ldttm_fecha, ls_dirigido_a, ls_texto2, li_num_lineas)

istr_constancias.sl_cuenta = long(uo_nombre.em_cuenta.text)
...
//istr_constancias.sdw_datawindow = parent
istr_constancias.sl_cuenta = long(uo_nombre.em_cuenta.text)
...
integer height = 1516
integer taborder = 50
string dataobject = "d_constancias_01"
...
istr_constancias.sl_cuenta = long(uo_nombre.em_cuenta.text)
istr_constancias.si_num_constancia = 111
istr_constancias.sw_window = parent
istr_constancias.suo_user_object = uo_nombre
