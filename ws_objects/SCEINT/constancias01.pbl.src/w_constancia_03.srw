$PBExportHeader$w_constancia_03.srw
$PBExportComments$Materias Inscritas con Horario
forward
global type w_constancia_03 from window
end type
type uo_nombre from uo_nombre_alumno_const within w_constancia_03
end type
type st_numero from statictext within w_constancia_03
end type
type st_decimal from statictext within w_constancia_03
end type
type cb_promedio from commandbutton within w_constancia_03
end type
type st_3 from statictext within w_constancia_03
end type
type em_precision_prom from editmask within w_constancia_03
end type
type st_texto_fecha from statictext within w_constancia_03
end type
type st_fecha from statictext within w_constancia_03
end type
type em_fecha from editmask within w_constancia_03
end type
type cb_redactar from commandbutton within w_constancia_03
end type
type dw_constancia from datawindow within w_constancia_03
end type
type mle_texto_libre from multilineedit within w_constancia_03
end type
type st_2 from statictext within w_constancia_03
end type
type st_1 from statictext within w_constancia_03
end type
type mle_dirigido_a from multilineedit within w_constancia_03
end type
end forward
...
global w_constancia_03 w_constancia_03

type variables
str_impresion_constancias istr_constancias
end variables

on w_constancia_03.create
