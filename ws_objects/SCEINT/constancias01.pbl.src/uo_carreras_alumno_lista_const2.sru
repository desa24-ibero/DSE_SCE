$PBExportHeader$uo_carreras_alumno_lista_const2.sru
...
forward
global type uo_carreras_alumno_lista_const2 from uo_master_uo
end type
type dw_carreras from uo_master_dw within uo_carreras_alumno_lista_const2
end type
type dw_nombre_alumno from uo_dw_nombre_alumno_2013 within uo_carreras_alumno_lista_const2
end type
type cbx_nuevo from checkbox within uo_carreras_alumno_lista_const2
end type
type em_digito from editmask within uo_carreras_alumno_lista_const2
end type
type st_2 from statictext within uo_carreras_alumno_lista_const2
end type
type em_cuenta from editmask within uo_carreras_alumno_lista_const2
end type
type st_1 from statictext within uo_carreras_alumno_lista_const2
end type
type r_1 from rectangle within uo_carreras_alumno_lista_const2
end type
end forward
...
global uo_carreras_alumno_lista_const2 uo_carreras_alumno_lista_const2
...
on uo_carreras_alumno_lista_const2.create
int iCurrent
call super::create
...
on uo_carreras_alumno_lista_const2.destroy
call super::destroy
