$PBExportHeader$w_constancia_01_2013.srw
$PBExportComments$Inscripción sin Promedio y sin Créditos
forward
global type w_constancia_01_2013 from w_master_main
end type
type st_1 from statictext within w_constancia_01_2013
end type
type mle_dirigido_a from multilineedit within w_constancia_01_2013
end type
type st_fecha from statictext within w_constancia_01_2013
end type
type em_fecha from editmask within w_constancia_01_2013
end type
type cb_redactar from commandbutton within w_constancia_01_2013
end type
type cbx_1 from checkbox within w_constancia_01_2013
end type
type mle_texto_libre from multilineedit within w_constancia_01_2013
end type
type st_2 from statictext within w_constancia_01_2013
end type
type st_texto_fecha from statictext within w_constancia_01_2013
end type
type dw_constancia from uo_master_dw within w_constancia_01_2013
end type
type uo_nombre from uo_carreras_alumno_lista_const2 within w_constancia_01_2013
end type
type st_version1 from statictext within w_constancia_01_2013
end type
type st_version2 from statictext within w_constancia_01_2013
end type
type uo_pdf from uo_imprime_pdf within w_constancia_01_2013
end type
end forward
...
integer width = 3717
integer height = 3012
string title = "Inscripción sin Promedio y sin Créditos"
...
global w_constancia_01_2013 w_constancia_01_2013
...
on w_constancia_01_2013.create
int iCurrent
call super::create
...
this.Control[iCurrent+7]=this.mle_texto_libre
this.Control[iCurrent+8]=this.st_2
this.Control[iCurrent+9]=this.st_texto_fecha
this.Control[iCurrent+10]=this.dw_constancia
...
on w_constancia_01_2013.destroy
call super::destroy
...
type st_sistema from w_master_main`st_sistema within w_constancia_01_2013
end type

type p_ibero from w_master_main`p_ibero within w_constancia_01_2013
end type
...
ll_renglones = dw_constancia.Retrieve(il_cuenta, ldttm_fecha, ls_dirigido_a, ls_texto2, li_num_lineas,il_carrera,ls_semtrim)
...
integer taborder = 40
boolean bringtotop = true
string dataobject = "d_constancias_01_2021"
