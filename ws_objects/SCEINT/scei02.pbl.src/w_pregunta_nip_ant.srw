$PBExportHeader$w_pregunta_nip_ant.srw
forward
global type w_pregunta_nip_ant from Window
end type
type p_1 from picture within w_pregunta_nip_ant
end type
type st_nip from statictext within w_pregunta_nip_ant
end type
type st_nombre_alumno from statictext within w_pregunta_nip_ant
end type
type sle_nip from singlelineedit within w_pregunta_nip_ant
end type
end forward
...
global w_pregunta_nip_ant w_pregunta_nip_ant
	...
	case 1
		...
		if ls_nip = as_nip then
			...
			if li_nip_detectado<> 1 then
				...
				lds_nips.SetItem(1,"nip2", ls_nip_plano)
