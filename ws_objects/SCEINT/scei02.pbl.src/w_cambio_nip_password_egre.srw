$PBExportHeader$w_cambio_nip_password_egre.srw
$PBExportComments$Despliegue de datos academicos de un alumno (Carrera, Semestre, Subsistema, Fecha de Ingreso, Fecha de Egreso,.....) Funcionalidad de ventana w_cambio_nip_password_2013 solo que con filtro inicial para Egresados
forward
global type w_cambio_nip_password_egre from w_master_main
end type
type uo_nombre from uo_nombre_alumno_2013 within w_cambio_nip_password_egre
end type
type dw_alumno_cambio_password from datawindow within w_cambio_nip_password_egre
end type
type cb_1 from commandbutton within w_cambio_nip_password_egre
end type
type iuo_foto_alumno_blob from uo_foto_alumno_blob within w_cambio_nip_password_egre
end type
type st_1 from statictext within w_cambio_nip_password_egre
end type
type rr_1 from roundrectangle within w_cambio_nip_password_egre
end type
type sle_nip_2 from singlelineedit within w_cambio_nip_password_egre
end type
type sle_nip_1 from singlelineedit within w_cambio_nip_password_egre
end type
type st_2 from statictext within w_cambio_nip_password_egre
end type
type st_3 from statictext within w_cambio_nip_password_egre
end type
type sle_nip_a from singlelineedit within w_cambio_nip_password_egre
end type
type sle_nip_b from singlelineedit within w_cambio_nip_password_egre
end type
type dw_nuevo_pwd from datawindow within w_cambio_nip_password_egre
end type
type dw_ws_actualiza_password from datawindow within w_cambio_nip_password_egre
end type
type dw_ws_valida_bloqueo from datawindow within w_cambio_nip_password_egre
end type
type dw_alumnos_egresados from datawindow within w_cambio_nip_password_egre
end type
type rr_2 from roundrectangle within w_cambio_nip_password_egre
end type
type rr_3 from roundrectangle within w_cambio_nip_password_egre
end type
end forward
...
integer width = 4238
integer height = 2780
string title = "Cambio de NIP a PASSWORD (Egresados)"
...
dw_alumnos_egresados dw_alumnos_egresados
rr_2 rr_2
rr_3 rr_3
end type
global w_cambio_nip_password_egre w_cambio_nip_password_egre
...
on w_cambio_nip_password_egre.create
int iCurrent
call super::create
...
this.dw_alumnos_egresados=create dw_alumnos_egresados
...
this.Control[iCurrent+16]=this.dw_alumnos_egresados
this.Control[iCurrent+17]=this.rr_2
this.Control[iCurrent+18]=this.rr_3
end on

on w_cambio_nip_password_egre.destroy
call super::destroy
...
destroy(this.dw_alumnos_egresados)
destroy(this.rr_2)
destroy(this.rr_3)
end on
...
dw_alumnos_egresados.SetTransObject(gtr_sce)
...
/********   Valida que sea un alumno egresado   ******/
li_result = dw_alumnos_egresados.retrieve(il_cuenta)
IF li_result = 0 Then
	MessageBox('Mensaje del Sistema','No es un alumno egresado de la Ibero...',Exclamation!)
	Return -1
End If

IF li_result = -1 Then
	MessageBox('Mensaje del Sistema','No fue posible validar si es un alumno egresado de la Ibero... ' + gtr_sce.sqlerrtext, StopSign!)
	Return -1
End If
...
type st_sistema from w_master_main`st_sistema within w_cambio_nip_password_egre
end type

type p_ibero from w_master_main`p_ibero within w_cambio_nip_password_egre
end type
...
/********   Valida que sea un alumno egresado   ******/
li_result2 = dw_alumnos_egresados.retrieve(il_cuenta)
...
boolean enabled = false
string title = "none"
string dataobject = "d_q_egresados"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
