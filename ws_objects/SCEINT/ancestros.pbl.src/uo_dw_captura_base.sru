$PBExportHeader$uo_dw_captura_base.sru
forward
global type uo_dw_captura_base from datawindow
end type
end forward
...
global uo_dw_captura_base uo_dw_captura_base
...
graphicobject lgo_grafico, lgo_grafico2
//tab_page_sol_revalidacion lt_tabpage
//
//lt_tabpage = getparent()
//
lgo_grafico = GetParent()

lgo_grafico2 = lgo_grafico.GetParent()

ventana_propietaria = lgo_grafico2.GetParent()
//
