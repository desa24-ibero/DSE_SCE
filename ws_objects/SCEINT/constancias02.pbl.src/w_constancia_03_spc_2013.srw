$PBExportHeader$w_constancia_03_spc_2013.srw
forward
global type w_constancia_03_spc_2013 from w_master_main
end type
type st_1 from statictext within w_constancia_03_spc_2013
end type
type mle_dirigido_a from multilineedit within w_constancia_03_spc_2013
end type
type st_fecha from statictext within w_constancia_03_spc_2013
end type
type em_fecha from editmask within w_constancia_03_spc_2013
end type
type cb_redactar from commandbutton within w_constancia_03_spc_2013
end type
type mle_texto_libre from multilineedit within w_constancia_03_spc_2013
end type
type st_2 from statictext within w_constancia_03_spc_2013
end type
type st_texto_fecha from statictext within w_constancia_03_spc_2013
end type
type dw_constancia from uo_master_dw within w_constancia_03_spc_2013
end type
type st_numero from statictext within w_constancia_03_spc_2013
end type
type st_decimal from statictext within w_constancia_03_spc_2013
end type
type st_3 from statictext within w_constancia_03_spc_2013
end type
type em_precision_prom from editmask within w_constancia_03_spc_2013
end type
type cb_promedio from commandbutton within w_constancia_03_spc_2013
end type
type uo_nombre from uo_carreras_alumno_lista_const2 within w_constancia_03_spc_2013
end type
type st_version1 from statictext within w_constancia_03_spc_2013
end type
type st_version2 from statictext within w_constancia_03_spc_2013
end type
type uo_pdf from uo_imprime_pdf within w_constancia_03_spc_2013
end type
end forward
...
global w_constancia_03_spc_2013 w_constancia_03_spc_2013
...
on w_constancia_03_spc_2013.create
int iCurrent
call super::create
...
this.Control[iCurrent+16]=this.st_version1
this.Control[iCurrent+17]=this.st_version2
this.Control[iCurrent+18]=this.uo_pdf
end on

on w_constancia_03_spc_2013.destroy
call super::destroy
...
type st_sistema from w_master_main`st_sistema within w_constancia_03_spc_2013
end type

type p_ibero from w_master_main`p_ibero within w_constancia_03_spc_2013
end type
...
ll_renglones = dw_constancia.Retrieve(il_cuenta, ldttm_fecha, ls_dirigido_a, ls_texto2,ld_promedio,&
					ldc_creditos, li_precision,ldc_creditos_totales,li_periodo_actual,li_anio_actual,li_rows_child, li_num_lineas,il_carrera,il_plan, ls_semtrim)  
