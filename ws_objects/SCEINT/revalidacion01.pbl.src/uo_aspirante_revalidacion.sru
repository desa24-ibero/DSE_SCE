$PBExportHeader$uo_aspirante_revalidacion.sru
forward
global type uo_aspirante_revalidacion from userobject
end type
type rb_buscar from radiobutton within uo_aspirante_revalidacion
end type
type rb_edicion from radiobutton within uo_aspirante_revalidacion
end type
type st_2 from statictext within uo_aspirante_revalidacion
end type
type st_1 from statictext within uo_aspirante_revalidacion
end type
type st_nombre from statictext within uo_aspirante_revalidacion
end type
type st_amaterno from statictext within uo_aspirante_revalidacion
end type
type st_apaterno from statictext within uo_aspirante_revalidacion
end type
type em_nombre from editmask within uo_aspirante_revalidacion
end type
type em_amaterno from editmask within uo_aspirante_revalidacion
end type
type em_apaterno from editmask within uo_aspirante_revalidacion
end type
type em_folio from editmask within uo_aspirante_revalidacion
end type
type em_digito from editmask within uo_aspirante_revalidacion
end type
type em_cuenta from editmask within uo_aspirante_revalidacion
end type
type rr_1 from roundrectangle within uo_aspirante_revalidacion
end type
end forward
...
global uo_aspirante_revalidacion uo_aspirante_revalidacion

type variables
str_aspi_alum_revalid istr_aspirante_limpia
...
STRING is_confirmacion_nuevo
end variables

event ue_reinicia_objeto();// Se reinician las variables de instancia para una nueva captura.
...
on uo_aspirante_revalidacion.destroy
...
is_confirmacion_nuevo = "N"
if li_resp = 1 then

	is_confirmacion_nuevo = "S"
...
SELECT dbo.aspirantes_revalidacion.folio,  dbo.aspirantes_revalidacion.tipo_periodo 
...
// Se valida el tipo de periodo. 
IF ls_tipo_periodo <> gs_tipo_periodo THEN 
	MessageBox("Error", "El folio escrito no corresponde a una cuenta que no es de tipo " + gs_descripcion_tipo_periodo, StopSign!) 
	this.Text = ""
	ii_moviendo_folio= 0
	ii_folio_valido = 0
	return	
...
// Se verifica el tipo de periodo de la cuenta.
STRING ls_tipo_periodo
ls_tipo_periodo = f_obten_tipo_periodo_cuenta(ll_cuenta_busqueda) 
IF ls_tipo_periodo <> gs_tipo_periodo THEN 
   MessageBox("Error", "Esta cuenta no pertenece a un tipo de periodo " + gs_descripcion_tipo_periodo, StopSign!) 
	this.Text = ""
	em_digito.Text = ""
	em_digito.Enabled = false
	ii_moviendo_cuenta= 0
