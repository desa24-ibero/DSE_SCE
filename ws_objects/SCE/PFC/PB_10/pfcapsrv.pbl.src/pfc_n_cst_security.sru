...
//			Modificado por FMC para optimizar la seguridad /*C1*/
//			Imprementado por Antonio Pica Ruiz en las PFC's de PB 10
//////////////////////////////////////////////////////////////////////////////
//
//	Copyright © 1996-1997 Sybase, Inc. and its subsidiaries.  All rights reserved.
//	Any distribution of the PowerBuilder Foundation Classes (PFC)
...
//Modificaciones para quitarle lo leentoooo FMC 08101999 /*C1*/
/*C1*/datastore lds_security_info
/*C1*/int li_ret
/*C1*/lds_security_info = Create DataStore
/*C1*/lds_security_info.DataObject = "d_security_info"
/*C1*/lds_security_info.SetTransObject(itr_trans)
/*C1*/li_ret = lds_security_info.retrieve(GetApplication().AppName,as_window)
/*C1*/if li_ret < 0 then
/*C1*/	//Error
/*C1*/	return 0
/*C1*/elseif li_ret = 0 then
/*C1*/	//No hay nada a asegurar
/*C1*/	return 0
/*C1*/end if
...
For li_idx = 1 To li_count
	/*C1*/	string ls_find
	/*C1*/	if as_objectname = '' Then
	/*C1*/		ls_find = lower(classname(ao_objects[li_idx]))
	/*C1*/	else
	/*C1*/		ls_find = as_objectname + '.' + lower(classname(ao_objects[li_idx]))
	/*C1*/	end If		
	/*C1*/	ls_find = "control like '"+ls_find+"%'"
	/*C1*/	if lds_security_info.Find(ls_find,1,lds_security_info.RowCount()) > 0 then
	Choose Case typeof(ao_objects[li_idx])
		Case userobject!
