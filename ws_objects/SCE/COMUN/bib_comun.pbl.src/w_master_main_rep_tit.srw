$PBExportHeader$w_master_main_rep_tit.srw
forward
global type w_master_main_rep_tit from w_main
end type
type st_sistema from statictext within w_master_main_rep_tit
end type
type p_ibero from picture within w_master_main_rep_tit
end type
end forward
...
global w_master_main_rep_tit w_master_main_rep_tit
...
on w_master_main_rep_tit.create
int iCurrent
call super::create
...
on w_master_main_rep_tit.destroy
call super::destroy
