$PBExportHeader$uo_planes_sce.sru
forward
global type uo_planes_sce from UserObject
end type
type dw_carrera from datawindow within uo_planes_sce
end type
type vsb_dw_carrera from vscrollbar within uo_planes_sce
end type
type r_3 from rectangle within uo_planes_sce
end type
type cbx_nuevo from checkbox within uo_planes_sce
end type
end forward
...
global uo_planes_sce uo_planes_sce
