$PBExportHeader$w_master_main.srw
forward
global type w_master_main from w_main
end type
type st_sistema from statictext within w_master_main
end type
type p_ibero from picture within w_master_main
end type
end forward
...
global w_master_main w_master_main
