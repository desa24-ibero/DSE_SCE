...
if conecta_bd(itr_sybfinpro,gs_scob,gs_usuario,gs_password)<>1 then
	if conecta_bd(itr_sybfinpro,gs_scaj,gs_usuario,gs_password)<>1 then
		DESTROY itr_sybfinpro
	end if
end if

if conecta_bd(itr_sybcespro,gs_sce,gs_usuario,gs_password)<>1 then
	if conecta_bd(itr_sybcespro,gs_sadm,gs_usuario,gs_password)<>1 then
		if conecta_bd(itr_sybcespro,gs_scred,gs_usuario,gs_password)<>1 then
