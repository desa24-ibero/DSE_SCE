$PBExportHeader$w_rep_prom.srw
forward
global type w_rep_prom from w_ancestral
end type
type cb_1 from commandbutton within w_rep_prom
end type
type st_status_1 from statictext within w_rep_prom
end type
type st_status_2 from statictext within w_rep_prom
end type
type dw_prom_cred_sem from datawindow within w_rep_prom
end type
type dw_1 from datawindow within w_rep_prom
end type
type dw_cortes from uo_dw_reporte within w_rep_prom
end type
type em_usuario from editmask within w_rep_prom
end type
type em_fecha_1 from editmask within w_rep_prom
end type
type em_fecha_2 from editmask within w_rep_prom
end type
type dw_rep_prom_1 from datawindow within w_rep_prom
end type
type dw_rep_banderas from datawindow within w_rep_prom
end type
type uo_1 from uo_per_ani within w_rep_prom
end type
type st_1 from statictext within w_rep_prom
end type
type st_2 from statictext within w_rep_prom
end type
type st_3 from statictext within w_rep_prom
end type
end forward
...
global w_rep_prom w_rep_prom

type variables

end variables

on w_rep_prom.create
int iCurrent
call super::create
...
type p_uia from w_ancestral`p_uia within w_rep_prom
end type
...
event clicked;dw_cortes.retrieve('?', gs_tipo_periodo) 
end event
...
dw_rep_prom_1.retrieve(em_usuario.text,date(em_fecha_1.text),date(em_fecha_2.text), gs_tipo_periodo)
end event
...
*/
st_status_2.text='Terminada la Carga'
dw_rep_banderas.retrieve(3,em_usuario.text,date(em_fecha_1.text),date(em_fecha_2.text), gs_tipo_periodo)
end event
