$PBExportHeader$w_cambio_tipo_periodo_sparl.srw
forward
global type w_cambio_tipo_periodo_sparl from window
end type
type cb_2 from commandbutton within w_cambio_tipo_periodo_sparl
end type
type cb_1 from commandbutton within w_cambio_tipo_periodo_sparl
end type
type dw_tipo_periodo from datawindow within w_cambio_tipo_periodo_sparl
end type
end forward
...
global w_cambio_tipo_periodo_sparl w_cambio_tipo_periodo_sparl

on w_cambio_tipo_periodo_sparl.create
...
on w_cambio_tipo_periodo_sparl.destroy
destroy(this.cb_2)
destroy(this.cb_1)
