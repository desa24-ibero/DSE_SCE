...
//Obtiene la clave del profesor correspondiente
//	>0 Si es un profesor válido
//	 0 Si no es un profesor válido

string ls_cve_profesor
long ll_cve_profesor

ls_cve_profesor= em_cve_profesor.text

if isnumber(ls_cve_profesor) then
