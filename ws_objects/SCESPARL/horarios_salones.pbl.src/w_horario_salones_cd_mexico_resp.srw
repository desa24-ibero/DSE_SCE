$PBExportHeader$w_horario_salones_cd_mexico_resp.srw
forward
global type w_horario_salones_cd_mexico_resp from window
end type
type cb_5 from commandbutton within w_horario_salones_cd_mexico_resp
end type
type cb_4 from commandbutton within w_horario_salones_cd_mexico_resp
end type
type st_3 from statictext within w_horario_salones_cd_mexico_resp
end type
type cb_1 from commandbutton within w_horario_salones_cd_mexico_resp
end type
type cb_2 from commandbutton within w_horario_salones_cd_mexico_resp
end type
type cb_3 from commandbutton within w_horario_salones_cd_mexico_resp
end type
type cb_exportar from commandbutton within w_horario_salones_cd_mexico_resp
end type
type cb_carga from commandbutton within w_horario_salones_cd_mexico_resp
end type
type hpb_4 from hprogressbar within w_horario_salones_cd_mexico_resp
end type
type dw_horario from datawindow within w_horario_salones_cd_mexico_resp
end type
type em_1 from editmask within w_horario_salones_cd_mexico_resp
end type
type dw_horarios_x_salon from datawindow within w_horario_salones_cd_mexico_resp
end type
type cbx_1 from checkbox within w_horario_salones_cd_mexico_resp
end type
type cbx_2 from checkbox within w_horario_salones_cd_mexico_resp
end type
type dw_lista_salones from datawindow within w_horario_salones_cd_mexico_resp
end type
type cbx_todos from checkbox within w_horario_salones_cd_mexico_resp
end type
type st_1 from statictext within w_horario_salones_cd_mexico_resp
end type
type cbx_4 from checkbox within w_horario_salones_cd_mexico_resp
end type
type hpb_1 from hprogressbar within w_horario_salones_cd_mexico_resp
end type
type hpb_2 from hprogressbar within w_horario_salones_cd_mexico_resp
end type
type hpb_3 from hprogressbar within w_horario_salones_cd_mexico_resp
end type
type st_avance1 from statictext within w_horario_salones_cd_mexico_resp
end type
type st_avance2 from statictext within w_horario_salones_cd_mexico_resp
end type
type st_avance3 from statictext within w_horario_salones_cd_mexico_resp
end type
type st_2 from statictext within w_horario_salones_cd_mexico_resp
end type
type dw_salones_x_grupo from datawindow within w_horario_salones_cd_mexico_resp
end type
end forward
...
global w_horario_salones_cd_mexico_resp w_horario_salones_cd_mexico_resp
...
on w_horario_salones_cd_mexico_resp.create
...
on w_horario_salones_cd_mexico_resp.destroy
...
long backcolor = 67108864
string text = "Versión CPH-Tij 22/marzo/2017."
