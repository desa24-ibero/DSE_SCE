$PBExportHeader$w_asigna_salones_resp.srw
forward
global type w_asigna_salones_resp from window
end type
type st_2 from statictext within w_asigna_salones_resp
end type
type st_avance from statictext within w_asigna_salones_resp
end type
type rb_cupo_alumnos from radiobutton within w_asigna_salones_resp
end type
type rb_cupo_salon from radiobutton within w_asigna_salones_resp
end type
type dw_salones from datawindow within w_asigna_salones_resp
end type
type cb_2 from commandbutton within w_asigna_salones_resp
end type
type sle_1 from singlelineedit within w_asigna_salones_resp
end type
type st_porcentaje from statictext within w_asigna_salones_resp
end type
type dw_horario from datawindow within w_asigna_salones_resp
end type
type cbx_1 from checkbox within w_asigna_salones_resp
end type
type cbx_reiniciar_salones from checkbox within w_asigna_salones_resp
end type
type st_grupos_sin_salon from statictext within w_asigna_salones_resp
end type
type hpb_avance_grupos from hprogressbar within w_asigna_salones_resp
end type
type dw_grupos from datawindow within w_asigna_salones_resp
end type
type st_1 from statictext within w_asigna_salones_resp
end type
type st_inicio_fin from statictext within w_asigna_salones_resp
end type
type ddlb_periodos from dropdownlistbox within w_asigna_salones_resp
end type
type dw_activacion_inicio_fin_periodo from datawindow within w_asigna_salones_resp
end type
type gb_1 from groupbox within w_asigna_salones_resp
end type
type gb_2 from groupbox within w_asigna_salones_resp
end type
end forward
...
string title = "Asignación de Salones Ibero-Tijuana                                                                             CPH. Ene/2017"
...
global w_asigna_salones_resp w_asigna_salones_resp
...
on w_asigna_salones_resp.create
...
on w_asigna_salones_resp.destroy
destroy(this.st_2)
