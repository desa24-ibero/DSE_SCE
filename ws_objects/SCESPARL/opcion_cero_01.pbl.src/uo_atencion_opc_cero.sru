$PBExportHeader$uo_atencion_opc_cero.sru
forward
global type uo_atencion_opc_cero from nonvisualobject
end type
end forward

global type uo_atencion_opc_cero from nonvisualobject
end type
global uo_atencion_opc_cero uo_atencion_opc_cero
...
For ll_i=1 To ids_cuentas.RowCount()
	...
	ls_Nivel = "L" /*Se selecciona el nivel del alumno */ 
	...
	IF gtr_sce.SQLCODE < 0 THEN 
		MESSAGEBOX("Error", "Se produjo un error al recuperar el nivel de la cuenta " + STRING(ll_Cuenta) + ": " + gtr_sce.SQLERRTEXT) 
		RETURN -1
	END IF 
...
//and	c.nivel = "L" /*Condicoón original 09_01_2017*/
...
/*Conción Original and	c.nivel = "L" 09_01_2017*/
...
on uo_atencion_opc_cero.create
call super::create
TriggerEvent( this, "constructor" )
end on

on uo_atencion_opc_cero.destroy
