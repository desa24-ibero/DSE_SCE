...
type cb_genera_esquema from commandbutton within w_prueba_opc_cero
end type
...
type cb_no_egresados from commandbutton within w_prueba_opc_cero
end type
...
this.Control[]={this.cb_genera_esquema,&
...
ids_tramites_inscritos.dataobject = "d_cuentas_revision_estudios_no_egre"
