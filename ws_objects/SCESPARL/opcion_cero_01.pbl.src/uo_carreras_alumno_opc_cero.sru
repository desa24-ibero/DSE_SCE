$PBExportHeader$uo_carreras_alumno_opc_cero.sru
forward
global type uo_carreras_alumno_opc_cero from uo_clave_texto_01
end type
end forward
...
global uo_carreras_alumno_opc_cero uo_carreras_alumno_opc_cero
...
on uo_carreras_alumno_opc_cero.create
call super::create
end on

on uo_carreras_alumno_opc_cero.destroy
call super::destroy
end on

type dw_1 from uo_clave_texto_01`dw_1 within uo_carreras_alumno_opc_cero
integer x = 0
integer y = 0
integer width = 2286
integer height = 96
string dataobject = "duo_carreras_plan"
end type
