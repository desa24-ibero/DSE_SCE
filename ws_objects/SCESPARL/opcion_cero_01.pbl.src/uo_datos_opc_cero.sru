$PBExportHeader$uo_datos_opc_cero.sru
forward
global type uo_datos_opc_cero from userobject
end type
type cb_elegir from commandbutton within uo_datos_opc_cero
end type
type st_3 from statictext within uo_datos_opc_cero
end type
type uo_carreras_alumno_i from uo_carreras_alumno_opc_cero within uo_datos_opc_cero
end type
type uo_nombre_alumno_i from uo_nombre_alumno_opc_cero within uo_datos_opc_cero
end type
end forward
...
global uo_datos_opc_cero uo_datos_opc_cero
