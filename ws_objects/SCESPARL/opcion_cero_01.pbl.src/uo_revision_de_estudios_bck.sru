$PBExportHeader$uo_revision_de_estudios_bck.sru
forward
global type uo_revision_de_estudios_bck from nonvisualobject
end type
end forward

global type uo_revision_de_estudios_bck from nonvisualobject
end type
global uo_revision_de_estudios_bck uo_revision_de_estudios_bck
...
Integer	li_cve_Carrera,li_cve_Plan,li_Sub,li_CredCur,li_Cont = 0,li_NumArchivo,li_PEgre =9
...
on uo_revision_de_estudios_bck.create
call super::create
TriggerEvent( this, "constructor" )
end on

on uo_revision_de_estudios_bck.destroy
