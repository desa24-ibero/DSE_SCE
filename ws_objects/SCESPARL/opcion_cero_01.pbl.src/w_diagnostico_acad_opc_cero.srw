$PBExportHeader$w_diagnostico_acad_opc_cero.srw
forward
global type w_diagnostico_acad_opc_cero from w_response
end type
type cb_cerrar from u_cb within w_diagnostico_acad_opc_cero
end type
type cb_imprimir from u_cb within w_diagnostico_acad_opc_cero
end type
type dw_diagnostico from u_dw within w_diagnostico_acad_opc_cero
end type
end forward
...
global w_diagnostico_acad_opc_cero w_diagnostico_acad_opc_cero

type variables
str_alumno_opc_cero ist_parametros
end variables

on w_diagnostico_acad_opc_cero.create
int iCurrent
call super::create
...
on w_diagnostico_acad_opc_cero.destroy
call super::destroy
