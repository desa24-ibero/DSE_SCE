$PBExportHeader$w_cambio_periodo_primer_ingreso_2014.srw
forward
global type w_cambio_periodo_primer_ingreso_2014 from w_main
end type
type st_sistema from statictext within w_cambio_periodo_primer_ingreso_2014
end type
type p_ibero from picture within w_cambio_periodo_primer_ingreso_2014
end type
type st_periodo_establecido_destino from statictext within w_cambio_periodo_primer_ingreso_2014
end type
type cb_establece_periodo_destino from u_cb within w_cambio_periodo_primer_ingreso_2014
end type
type st_periodo_establecido_origen from statictext within w_cambio_periodo_primer_ingreso_2014
end type
type cb_establece_periodo_origen from u_cb within w_cambio_periodo_primer_ingreso_2014
end type
type uo_2 from uo_per_ani_visual within w_cambio_periodo_primer_ingreso_2014
end type
type uo_1 from uo_per_ani_visual within w_cambio_periodo_primer_ingreso_2014
end type
type st_2 from u_st within w_cambio_periodo_primer_ingreso_2014
end type
type st_1 from u_st within w_cambio_periodo_primer_ingreso_2014
end type
type cb_3 from u_cb within w_cambio_periodo_primer_ingreso_2014
end type
type st_avance from u_st within w_cambio_periodo_primer_ingreso_2014
end type
type st_procesamiento from u_st within w_cambio_periodo_primer_ingreso_2014
end type
type cb_2 from u_cb within w_cambio_periodo_primer_ingreso_2014
end type
type dw_cortes_cuentas from u_dw within w_cambio_periodo_primer_ingreso_2014
end type
type gb_2 from groupbox within w_cambio_periodo_primer_ingreso_2014
end type
type st_5 from statictext within w_cambio_periodo_primer_ingreso_2014
end type
type st_6 from statictext within w_cambio_periodo_primer_ingreso_2014
end type
type st_3 from statictext within w_cambio_periodo_primer_ingreso_2014
end type
type st_4 from statictext within w_cambio_periodo_primer_ingreso_2014
end type
end forward
...
global w_cambio_periodo_primer_ingreso_2014 w_cambio_periodo_primer_ingreso_2014
...
on w_cambio_periodo_primer_ingreso_2014.create
int iCurrent
call super::create
...
this.Control[iCurrent+3]=this.st_periodo_establecido_destino
this.Control[iCurrent+4]=this.cb_establece_periodo_destino
this.Control[iCurrent+5]=this.st_periodo_establecido_origen
this.Control[iCurrent+6]=this.cb_establece_periodo_origen
...
this.Control[iCurrent+13]=this.st_procesamiento
this.Control[iCurrent+14]=this.cb_2
this.Control[iCurrent+15]=this.dw_cortes_cuentas
...
on w_cambio_periodo_primer_ingreso_2014.destroy
call super::destroy
...
IF li_confirmacion = 1 THEN
	...
	if conecta_bd(gtr_sfeb,"sfeb",gs_usuario,gs_password) = 0 then
		return
	end if
	
	FOR ll_row= 1 TO ll_rowcount
		ll_cuenta = dw_cortes_cuentas.GetItemNumber(ll_row,"academicos_hist_cuenta")
		...
		if li_adeuda_primer_ingreso = 1 then
			dw_cortes_cuentas.SetItem(ll_row, "academicos_hist_periodo_ing", li_periodo_destino)
			dw_cortes_cuentas.SetItem(ll_row, "academicos_hist_anio_ing", li_anio_destino)			
		end if
	NEXT
...
integer height = 1660
integer taborder = 20
string dataobject = "d_cambio_periodo_primer_ingreso_2014"
