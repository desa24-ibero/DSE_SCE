$PBExportHeader$w_asigna_hora_inscripcion_conf_2014.srw
forward
global type w_asigna_hora_inscripcion_conf_2014 from window
end type
type st_sistema from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type p_ibero from picture within w_asigna_hora_inscripcion_conf_2014
end type
type cb_establece_folio_sol from commandbutton within w_asigna_hora_inscripcion_conf_2014
end type
type p_1 from picture within w_asigna_hora_inscripcion_conf_2014
end type
type rb_ingreso from radiobutton within w_asigna_hora_inscripcion_conf_2014
end type
type st_porc3 from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type st_porc2 from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type st_porc1 from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type em_susceptibles from editmask within w_asigna_hora_inscripcion_conf_2014
end type
type cb_susceptibles from commandbutton within w_asigna_hora_inscripcion_conf_2014
end type
type em_cuenta_registros from editmask within w_asigna_hora_inscripcion_conf_2014
end type
type uo_1 from uo_per_ani within w_asigna_hora_inscripcion_conf_2014
end type
type cb_contar from commandbutton within w_asigna_hora_inscripcion_conf_2014
end type
type cb_1 from commandbutton within w_asigna_hora_inscripcion_conf_2014
end type
type rb_todos from radiobutton within w_asigna_hora_inscripcion_conf_2014
end type
type rb_no_preinscritos from radiobutton within w_asigna_hora_inscripcion_conf_2014
end type
type rb_preinscritos from radiobutton within w_asigna_hora_inscripcion_conf_2014
end type
type rb_posgrado from radiobutton within w_asigna_hora_inscripcion_conf_2014
end type
type rb_licenciatura from radiobutton within w_asigna_hora_inscripcion_conf_2014
end type
type st_fecha from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type em_calendar from u_em within w_asigna_hora_inscripcion_conf_2014
end type
type rb_normal from radiobutton within w_asigna_hora_inscripcion_conf_2014
end type
type rb_altas from radiobutton within w_asigna_hora_inscripcion_conf_2014
end type
type p_uia from picture within w_asigna_hora_inscripcion_conf_2014
end type
type cb_ok from commandbutton within w_asigna_hora_inscripcion_conf_2014
end type
type em_total3 from editmask within w_asigna_hora_inscripcion_conf_2014
end type
type em_total2 from editmask within w_asigna_hora_inscripcion_conf_2014
end type
type em_total1 from editmask within w_asigna_hora_inscripcion_conf_2014
end type
type st_6 from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type st_dia_3 from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type st_dia2 from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type st_dia1 from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type cbx_predeterminados from checkbox within w_asigna_hora_inscripcion_conf_2014
end type
type em_porc_2 from editmask within w_asigna_hora_inscripcion_conf_2014
end type
type em_porc_3 from editmask within w_asigna_hora_inscripcion_conf_2014
end type
type em_porc_1 from editmask within w_asigna_hora_inscripcion_conf_2014
end type
type st_4 from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type st_hora_actual from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type st_cont from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type st_3 from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type cb_limpiar from commandbutton within w_asigna_hora_inscripcion_conf_2014
end type
type cb_eliminar from commandbutton within w_asigna_hora_inscripcion_conf_2014
end type
type cb_insertar from commandbutton within w_asigna_hora_inscripcion_conf_2014
end type
type lb_dias_inscripcion from listbox within w_asigna_hora_inscripcion_conf_2014
end type
type cb_agregar from commandbutton within w_asigna_hora_inscripcion_conf_2014
end type
type em_hora_fin from editmask within w_asigna_hora_inscripcion_conf_2014
end type
type em_hora_ini from editmask within w_asigna_hora_inscripcion_conf_2014
end type
type st_2 from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type st_1 from statictext within w_asigna_hora_inscripcion_conf_2014
end type
type cb_ejecuta from commandbutton within w_asigna_hora_inscripcion_conf_2014
end type
type gb_preinscripcion from groupbox within w_asigna_hora_inscripcion_conf_2014
end type
type gb_grado from groupbox within w_asigna_hora_inscripcion_conf_2014
end type
type gb_1 from groupbox within w_asigna_hora_inscripcion_conf_2014
end type
type gb_porcent from groupbox within w_asigna_hora_inscripcion_conf_2014
end type
type gb_disponibilidad from groupbox within w_asigna_hora_inscripcion_conf_2014
end type
type gb_seleccionados from groupbox within w_asigna_hora_inscripcion_conf_2014
end type
end forward
...
global w_asigna_hora_inscripcion_conf_2014 w_asigna_hora_inscripcion_conf_2014
...
on w_asigna_hora_inscripcion_conf_2014.create
...
on w_asigna_hora_inscripcion_conf_2014.destroy
...
ds_alumnos.dataobject	=	"d_asigna_hora_insc_nvo_2014"
...
IF f_foliar_horario_solicitudes_2014(ls_cve_criterio,gi_periodo, gi_anio)	= -1 THEN
