$PBExportHeader$w_revision_estudios_masiva_2014.srw
forward
global type w_revision_estudios_masiva_2014 from w_master_main
end type
type uo_nombre from uo_carreras_alumno_lista within w_revision_estudios_masiva_2014
end type
type cb_3 from commandbutton within w_revision_estudios_masiva_2014
end type
type cb_genera_esquema from commandbutton within w_revision_estudios_masiva_2014
end type
type cb_total from commandbutton within w_revision_estudios_masiva_2014
end type
type cb_no_egresados from commandbutton within w_revision_estudios_masiva_2014
end type
type cb_2 from commandbutton within w_revision_estudios_masiva_2014
end type
type sle_registros_procesados from singlelineedit within w_revision_estudios_masiva_2014
end type
type st_1 from statictext within w_revision_estudios_masiva_2014
end type
type sle_inicial from singlelineedit within w_revision_estudios_masiva_2014
end type
type st_2 from statictext within w_revision_estudios_masiva_2014
end type
type st_final from statictext within w_revision_estudios_masiva_2014
end type
type sle_final from singlelineedit within w_revision_estudios_masiva_2014
end type
type gb_1 from groupbox within w_revision_estudios_masiva_2014
end type
end forward
...
global w_revision_estudios_masiva_2014 w_revision_estudios_masiva_2014

type variables
long il_cuenta,il_carrera,il_plan
u_datastore ids_tramites_inscritos , ids_no_egresados, ids_total, ids_incremental
end variables
...
ids_tramites_inscritos = CREATE u_datastore
...
on w_revision_estudios_masiva_2014.create
int iCurrent
call super::create
...
this.Control[iCurrent+3]=this.cb_genera_esquema
this.Control[iCurrent+4]=this.cb_total
this.Control[iCurrent+5]=this.cb_no_egresados
this.Control[iCurrent+6]=this.cb_2
this.Control[iCurrent+7]=this.sle_registros_procesados
this.Control[iCurrent+8]=this.st_1
this.Control[iCurrent+9]=this.sle_inicial
this.Control[iCurrent+10]=this.st_2
this.Control[iCurrent+11]=this.st_final
this.Control[iCurrent+12]=this.sle_final
this.Control[iCurrent+13]=this.gb_1
end on

on w_revision_estudios_masiva_2014.destroy
call super::destroy
...
type st_sistema from w_master_main`st_sistema within w_revision_estudios_masiva_2014
end type

type p_ibero from w_master_main`p_ibero within w_revision_estudios_masiva_2014
end type
