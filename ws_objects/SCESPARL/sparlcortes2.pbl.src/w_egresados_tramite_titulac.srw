$PBExportHeader$w_egresados_tramite_titulac.srw
...
forward
global type w_egresados_tramite_titulac from w_ancestral
end type
type st_ultimacuenta from statictext within w_egresados_tramite_titulac
end type
type st_6 from statictext within w_egresados_tramite_titulac
end type
type st_update from statictext within w_egresados_tramite_titulac
end type
type st_5 from statictext within w_egresados_tramite_titulac
end type
type st_fin from statictext within w_egresados_tramite_titulac
end type
type st_inicio from statictext within w_egresados_tramite_titulac
end type
type st_4 from statictext within w_egresados_tramite_titulac
end type
type st_3 from statictext within w_egresados_tramite_titulac
end type
type st_2 from statictext within w_egresados_tramite_titulac
end type
type st_status from statictext within w_egresados_tramite_titulac
end type
type st_1 from statictext within w_egresados_tramite_titulac
end type
type st_status1 from statictext within w_egresados_tramite_titulac
end type
type cb_tramite_de_titulacion from commandbutton within w_egresados_tramite_titulac
end type
type uo_1 from uo_per_ani within w_egresados_tramite_titulac
end type
end forward
...
integer width = 2075
integer height = 964
string title = "Trámite de Titulación"
...
cb_tramite_de_titulacion cb_tramite_de_titulacion
uo_1 uo_1
end type
global w_egresados_tramite_titulac w_egresados_tramite_titulac
...
in_CredMin[AMaOp] = dw_revision.getitemnumber(AMaOp,"minimos")
in_CredMin[AMeOp] = dw_revision.getitemnumber(AMeOp,"minimos")

in_TotCred[AMaOp] = dw_revision.getitemnumber(AMaOp,"cursados")
in_TotCred[AMeOp] = dw_revision.getitemnumber(AMeOp,"cursados")

If f_actualiza_creditos_revision(l_cuenta, l_carrera, l_plan, in_CredMin , in_TotCred )= -1 THEN
	RETURN FALSE	
else
	return true
end if
...
on w_egresados_tramite_titulac.create
int iCurrent
call super::create
...
this.cb_tramite_de_titulacion=create cb_tramite_de_titulacion
...
this.Control[iCurrent+13]=this.cb_tramite_de_titulacion
this.Control[iCurrent+14]=this.uo_1
end on

on w_egresados_tramite_titulac.destroy
call super::destroy
...
destroy(this.cb_tramite_de_titulacion)
destroy(this.uo_1)
end on

type p_uia from w_ancestral`p_uia within w_egresados_tramite_titulac
end type
...
fontfamily fontfamily = swiss!
string facename = "Arial"
string text = "Trámite de Titulación"
end type
...
dw_cuentas.DataObject = "d_cuentas_tramite_titulac"
...
ll_num_alumnos= dw_cuentas.Retrieve() 
