$PBExportHeader$w_cortes.srw
$PBExportComments$Cambia el Status a Aceptado o Rechazado según las líneas de corte
forward
global type w_cortes from Window
end type
type em_max from editmask within w_cortes
end type
type em_min from editmask within w_cortes
end type
type st_1 from statictext within w_cortes
end type
type dw_1 from datawindow within w_cortes
end type
type cb_1 from commandbutton within w_cortes
end type
type uo_1 from uo_ver_per_ani within w_cortes
end type
end forward
