$PBExportHeader$w_enlace_anterior.srw
forward
global type w_enlace_anterior from Window
end type
type st_1 from statictext within w_enlace_anterior
end type
type dw_2 from datawindow within w_enlace_anterior
end type
type dw_1 from uo_dw_reporte within w_enlace_anterior
end type
type uo_1 from uo_ver_per_ani within w_enlace_anterior
end type
type em_max from editmask within w_enlace_anterior
end type
type em_min from editmask within w_enlace_anterior
end type
end forward
...
global w_enlace_anterior w_enlace_anterior
...
event lee_dw_2;			al_mat=dw_2.object.cve_mat[cont_2]
			al_grupo=dw_2.object.gpo[cont_2]
