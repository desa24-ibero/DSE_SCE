$PBExportHeader$w_lis_asp_ant.srw
forward
global type w_lis_asp_ant from window
end type
type dw_fecha_examen from datawindow within w_lis_asp_ant
end type
type st_3 from statictext within w_lis_asp_ant
end type
type cbx_por_fecha from checkbox within w_lis_asp_ant
end type
type uo_tipo_periodo_ing from uo_tipo_periodo within w_lis_asp_ant
end type
type cbx_departamentos from checkbox within w_lis_asp_ant
end type
type cbx_coordinacion from checkbox within w_lis_asp_ant
end type
type cb_9 from commandbutton within w_lis_asp_ant
end type
type cbx_bachillera from checkbox within w_lis_asp_ant
end type
type cbx_division from checkbox within w_lis_asp_ant
end type
type cbx_carrera from checkbox within w_lis_asp_ant
end type
type uo_2 from uo_carrera within w_lis_asp_ant
end type
type uo_1 from uo_ver_per_ani within w_lis_asp_ant
end type
type dw_1 from uo_dw_reporte within w_lis_asp_ant
end type
end forward
...
global w_lis_asp_ant w_lis_asp_ant
