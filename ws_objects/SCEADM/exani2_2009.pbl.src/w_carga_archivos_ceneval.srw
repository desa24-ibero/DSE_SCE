$PBExportHeader$w_carga_archivos_ceneval.srw
forward
global type w_carga_archivos_ceneval from w_main
end type
type cbx_utiliza_query from u_cbx within w_carga_archivos_ceneval
end type
type mle_query from multilineedit within w_carga_archivos_ceneval
end type
type cb_5 from u_cb within w_carga_archivos_ceneval
end type
type st_num_insertados from u_st within w_carga_archivos_ceneval
end type
type st_num_consultados from u_st within w_carga_archivos_ceneval
end type
type cb_4 from u_cb within w_carga_archivos_ceneval
end type
type cb_3 from u_cb within w_carga_archivos_ceneval
end type
type uo_1 from uo_ver_per_ani within w_carga_archivos_ceneval
end type
type dw_resultado_archivo_exani_2 from u_dw within w_carga_archivos_ceneval
end type
type cb_2 from u_cb within w_carga_archivos_ceneval
end type
type lb_nombre_tablas from u_lb within w_carga_archivos_ceneval
end type
type cb_1 from u_cb within w_carga_archivos_ceneval
end type
type cb_copia_archivos from u_cb within w_carga_archivos_ceneval
end type
type lb_nombre_archivos from u_lb within w_carga_archivos_ceneval
end type
type lb_ruta_archivos from u_lb within w_carga_archivos_ceneval
end type
type mle_selected from u_mle within w_carga_archivos_ceneval
end type
type cb_carga_archivos from u_cb within w_carga_archivos_ceneval
end type
type dw_resultados_archivo_ceneval from u_dw within w_carga_archivos_ceneval
end type
type gb_1 from u_gb within w_carga_archivos_ceneval
end type
end forward
...
global w_carga_archivos_ceneval w_carga_archivos_ceneval

on w_carga_archivos_ceneval.create
int iCurrent
call super::create
...
this.Control[iCurrent+1]=this.cbx_utiliza_query
this.Control[iCurrent+2]=this.mle_query
this.Control[iCurrent+3]=this.cb_5
this.Control[iCurrent+4]=this.st_num_insertados
this.Control[iCurrent+5]=this.st_num_consultados
this.Control[iCurrent+6]=this.cb_4
this.Control[iCurrent+7]=this.cb_3
this.Control[iCurrent+8]=this.uo_1
this.Control[iCurrent+9]=this.dw_resultado_archivo_exani_2
this.Control[iCurrent+10]=this.cb_2
this.Control[iCurrent+11]=this.lb_nombre_tablas
this.Control[iCurrent+12]=this.cb_1
this.Control[iCurrent+13]=this.cb_copia_archivos
this.Control[iCurrent+14]=this.lb_nombre_archivos
this.Control[iCurrent+15]=this.lb_ruta_archivos
this.Control[iCurrent+16]=this.mle_selected
this.Control[iCurrent+17]=this.cb_carga_archivos
this.Control[iCurrent+18]=this.dw_resultados_archivo_ceneval
this.Control[iCurrent+19]=this.gb_1
end on

on w_carga_archivos_ceneval.destroy
call super::destroy
...
integer li_confirmacion, li_update
...
integer height = 424
integer taborder = 40
string dataobject = "d_resultado_archivo_exani_2"
...
//	 ls_OPC_APLI      = dw_resultados_archivo_ceneval.GetItemString(ll_row, "OPC_APLI")	
//	 ls_TIPO_REG      = dw_resultados_archivo_ceneval.GetItemString(ll_row, "TIPO_REG")	
//	 ls_TIPO_RESP     = dw_resultados_archivo_ceneval.GetItemString(ll_row, "TIPO_RESP")	
////	 ls_CVE_BPM       = dw_resultados_archivo_ceneval.GetItemString(ll_row, "CVE_BPM")	
//	 ls_APLI          = dw_resultados_archivo_ceneval.GetItemString(ll_row, "APLI")	
	 ls_OPC_APLI          = dw_resultados_archivo_ceneval.GetItemString(ll_row, "APLI")	
    ...
    ldttm_FECHA_APLI =datetime(ldt_FECHA_APLI)
	 ...
	 ld_PRLM          = dw_resultados_archivo_ceneval.GetItemDecimal(ll_row, "PRLM")
//	 ld_PMAT_S        = dw_resultados_archivo_ceneval.GetItemDecimal(ll_row, "PMAT_S")
	 ld_PMAT_S        = dw_resultados_archivo_ceneval.GetItemDecimal(ll_row, "PMAT")
	 ld_PRV           = dw_resultados_archivo_ceneval.GetItemDecimal(ll_row, "PRV")
	 ld_PESP				= dw_resultados_archivo_ceneval.GetItemDecimal(ll_row, "PESP")
	 ld_PTIC				= dw_resultados_archivo_ceneval.GetItemDecimal(ll_row, "PTIC")
	 ld_IRLM				= dw_resultados_archivo_ceneval.GetItemDecimal(ll_row, "IRLM")
//	 ld_IMAT_S			= dw_resultados_archivo_ceneval.GetItemDecimal(ll_row, "IMAT_S")
	 ld_IMAT_S			= dw_resultados_archivo_ceneval.GetItemDecimal(ll_row, "IMAT")
	 ld_IRV				= dw_resultados_archivo_ceneval.GetItemDecimal(ll_row, "IRV")
	 ld_IESP				= dw_resultados_archivo_ceneval.GetItemDecimal(ll_row, "IESP")
	 ld_ITIC				= dw_resultados_archivo_ceneval.GetItemDecimal(ll_row, "ITIC")  
...
//Se ponen temporalmente en examen de diagnostico para que no tome el de las areas
	 ...
	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "OPC_APLI",ls_OPC_APLI)	
//	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "TIPO_REG", ls_TIPO_REG)	
//	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "TIPO_RESP", ls_TIPO_RESP)	
//	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "CVE_BPM",ls_CVE_BPM)	
//	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "APLI",ls_APLI)	
	 ...
	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "PRLM",ld_PRLM)
	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "PMAT_S",ld_PMAT_S)
	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "PRV",ld_PRV)
	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "PESP",ld_PESP)
	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "PTIC",ld_PTIC)
	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "IRLM",ld_IRLM)
	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "IMAT_S",ld_IMAT_S)
	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "IRV",ld_IRV)
	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "IESP",ld_IESP)
	 dw_resultado_archivo_exani_2.SetItem(ll_row_insertado, "ITIC",ld_ITIC)  
...
if ll_rows_version>0 then
	...
	if li_borra_todo = -1 then
		MessageBox("Error de Eliminación", "No esposible eliminar los registros existentes", StopSign!)
		return
	end if 
...
integer height = 424
integer taborder = 10
string dataobject = "d_exani_2_dbf_nuevo_formato"
boolean hscrollbar = true
end type
