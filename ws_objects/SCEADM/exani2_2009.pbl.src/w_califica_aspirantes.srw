$PBExportHeader$w_califica_aspirantes.srw
...
forward
global type w_califica_aspirantes from w_main
end type
type dw_resultado_examen_modulo_cons from u_dw within w_califica_aspirantes
end type
type dw_modulo_examen from u_dw within w_califica_aspirantes
end type
type dw_resultado_examen_modulo from u_dw within w_califica_aspirantes
end type
type dw_aspiran_pago_examen from u_dw within w_califica_aspirantes
end type
type em_max from editmask within w_califica_aspirantes
end type
type em_min from editmask within w_califica_aspirantes
end type
type st_1 from statictext within w_califica_aspirantes
end type
type cb_califica from commandbutton within w_califica_aspirantes
end type
type uo_1 from uo_ver_per_ani within w_califica_aspirantes
end type
end forward
...
global w_califica_aspirantes w_califica_aspirantes
...
on w_califica_aspirantes.create
int iCurrent
call super::create
...
on w_califica_aspirantes.destroy
call super::destroy
