$PBExportHeader$uo_per_ani_admision.sru
$PBExportComments$Objeto con el que se puede seleccionar: Periodo y Año en cuestión. Modifica variables globales.
forward
global type uo_per_ani_admision from userobject
end type
type em_per from editmask within uo_per_ani_admision
end type
type em_ani from editmask within uo_per_ani_admision
end type
type r_3 from rectangle within uo_per_ani_admision
end type
type cbx_nuevo from checkbox within uo_per_ani_admision
end type
type rr_4 from roundrectangle within uo_per_ani_admision
end type
type rr_5 from roundrectangle within uo_per_ani_admision
end type
end forward
...
global uo_per_ani_admision uo_per_ani_admision
...
on uo_per_ani_admision.destroy
destroy(this.em_per)
destroy(this.em_ani)
destroy(this.r_3)
...
event ue_changed;
ie_periodo = iuo_periodo_servicios.f_recupera_id(text, "L") 
is_periodo = text
