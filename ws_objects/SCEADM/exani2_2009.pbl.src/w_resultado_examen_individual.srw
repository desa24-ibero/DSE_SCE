$PBExportHeader$w_resultado_examen_individual.srw
$PBExportComments$Altas, bajas, despliegue, consulta y modificación de datos básicos de un aspirante.
forward
global type w_resultado_examen_individual from w_main
end type
type cb_4 from commandbutton within w_resultado_examen_individual
end type
type uo_nombre from uo_nombre_aspirante2 within w_resultado_examen_individual
end type
type cb_3 from commandbutton within w_resultado_examen_individual
end type
type cb_1 from commandbutton within w_resultado_examen_individual
end type
type dw_solicitud from datawindow within w_resultado_examen_individual
end type
type cb_2 from commandbutton within w_resultado_examen_individual
end type
type dw_1 from datawindow within w_resultado_examen_individual
end type
type dw_3 from datawindow within w_resultado_examen_individual
end type
type dw_2 from datawindow within w_resultado_examen_individual
end type
end forward
...
global w_resultado_examen_individual w_resultado_examen_individual
...
on w_resultado_examen_individual.create
int iCurrent
call super::create
...
on w_resultado_examen_individual.destroy
call super::destroy
...
integer height = 1072
integer taborder = 40
string dataobject = "d_resultado_examen_modulo_individual"
