$PBExportHeader$w_catalogo_resultados.srw
$PBExportComments$Catálogo de Resultados, con calificaciones
forward
global type w_catalogo_resultados from window
end type
type dw_1 from datawindow within w_catalogo_resultados
end type
type uo_nombre from uo_nombre_aspirante within w_catalogo_resultados
end type
end forward
...
global w_catalogo_resultados w_catalogo_resultados
...
on w_catalogo_resultados.create
...
on w_catalogo_resultados.destroy
...
integer width = 3579
integer height = 1356
string dataobject = "dw_catalogo_resultados"
end type
