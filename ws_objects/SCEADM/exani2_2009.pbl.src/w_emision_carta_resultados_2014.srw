$PBExportHeader$w_emision_carta_resultados_2014.srw
$PBExportComments$Permite elegir que folios se imprimirán las cartas de resultados, los ordena alfabéticamente
forward
global type w_emision_carta_resultados_2014 from w_main
end type
type ddlb_opcion from dropdownlistbox within w_emision_carta_resultados_2014
end type
type dw_2 from datawindow within w_emision_carta_resultados_2014
end type
type uo_1 from uo_ver_per_ani within w_emision_carta_resultados_2014
end type
type em_max from editmask within w_emision_carta_resultados_2014
end type
type em_min from editmask within w_emision_carta_resultados_2014
end type
type dw_1 from uo_dw_reporte within w_emision_carta_resultados_2014
end type
end forward
...
global w_emision_carta_resultados_2014 w_emision_carta_resultados_2014
...
on w_emision_carta_resultados_2014.create
int iCurrent
call super::create
...
on w_emision_carta_resultados_2014.destroy
call super::destroy
...
integer height = 1580
integer taborder = 0
string dataobject = "dw_carta_resultados_2014"
