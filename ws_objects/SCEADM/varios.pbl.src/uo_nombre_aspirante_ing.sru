$PBExportHeader$uo_nombre_aspirante_ing.sru
forward
global type uo_nombre_aspirante_ing from userobject
end type
type uo_tipo_periodo_ing from uo_tipo_periodo within uo_nombre_aspirante_ing
end type
type em_cuenta from editmask within uo_nombre_aspirante_ing
end type
type cbx_nuevo from checkbox within uo_nombre_aspirante_ing
end type
type dw_nombre_aspirante from datawindow within uo_nombre_aspirante_ing
end type
type em_digito from editmask within uo_nombre_aspirante_ing
end type
type st_2 from statictext within uo_nombre_aspirante_ing
end type
type st_1 from statictext within uo_nombre_aspirante_ing
end type
type uo_1 from uo_ver_per_ani within uo_nombre_aspirante_ing
end type
end forward
...
global uo_nombre_aspirante_ing uo_nombre_aspirante_ing
...
on uo_nombre_aspirante_ing.create
...
on uo_nombre_aspirante_ing.destroy
