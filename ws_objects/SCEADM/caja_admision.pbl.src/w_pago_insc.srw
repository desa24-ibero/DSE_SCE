$PBExportHeader$w_pago_insc.srw
$PBExportComments$En esta ventana se puede elegir el FOLIO del aspirante que esta pagando su inscripción.
forward
global type w_pago_insc from Window
end type
type dw_1 from datawindow within w_pago_insc
end type
type uo_nombre from uo_nombre_aspirante within w_pago_insc
end type
end forward
...
string Title="Pagos de Inscripción"
string MenuName="m_menu"
long BackColor=10789024
dw_1 dw_1
uo_nombre uo_nombre
end type
global w_pago_insc w_pago_insc
...
int Height=177
int TabOrder=20
string DataObject="dw_pago_insc"
end type
...
if ModifiedCount() > 0 Then
	...
	if respuesta = 1 then
		...
		hoy=datetime(today(),Time("02:01:00"))
	   UPDATE bita_bachi  
      SET fecha = :hoy,   
          usuario = :gs_usuario  
