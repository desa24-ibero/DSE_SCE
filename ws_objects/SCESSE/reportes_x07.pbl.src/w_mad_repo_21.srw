$PBExportHeader$w_mad_repo_21.srw
$PBExportComments$Ventana para el Reporte de Grupos Asimilados
forward
global type w_mad_repo_21 from w_master_main_rep
end type
type dw_depto_0 from datawindow within w_mad_repo_21
end type
type dw_depto_5 from datawindow within w_mad_repo_21
end type
type dw_depto_4 from datawindow within w_mad_repo_21
end type
type dw_depto_3 from datawindow within w_mad_repo_21
end type
type dw_depto_2 from datawindow within w_mad_repo_21
end type
type dw_depto_1 from datawindow within w_mad_repo_21
end type
type tab_1 from tab within w_mad_repo_21
end type
...
type rb_13 from radiobutton within tabpage_general
end type
type rb_12 from radiobutton within tabpage_general
end type
type rb_11 from radiobutton within tabpage_general
end type
...
type uo_lb_division from uo_pfc_list_box_multiple within w_mad_repo_21
end type
type ddlb_tipo_imp from dropdownlistbox within w_mad_repo_21
end type
type st_2 from statictext within w_mad_repo_21
end type
end forward
...
integer width = 3936
integer height = 2852
string title = "Reporte de Grupos Asimilados"
...
global w_mad_repo_21 w_mad_repo_21
...
this.Control[iCurrent+1]=this.dw_depto_0
this.Control[iCurrent+2]=this.dw_depto_5
this.Control[iCurrent+3]=this.dw_depto_4
this.Control[iCurrent+4]=this.dw_depto_3
this.Control[iCurrent+5]=this.dw_depto_2
this.Control[iCurrent+6]=this.dw_depto_1
this.Control[iCurrent+7]=this.tab_1
this.Control[iCurrent+8]=this.uo_lb_division
this.Control[iCurrent+9]=this.ddlb_tipo_imp
this.Control[iCurrent+10]=this.st_2
end on

on w_mad_repo_21.destroy
call super::destroy
...
type st_sistema from w_master_main_rep`st_sistema within w_mad_repo_21
integer x = 704
integer y = 92
end type

type p_ibero from w_master_main_rep`p_ibero within w_mad_repo_21
integer x = 14
integer y = 8
end type
...
//Utilizado anteriormente para desplegar la informacion en la pantalla
...
integer height = 832
integer taborder = 61
string dataobject = "dw_repo_mad_21_gz"
...
integer taborder = 31
boolean bringtotop = true
string dataobject = "dw_repo_mad_21_gx"
boolean maxbox = true
boolean hscrollbar = true
boolean vscrollbar = true
boolean resizable = true
...
FOR le_index = 1 TO UPPERBOUND(istr_periodos[]) 
	// Si se trata del primer periodo de cada tipo	
	IF THIS.istr_periodos[le_index].periodo = 0 OR THIS.istr_periodos[le_index].periodo = 3 THEN 
		//MESSAGEBOX("CAMBIA", THIS.istr_periodos[le_index].periodo)
		wf_actualiza_lista_coordina(false)
		EXIT 		
	END IF		
NEXT
