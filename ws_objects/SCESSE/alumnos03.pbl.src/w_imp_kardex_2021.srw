$PBExportHeader$w_imp_kardex_2021.srw
$PBExportComments$Se agrega impresion a archivo PDF. 29 Sep 2021. cph
forward
global type w_imp_kardex_2021 from w_master_main
end type
type lds_prueba from datawindow within w_imp_kardex_2021
end type
type lds_revision_est from datawindow within w_imp_kardex_2021
end type
type dw_alumnos_carrera from uo_master_dw within w_imp_kardex_2021
end type
type dw_carreras from uo_master_dw within w_imp_kardex_2021
end type
type uo_nombre from uo_carreras_alumno_lista within w_imp_kardex_2021
end type
type rb_1 from radiobutton within w_imp_kardex_2021
end type
type rb_2 from radiobutton within w_imp_kardex_2021
end type
type gb_1 from groupbox within w_imp_kardex_2021
end type
type gb_2 from groupbox within w_imp_kardex_2021
end type
type dw_preview_kardex from uo_master_dw within w_imp_kardex_2021
end type
type st_version from statictext within w_imp_kardex_2021
end type
type st_version2 from statictext within w_imp_kardex_2021
end type
type uo_pdf from uo_imprime_pdf within w_imp_kardex_2021
end type
end forward
...
global w_imp_kardex_2021 w_imp_kardex_2021
...
this.Control[iCurrent+11]=this.st_version
this.Control[iCurrent+12]=this.st_version2
this.Control[iCurrent+13]=this.uo_pdf
end on

on w_imp_kardex_2021.destroy
call super::destroy
...
dw_preview_kardex.height=this.height - 1050 //cph sept 29 2021
end event
...
event resize;call super::resize;dw_preview_kardex.height=this.height - 1050 //cph sept 29 2021
end event

type st_sistema from w_master_main`st_sistema within w_imp_kardex_2021
integer x = 722
end type

type p_ibero from w_master_main`p_ibero within w_imp_kardex_2021
integer x = 23
integer y = 16
end type
...
if(wf_genera_consulta_kardex(row)=1) then
	uo_pdf.enabled=true
	uo_pdf.inicializa_dw(dw_preview_kardex,"","","98")  // inicializa el uo_pdf para generar PDF cph 29 sept 2021
end if
end event
...
"Se agregrega generación de PDF cph. 29 sept 2021.~r")
