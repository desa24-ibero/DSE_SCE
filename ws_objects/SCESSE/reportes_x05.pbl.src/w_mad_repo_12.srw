$PBExportHeader$w_mad_repo_12.srw
$PBExportComments$Ventana para el Reporte de Alumnos que Adeudan algun Documentos
forward
global type w_mad_repo_12 from window
end type
type dw_pos from datawindow within w_mad_repo_12
end type
type dw_lic from datawindow within w_mad_repo_12
end type
type tab_1 from tab within w_mad_repo_12
end type
...
string title = "Reporte de Alumnos que Adeudan algún Documento"
...
global w_mad_repo_12 w_mad_repo_12
