$PBExportHeader$w_mad_repo_11.srw
$PBExportComments$Ventana para el Reporte de Alumnos Dados de Baja por Adeudo de Documentos
forward
global type w_mad_repo_11 from window
end type
type dw_pos from datawindow within w_mad_repo_11
end type
type dw_lic from datawindow within w_mad_repo_11
end type
type tab_1 from tab within w_mad_repo_11
end type
...
string title = "Reporte de Alumnos Dados De Baja por Adeudo de Documentos"
...
global w_mad_repo_11 w_mad_repo_11
...
integer height = 1088
integer taborder = 16
string dataobject = "dw_repo_mad_11_gy"
...
integer height = 392
integer taborder = 15
string dataobject = "dw_repo_mad_11_gx"
boolean livescroll = true
end type
...
integer height = 1012
integer taborder = 14
string dataobject = "dw_repo_mad_11_gz"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
...
New_SQL_P=New_SQL_P+" ( academicos.cve_carrera = carreras.cve_carrera ) and "+&
						"( academicos.cuenta = banderas.cuenta ) and  "+&
						"( academicos.cuenta = documentos.cuenta ) and  "+&
						"( banderas.baja_documentos = 1 ) "  
...
integer height = 976
integer taborder = 15
string dataobject = "dw_repo_mad_11_ly"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
...
integer height = 316
integer taborder = 14
string dataobject = "dw_repo_mad_11_lx"
boolean livescroll = true
end type
...
integer height = 1268
integer taborder = 63
string dataobject = "dw_repo_mad_11_lz"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
