$PBExportHeader$w_mad_repo_13.srw
$PBExportComments$Ventana para el Reporte de Alumnos que Adeudan algun Documentos
forward
global type w_mad_repo_13 from window
end type
type dw_pos from datawindow within w_mad_repo_13
end type
type dw_lic from datawindow within w_mad_repo_13
end type
type tab_1 from tab within w_mad_repo_13
end type
...
string title = "Reporte de recepción de documentos de Alumnos de nuevo ingreso"
...
global w_mad_repo_13 w_mad_repo_13
...
integer height = 1088
integer taborder = 16
string dataobject = "dw_repo_mad_12_gy"
...
integer height = 392
integer taborder = 15
string dataobject = "dw_repo_mad_12_gx"
boolean livescroll = true
end type
...
integer height = 1012
integer taborder = 14
string dataobject = "dw_repo_mad_12_gz"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
...
//	li_seleccion = lb_carreras_por_coordinacion.ObtenCarreras(li_cve_carreras, li_total_carreras)
   ...
   Nuevo_Select=" DataWindow.Table.Select=' SELECT academicos.cuenta,"+&
	 ...
	 Nuevo_Select_2=" DataWindow.Table.Select=' SELECT DISTINCT"+&
	             " academicos.cuenta,"+&
                " academicos.cve_carrera," +&
                " carreras.carrera"+&
                " FROM academicos,"+&
...
New_SQL_P=New_SQL_P+" AND ( academicos.cuenta = banderas.cuenta ) and "+&
          "( academicos.cuenta = documentos.cuenta ) and "+&
          "( documentos.cve_flag_documento = flag_documentos.cve_flag_documento ) and "+&
          "( documentos.cve_documento = tipo_documento.cve_documento ) " 
/*
//	OSS, 20-Oct-2021. Se quita el ( documentos.cve_flag_documento = 0 ) para que traiga todos los documentos ...
New_SQL_P=New_SQL_P+" AND ( academicos.cuenta = banderas.cuenta ) and "+&
          "( academicos.cuenta = documentos.cuenta ) and "+&
          "( documentos.cve_flag_documento = flag_documentos.cve_flag_documento ) and "+&
          "( documentos.cve_documento = tipo_documento.cve_documento ) and "+&
          "( documentos.cve_flag_documento = 0 ) "  
*/
...
// Encabezado por DEFAULT
New_SQL_P=New_SQL_P+" ( academicos.cve_carrera = carreras.cve_carrera ) and "+&
						"( academicos.cuenta = documentos.cuenta ) and  "+&
						"( documentos.cve_flag_documento = 0 ) " 
...
integer height = 976
integer taborder = 15
string dataobject = "dw_repo_mad_12_ly"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
...
integer height = 316
integer taborder = 14
string dataobject = "dw_repo_mad_12_lx"
boolean livescroll = true
end type
...
integer height = 1268
integer taborder = 63
string dataobject = "dw_repo_mad_12_lz"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
