$PBExportHeader$w_mad_repo_04.srw
$PBExportComments$Ventana para el Reporte de Directorio de Padre - Alumno
forward
global type w_mad_repo_04 from window
end type
type dw_pos from datawindow within w_mad_repo_04
end type
type dw_lic from datawindow within w_mad_repo_04
end type
type tab_1 from tab within w_mad_repo_04
end type
...
string title = "Reporte de Directorio de Padre - Alumno"
...
global w_mad_repo_04 w_mad_repo_04
...
integer height = 396
integer taborder = 16
string dataobject = "dw_repo_mad_04_gy"
boolean livescroll = true
end type
...
integer height = 396
integer taborder = 15
string dataobject = "dw_repo_mad_04_gx"
boolean livescroll = true
end type
...
integer height = 1012
integer taborder = 14
string dataobject = "dw_repo_mad_04_gz"
...
New_SQL_P=New_SQL_P+" WHERE ( academicos.cuenta = padre.cuenta ) and "+&  
          " ( academicos.cve_carrera = carreras.cve_carrera ) and "+&
			 " ( academicos.cuenta = alumnos.cuenta ) and"+&
...
integer height = 316
integer taborder = 15
string dataobject = "dw_repo_mad_04_ly"
boolean livescroll = true
end type
...
integer height = 236
integer taborder = 14
string dataobject = "dw_repo_mad_04_lx"
boolean livescroll = true
end type
...
integer height = 1268
integer taborder = 63
string dataobject = "dw_repo_mad_04_lz"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
