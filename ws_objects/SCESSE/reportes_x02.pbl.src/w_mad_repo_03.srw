$PBExportHeader$w_mad_repo_03.srw
$PBExportComments$Ventana para el Reporte de Directorio de Padres
forward
global type w_mad_repo_03 from window
end type
type dw_pos from datawindow within w_mad_repo_03
end type
type dw_lic from datawindow within w_mad_repo_03
end type
type tab_1 from tab within w_mad_repo_03
end type
...
string title = "Reporte de Directorio de Padres"
...
global w_mad_repo_03 w_mad_repo_03
...
integer height = 448
integer taborder = 16
string dataobject = "dw_repo_mad_03_gy"
boolean livescroll = true
end type
...
integer height = 396
integer taborder = 15
string dataobject = "dw_repo_mad_03_gx"
boolean livescroll = true
end type
...
integer height = 1012
integer taborder = 14
string dataobject = "dw_repo_mad_03_gz"
...
if (rb_1x.checked=TRUE) then
   ...
   dw_2x.setsort("padre_nombre_completo A, academicos_cve_carrera A")
	dw_2x.sort()
	// Se recalcula el grupo
	dw_2x.GroupCalc ( )

   dw_2z.setsort("padre_nombre_completo A, academicos_cve_carrera A")
	dw_2z.sort()
	// Se recalcula el grupo
	dw_2z.GroupCalc ( )
   ...
   if (cbx_2x.checked=TRUE) then
      dw_2x.setsort("academicos_cve_carrera A, padre_nombre_completo A")
		dw_2x.sort()
		// Se recalcula el grupo
		dw_2x.GroupCalc ( )

      dw_2z.setsort("academicos_cve_carrera A, padre_nombre_completo A")
		dw_2z.sort()
		// Se recalcula el grupo
		dw_2z.GroupCalc ( )
...
New_SQL_P=New_SQL_P+" WHERE ( academicos.cuenta = padre.cuenta ) and "+&  
...
integer height = 1004
integer taborder = 15
string dataobject = "dw_repo_mad_03_ly"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
...
integer height = 236
integer taborder = 14
string dataobject = "dw_repo_mad_03_lx"
boolean livescroll = true
end type
...
if (rb_10.checked=TRUE) then
	// Ordenamiento por Alumno
   dw_1x.setsort("padre_nombre_completo A, academicos_cve_carrera A")
	dw_1x.sort()
	// Se recalcula el grupo
	dw_1x.GroupCalc ( )

   dw_1z.setsort("padre_nombre_completo A, academicos_cve_carrera A")
	dw_1z.sort()
	// Se recalcula el grupo
	dw_1z.GroupCalc ( )
   ...
   if (cbx_20.checked=TRUE) then
      dw_1x.setsort("academicos_cve_carrera A, padre_nombre_completo A")
		dw_1x.sort()
		// Se recalcula el grupo
		dw_1x.GroupCalc ( )

      dw_1z.setsort("academicos_cve_carrera A, padre_nombre_completo A")
		dw_1z.sort()
		// Se recalcula el grupo
		dw_1z.GroupCalc ( )
...
integer height = 1268
integer taborder = 63
string dataobject = "dw_repo_mad_03_lz"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
