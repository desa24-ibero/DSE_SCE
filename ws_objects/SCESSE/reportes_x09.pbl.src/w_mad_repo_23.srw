$PBExportHeader$w_mad_repo_23.srw
$PBExportComments$Ventana para el Reporte de Grupos Cancelados
forward
global type w_mad_repo_23 from w_master_main_rep
end type
type tab_1 from tab within w_mad_repo_23
end type
...
type dw_depto_0 from datawindow within w_mad_repo_23
end type
type dw_depto_5 from datawindow within w_mad_repo_23
end type
type dw_depto_4 from datawindow within w_mad_repo_23
end type
type dw_depto_3 from datawindow within w_mad_repo_23
end type
type dw_depto_2 from datawindow within w_mad_repo_23
end type
type dw_depto_1 from datawindow within w_mad_repo_23
end type
type uo_lb_division from uo_pfc_list_box_multiple within w_mad_repo_23
end type
type st_2 from statictext within w_mad_repo_23
end type
type ddlb_tipo_imp from dropdownlistbox within w_mad_repo_23
end type
end forward
...
integer width = 3845
integer height = 2868
string title = "Reporte de Grupos Cancelados"
...
global w_mad_repo_23 w_mad_repo_23
...
type st_sistema from w_master_main_rep`st_sistema within w_mad_repo_23
end type

type p_ibero from w_master_main_rep`p_ibero within w_mad_repo_23
end type
...
integer height = 832
integer taborder = 61
string dataobject = "dw_repo_mad_23_gz"
boolean hscrollbar = true
boolean vscrollbar = true
...
integer taborder = 31
boolean bringtotop = true
string dataobject = "dw_repo_mad_23_gx"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
