$PBExportHeader$w_cambios_de_carrera_nvo_2013_back.srw
forward
global type w_cambios_de_carrera_nvo_2013_back from w_master_main
end type
type dw_prerrequisitos from uo_master_dw within w_cambios_de_carrera_nvo_2013_back
end type
type dw_historico_cambio_carr from uo_master_dw within w_cambios_de_carrera_nvo_2013_back
end type
type dw_revision_est from uo_master_dw within w_cambios_de_carrera_nvo_2013_back
end type
type uo_1 from uo_per_ani within w_cambios_de_carrera_nvo_2013_back
end type
type dw_carreras_cursadas from uo_carreras_alumno within w_cambios_de_carrera_nvo_2013_back
end type
type uo_nombre from uo_nombre_alumno_2013 within w_cambios_de_carrera_nvo_2013_back
end type
type r_3 from rectangle within w_cambios_de_carrera_nvo_2013_back
end type
type r_1 from rectangle within w_cambios_de_carrera_nvo_2013_back
end type
type dw_cam_carr from uo_master_dw within w_cambios_de_carrera_nvo_2013_back
end type
type st_espere from statictext within w_cambios_de_carrera_nvo_2013_back
end type
type st_anio from statictext within w_cambios_de_carrera_nvo_2013_back
end type
type st_per from statictext within w_cambios_de_carrera_nvo_2013_back
end type
type rr_1 from roundrectangle within w_cambios_de_carrera_nvo_2013_back
end type
type rr_2 from roundrectangle within w_cambios_de_carrera_nvo_2013_back
end type
type rr_3 from roundrectangle within w_cambios_de_carrera_nvo_2013_back
end type
end forward
...
global w_cambios_de_carrera_nvo_2013_back w_cambios_de_carrera_nvo_2013_back
...
on w_cambios_de_carrera_nvo_2013_back.create
int iCurrent
call super::create
...
this.Control[iCurrent+9]=this.dw_cam_carr
this.Control[iCurrent+10]=this.st_espere
this.Control[iCurrent+11]=this.st_anio
this.Control[iCurrent+12]=this.st_per
this.Control[iCurrent+13]=this.rr_1
this.Control[iCurrent+14]=this.rr_2
this.Control[iCurrent+15]=this.rr_3
end on

on w_cambios_de_carrera_nvo_2013_back.destroy
call super::destroy
...
event doubleclicked;call super::doubleclicked;int sub_sist,li_baja_disciplina,li_baja_documentos,li_cve_flag_promedio
// Juan Campos.  Abril-1997.
//BEVM 19/06/2013
...
event ue_actualiza;call super::ue_actualiza;// Juan Campos.  	Abril-1997.
...
type st_sistema from w_master_main`st_sistema within w_cambios_de_carrera_nvo_2013_back
integer textsize = -16
end type

type p_ibero from w_master_main`p_ibero within w_cambios_de_carrera_nvo_2013_back
end type
...
event itemchanged;call super::itemchanged;string ls_carrera, ls_columna, ls_plan, ls_nivel,ls_cve_carrera, ls_tper
