$PBExportHeader$uo_nombre_profesor_cupo_coord.sru
forward
global type uo_nombre_profesor_cupo_coord from userobject
end type
type st_1 from statictext within uo_nombre_profesor_cupo_coord
end type
type em_digito from editmask within uo_nombre_profesor_cupo_coord
end type
type st_2 from statictext within uo_nombre_profesor_cupo_coord
end type
type r_2 from rectangle within uo_nombre_profesor_cupo_coord
end type
type dw_nombre_alumno from datawindow within uo_nombre_profesor_cupo_coord
end type
type r_3 from rectangle within uo_nombre_profesor_cupo_coord
end type
type cbx_nuevo from checkbox within uo_nombre_profesor_cupo_coord
end type
type r_1 from rectangle within uo_nombre_profesor_cupo_coord
end type
type em_cve_profesor from editmask within uo_nombre_profesor_cupo_coord
end type
end forward
...
global uo_nombre_profesor_cupo_coord uo_nombre_profesor_cupo_coord
...
on uo_nombre_profesor_cupo_coord.create
...
on uo_nombre_profesor_cupo_coord.destroy
destroy(this.st_1)
