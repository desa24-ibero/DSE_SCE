$PBExportHeader$uo_grupos_cupo_coord2.sru
forward
global type uo_grupos_cupo_coord2 from userobject
end type
type cbx_descuenta_sdu_se from checkbox within uo_grupos_cupo_coord2
end type
type rb_editar from radiobutton within uo_grupos_cupo_coord2
end type
type rb_insertar from radiobutton within uo_grupos_cupo_coord2
end type
type dw_1 from datawindow within uo_grupos_cupo_coord2
end type
end forward
...
global uo_grupos_cupo_coord2 uo_grupos_cupo_coord2
...
string is_gpo= ""
long il_cve_mat
w_grupos_cupo_coord2 w_ventana
...
on uo_grupos_cupo_coord2.create
...
on uo_grupos_cupo_coord2.destroy
...
if isvalid(w_grupos_cupo_coord2) then
	w_ventana  =  w_grupos_cupo_coord2
end if
