...
type dw_pmaterias_clv_mat_syb from datawindow within w_crea_paq_nvo
end type
type dw_tmp_paq_materias from datawindow within w_crea_paq_nvo
end type
type dw_paq_clv_carr_syb from datawindow within w_crea_paq_nvo
end type
type dw_tmp_paq from datawindow within w_crea_paq_nvo
end type
...
this.Control[]={this.dw_pmaterias_clv_mat_syb,&
