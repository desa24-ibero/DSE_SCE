$PBExportHeader$w_cambio_nota_seriacion.srw
...
forward
global type w_cambio_nota_seriacion from window
end type
type dw_aviso_archivo_intercambio from datawindow within w_cambio_nota_seriacion
end type
type dw_aviso_tesoreria_intercambio from datawindow within w_cambio_nota_seriacion
end type
type cb_sancion_cursadas from commandbutton within w_cambio_nota_seriacion
end type
type cb_sancion_inscritas from commandbutton within w_cambio_nota_seriacion
end type
type dw_materias_ligadas_historico from datawindow within w_cambio_nota_seriacion
end type
type cb_cerrar from commandbutton within w_cambio_nota_seriacion
end type
type dw_materias_ligadas_inscritas from datawindow within w_cambio_nota_seriacion
end type
end forward
...
global w_cambio_nota_seriacion w_cambio_nota_seriacion
...
on w_cambio_nota_seriacion.create
...
on w_cambio_nota_seriacion.destroy
...
string dataobject = "d_seriacion_int_historico_prov"
...
string dataobject = "d_seriacion_int_inscritas_prov"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
