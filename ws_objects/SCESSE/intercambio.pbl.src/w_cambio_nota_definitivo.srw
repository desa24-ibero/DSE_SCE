$PBExportHeader$w_cambio_nota_definitivo.srw
...
forward
global type w_cambio_nota_definitivo from w_sheet
end type
type cb_copia_cals from commandbutton within w_cambio_nota_definitivo
end type
type dw_carrera_plan_intercambio from u_dw within w_cambio_nota_definitivo
end type
type p_alumno from picture within w_cambio_nota_definitivo
end type
type uo_cuenta from uo_nombre_alumno within w_cambio_nota_definitivo
end type
type cb_aplicar from commandbutton within w_cambio_nota_definitivo
end type
type cb_salir from commandbutton within w_cambio_nota_definitivo
end type
type cb_refrescar from commandbutton within w_cambio_nota_definitivo
end type
type dw_materias_intercambio from datawindow within w_cambio_nota_definitivo
end type
type uo_foto from uo_foto_alumno_int within w_cambio_nota_definitivo
end type
end forward
...
global w_cambio_nota_definitivo w_cambio_nota_definitivo
...
long		ll_cuenta
long		ll_row_carrera_plan_intercambio, ll_rows
string	ls_inifile
...
on w_cambio_nota_definitivo.create
int iCurrent
call super::create
...
this.Control[iCurrent+1]=this.cb_copia_cals
this.Control[iCurrent+2]=this.dw_carrera_plan_intercambio
this.Control[iCurrent+3]=this.p_alumno
...
on w_cambio_nota_definitivo.destroy
call super::destroy
...
//
//////////////////////////////////////////////////////////////////////////////
integer li_resultado, li_seriacion_intercambio
n_cst_cambio_nota lnv_cambio_nota
any la_data[]
integer li_procesados
long ll_renglon, ll_renglones
...
if lb_hubo_seriada_inscrita or lb_hubo_seriada_cursada then
	...
	openwithparm (w_cambio_nota_seriacion_perm,istr_msgparm)
end if
...
integer taborder = 30
string title = "none"
string dataobject = "d_dca_mat_inscritas_definitivo"
