$PBExportHeader$w_cambio_nota_provisional.srw
...
forward
global type w_cambio_nota_provisional from w_sheet
end type
type cb_copia_cals from commandbutton within w_cambio_nota_provisional
end type
type dw_carrera_plan_intercambio from u_dw within w_cambio_nota_provisional
end type
type p_alumno from picture within w_cambio_nota_provisional
end type
type uo_cuenta from uo_nombre_alumno within w_cambio_nota_provisional
end type
type cb_aplicar from commandbutton within w_cambio_nota_provisional
end type
type cb_salir from commandbutton within w_cambio_nota_provisional
end type
type cb_refrescar from commandbutton within w_cambio_nota_provisional
end type
type dw_materias_intercambio from datawindow within w_cambio_nota_provisional
end type
type uo_foto from uo_foto_alumno_int within w_cambio_nota_provisional
end type
end forward
...
global w_cambio_nota_provisional w_cambio_nota_provisional
...
on w_cambio_nota_provisional.create
int iCurrent
call super::create
...
on w_cambio_nota_provisional.destroy
call super::destroy
...
integer taborder = 30
string title = "none"
string dataobject = "d_dca_mat_inscritas_provisional"
