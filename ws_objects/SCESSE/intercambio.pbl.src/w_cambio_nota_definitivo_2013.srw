$PBExportHeader$w_cambio_nota_definitivo_2013.srw
...
forward
global type w_cambio_nota_definitivo_2013 from w_master_main
end type
type iuo_foto_alumno_blob from uo_foto_alumno_blob within w_cambio_nota_definitivo_2013
end type
type uo_nombre from uo_carreras_alumno_lista within w_cambio_nota_definitivo_2013
end type
type dw_materias_intercambio from uo_master_dw within w_cambio_nota_definitivo_2013
end type
type cb_1 from commandbutton within w_cambio_nota_definitivo_2013
end type
type cb_copia_cals from commandbutton within w_cambio_nota_definitivo_2013
end type
type cb_aplicar from commandbutton within w_cambio_nota_definitivo_2013
end type
end forward
...
integer width = 4238
integer height = 2704
string title = "Cambio de nota definitivo"
...
global w_cambio_nota_definitivo_2013 w_cambio_nota_definitivo_2013
...
on w_cambio_nota_definitivo_2013.create
int iCurrent
call super::create
...
on w_cambio_nota_definitivo_2013.destroy
call super::destroy
...
event open;call super::open;m_menu_general_base_2013.m_imprime.visible = False
m_menu_general_base_2013.m_salvar.visible = False
m_menu_general_base_2013.m_imprime.Toolbaritemvisible = False
m_menu_general_base_2013.m_salvar.Toolbaritemvisible = False
...
type st_sistema from w_master_main`st_sistema within w_cambio_nota_definitivo_2013
end type

type p_ibero from w_master_main`p_ibero within w_cambio_nota_definitivo_2013
end type
...
integer taborder = 11
boolean bringtotop = true
string dataobject = "d_dca_mat_inscritas_definitivo_2013"
end type
...
MessageBox('Aviso', ls_mensaje,Information!)
...
long ll_periodo, ll_anio, ll_cuenta, ll_cve_mat
boolean lb_seriada_inscrita, lb_seriada_cursada, lb_hubo_seriada_inscrita, lb_hubo_seriada_cursada
integer li_transfiere_materia= 0, li_num_transferidas = 0
...
for ll_renglon = 1 to ll_renglones
	...
	li_transfiere_materia =  dw_materias_intercambio.GetItemNumber(ll_renglon, "transfiere_materia")
	
	if li_transfiere_materia = 1 then 
		li_num_transferidas = li_num_transferidas +1
...
//	if la_data[9] = 1 and la_data[10] = 1 then
		...
		li_resultado = lnv_cambio_nota.of_cambio_nota_definitivo(ll_cuenta,ll_cve_mat,ls_calificacion,ll_periodo,ll_anio)
...
if li_num_transferidas = 0 then
	MessageBox("Ninguna materia transferida", "Favor de elegir al menos una materia",StopSign!)
end if
...
if lb_hubo_seriada_inscrita or lb_hubo_seriada_cursada then
	...
	openwithparm (w_cambio_nota_seriacion_perm_2013,istr_msgparm)
end if
