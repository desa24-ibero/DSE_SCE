$PBExportHeader$w_cambio_nota_seriacion_perm_2013.srw
forward
global type w_cambio_nota_seriacion_perm_2013 from w_master_main
end type
type dw_materias_ligadas_inscritas from uo_master_dw within w_cambio_nota_seriacion_perm_2013
end type
type dw_materias_ligadas_historico from uo_master_dw within w_cambio_nota_seriacion_perm_2013
end type
type cb_sancion_inscritas from commandbutton within w_cambio_nota_seriacion_perm_2013
end type
type cb_sancion_cursadas from commandbutton within w_cambio_nota_seriacion_perm_2013
end type
type dw_aviso_tesoreria_intercambio from datawindow within w_cambio_nota_seriacion_perm_2013
end type
type dw_aviso_archivo_intercambio from datawindow within w_cambio_nota_seriacion_perm_2013
end type
end forward
...
global w_cambio_nota_seriacion_perm_2013 w_cambio_nota_seriacion_perm_2013
...
on w_cambio_nota_seriacion_perm_2013.create
int iCurrent
call super::create
...
on w_cambio_nota_seriacion_perm_2013.destroy
call super::destroy
...
// Se recupera la carrera de académicos.
SELECT cve_carrera 
INTO :il_carrera 
FROM academicos 
...
IF gtr_sce.SQLCODE < 0 THEN 
	MESSAGEBOX("Error", "Se produjo un error al recuperar la carrera del alumno: " + gtr_sce.SQLERRTEXT)
END IF
...
type st_sistema from w_master_main`st_sistema within w_cambio_nota_seriacion_perm_2013
end type

type p_ibero from w_master_main`p_ibero within w_cambio_nota_seriacion_perm_2013
end type
...
string dataobject = "d_seriacion_int_inscritas_2013"
end type
...
string dataobject = "d_seriacion_int_historico_2013"
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_aviso_archivo_interc_perm_2013"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
