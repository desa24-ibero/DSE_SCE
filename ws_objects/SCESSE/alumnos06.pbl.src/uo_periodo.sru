...
$PBExportComments$Objeto utilizado para desplegar/capturar el año y el periodo.Para realizar la captura del periodo se lee "uo_#%%/((.periodo"Esta variable entrega un int. Para efectuar la captura del  año se realiza mediante  "uo_#%%/((.año" esta variable entrega un l䅄⩔☀
forward
