$PBExportHeader$w_datosgenerales_tij.srw
forward
global type w_datosgenerales_tij from w_master_main
end type
type st_replica from statictext within w_datosgenerales_tij
end type
type dw_domicilio from uo_master_dw within w_datosgenerales_tij
end type
type uo_nombre from uo_nombre_alumno_2013 within w_datosgenerales_tij
end type
type dw_procedencia from uo_master_dw within w_datosgenerales_tij
end type
type dw_nacimiento from uo_master_dw within w_datosgenerales_tij
end type
type dw_cp from datawindow within w_datosgenerales_tij
end type
end forward
...
global w_datosgenerales_tij w_datosgenerales_tij
...
on w_datosgenerales_tij.create
int iCurrent
call super::create
...
on w_datosgenerales_tij.destroy
call super::destroy
...
type st_sistema from w_master_main`st_sistema within w_datosgenerales_tij
end type

type p_ibero from w_master_main`p_ibero within w_datosgenerales_tij
string picturename = "anEscudo-Logo_Tijuana.png"
end type
...
integer height = 1212
integer taborder = 30
string dataobject = "dw_naci_alumno_tij"
boolean hscrollbar = false
boolean vscrollbar = false
end type
