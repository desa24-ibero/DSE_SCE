$PBExportHeader$w_mad_repo_07.srw
$PBExportComments$Ventana para el Reporte de Etiquetas de Correspondencia
forward
global type w_mad_repo_07 from window
end type
type dw_pos from datawindow within w_mad_repo_07
end type
type dw_lic from datawindow within w_mad_repo_07
end type
type tab_1 from tab within w_mad_repo_07
end type
...
string title = "Etiquetas de Correspondencia para Alumnos"
...
global w_mad_repo_07 w_mad_repo_07
...
integer height = 892
integer taborder = 16
string dataobject = "dw_repo_mad_07_gy"
...
integer height = 1012
integer taborder = 14
string dataobject = "dw_repo_mad_07_gx"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
...
New_SQL_P=New_SQL_P+" WHERE ( academicos.cuenta = alumnos.cuenta ) and "+&  
          ...
          "( domicilio.cve_estado = estados.cve_estado ) "
...
integer height = 860
integer taborder = 15
string dataobject = "dw_repo_mad_07_ly"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
...
integer height = 1368
integer taborder = 63
string dataobject = "dw_repo_mad_07_lx"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
