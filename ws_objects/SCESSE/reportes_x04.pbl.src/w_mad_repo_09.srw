$PBExportHeader$w_mad_repo_09.srw
$PBExportComments$Ventana para el Reporte de Etiquetas de Padres
forward
global type w_mad_repo_09 from window
end type
type dw_pos from datawindow within w_mad_repo_09
end type
type dw_lic from datawindow within w_mad_repo_09
end type
type tab_1 from tab within w_mad_repo_09
end type
...
string title = "Etiquetas de Correspondencia para Padres"
...
global w_mad_repo_09 w_mad_repo_09
...
integer height = 892
integer taborder = 16
string dataobject = "dw_repo_mad_09_gy"
...
integer height = 1012
integer taborder = 14
string dataobject = "dw_repo_mad_09_gx"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
...
// Se coloca el Periodo en la impresión
int periodo,anio
string periodo_2
...
New_SQL_P=New_SQL_P+" WHERE ( academicos.cuenta = padre.cuenta ) and "+&  
          ...
          "( padre.cve_estado = estados.cve_estado ) "
...
integer height = 860
integer taborder = 15
string dataobject = "dw_repo_mad_09_ly"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
...
integer height = 1368
integer taborder = 63
string dataobject = "dw_repo_mad_09_lx"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
...
periodo_2 = luo_periodo_servicios.f_recupera_desc_periodo(gtr_sce, periodo)
