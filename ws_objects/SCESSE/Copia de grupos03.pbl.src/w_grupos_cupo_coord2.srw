...
if ll_num_horarios =0 and li_tipo<>1 and li_tipo<>2 and li_tipo<>4 then
	...
	return -1
elseif ll_num_horarios >0 then		
		if li_tipo=1 then
			MessageBox("Grupo Especial con Horario", "Los grupos por asesoria no pueden tener horario.",StopSign!)
			return -1
		elseif li_tipo=2 then
			MessageBox("Grupo Especial con Horario", "Los grupos asimilados no pueden tener horario.",StopSign!)
			return -1			
		elseif li_tipo=4 then
			MessageBox("Grupo Especial con Horario", "Los grupos en línea no pueden tener horario.",StopSign!)
			return -1			
		end if		
end if
