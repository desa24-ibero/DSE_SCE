...
type uo_periodo from uo_periodo_variable within w_analisis_programacion_grupos
end type
...
Where	pp.cve_proceso = 5 
and 		p.periodo = pp.periodo 
and 		p.tipo = :gs_tipo_periodo
Using		gtr_sce;
...
THIS.uo_periodo.f_selecciona_periodo(ii_periodo, "L")
...
THIS.uo_periodo.f_genera_periodo( gs_tipo_periodo, "H", "L", "L", "N", gtr_sce)
...
//	ls_tipo_periodo = luo_periodo_servicios.ids_periodos_activos.GETITEMSTRING(le_pos, "tipo_periodo") 
	THIS.uo_periodo.f_selecciona_periodo(le_id_periodo, "L")
NEXT 
...
ii_periodo = PARENT.uo_periodo.id_periodo 
is_descripcion_periodo = PARENT.uo_periodo.descripcion
//**--**--**--**--**--**--**--**--**--**--**--**--**--**--**--**--**--**--**
...
Tab_1.Tabpage_division.dw_division.Object.t_reporte.Text = 'REPORTE DE PROGRAMACIÓN DE GRUPOS POR DIVISIÓN, ' + is_descripcion_periodo + ' ' + String ( ii_anio )
Tab_1.Tabpage_departamento.dw_departamento.Object.t_reporte.Text = 'REPORTE DE PROGRAMACIÓN DE GRUPOS POR DEPARTAMENTO, ' + is_descripcion_periodo + ' ' + String ( ii_anio )
Tab_1.Tabpage_coordinacion.dw_coordinacion.Object.t_reporte.Text = 'REPORTE DE PROGRAMACIÓN DE GRUPOS POR COORDINACIÓN, ' + is_descripcion_periodo + ' ' + String ( ii_anio )
...
IF Tab_1.Tabpage_coordinacion.dw_coordinacion.Retrieve ( ii_anio , ii_periodo , ii_cve_dia , ii_clase_aula , li_cve_tipo_grupo_clase [  ] ,li_horario_matutino, li_horario_vespertino, ii_cve_coordinacion, ii_inscritos ) = 0 THEN
...
MessageBox ( "Aviso" , "La información se preparó de forma correcta para el año " + em_anio.Text + " y el periodo " + is_descripcion_periodo  )
...
integer taborder = 30
string title = "none"
string dataobject = "d_bloques_por_dia_coordinacion"
boolean hscrollbar = true
boolean vscrollbar = true
boolean resizable = true
boolean livescroll = true
