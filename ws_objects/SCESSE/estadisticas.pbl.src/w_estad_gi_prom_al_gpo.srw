$PBExportHeader$w_estad_gi_prom_al_gpo.srw
forward
global type w_estad_gi_prom_al_gpo from window
end type
type ddlb_tipo_imp from dropdownlistbox within w_estad_gi_prom_al_gpo
end type
type st_2 from statictext within w_estad_gi_prom_al_gpo
end type
type uo_periodo from uo_periodo_variable_tipos within w_estad_gi_prom_al_gpo
end type
type uo_coordinacion from uo_coordinaciones within w_estad_gi_prom_al_gpo
end type
type gb_coordinacion from groupbox within w_estad_gi_prom_al_gpo
end type
type st_3 from statictext within w_estad_gi_prom_al_gpo
end type
type dw_estadisticas from datawindow within w_estad_gi_prom_al_gpo
end type
type cb_1 from commandbutton within w_estad_gi_prom_al_gpo
end type
type em_anio from editmask within w_estad_gi_prom_al_gpo
end type
type dw_1x from datawindow within w_estad_gi_prom_al_gpo
end type
type gb_8 from groupbox within w_estad_gi_prom_al_gpo
end type
type gb_11 from groupbox within w_estad_gi_prom_al_gpo
end type
type gb_20 from groupbox within w_estad_gi_prom_al_gpo
end type
type gb_1 from groupbox within w_estad_gi_prom_al_gpo
end type
end forward
...
string title = "Estadística de Alumnos por Grupo"
...
global w_estad_gi_prom_al_gpo w_estad_gi_prom_al_gpo
...
on w_estad_gi_prom_al_gpo.create
...
on w_estad_gi_prom_al_gpo.destroy
...
if ii_num_resize > 0 then
	...
	dw_estadisticas.height = newheight - 500
...
integer height = 1212
integer taborder = 80
string dataobject = "d_gi_alumnos_por_grupo"
...
long ll_num_rows, ll_row, ll_num_inscritos, ll_suma_inscritos
real lr_promedio
...
for ll_row = 1 to ll_num_rows
   ll_num_inscritos = this.GetItemNumber(ll_row, "num_grupos")
   ll_suma_inscritos = this.GetItemNumber(ll_row, "suma_inscritos")
	if ll_num_inscritos <> 0 then
	   lr_promedio = ll_suma_inscritos / ll_num_inscritos
		this.Setitem(ll_row, "promedio", lr_promedio)	
	end if
next
