$PBExportHeader$w_actas_en_linea_estatus_back.srw
forward
global type w_actas_en_linea_estatus_back from window
end type
type uo_periodos from uo_per_ani within w_actas_en_linea_estatus_back
end type
type rb_extrao_tit from radiobutton within w_actas_en_linea_estatus_back
end type
type rb_ordinario from radiobutton within w_actas_en_linea_estatus_back
end type
type gb_3 from groupbox within w_actas_en_linea_estatus_back
end type
type cbx_filtra_zz from checkbox within w_actas_en_linea_estatus_back
end type
type rb_mi_coord from radiobutton within w_actas_en_linea_estatus_back
end type
type rb_gpos_coord from radiobutton within w_actas_en_linea_estatus_back
end type
type uo_coordinacion from uo_dgmu_coordinaciones within w_actas_en_linea_estatus_back
end type
type gb_coordinacion from groupbox within w_actas_en_linea_estatus_back
end type
type st_3 from statictext within w_actas_en_linea_estatus_back
end type
type dw_estadisticas from datawindow within w_actas_en_linea_estatus_back
end type
type cb_1 from commandbutton within w_actas_en_linea_estatus_back
end type
type em_anio from editmask within w_actas_en_linea_estatus_back
end type
type rb_otonio from radiobutton within w_actas_en_linea_estatus_back
end type
type rb_verano from radiobutton within w_actas_en_linea_estatus_back
end type
type rb_primavera from radiobutton within w_actas_en_linea_estatus_back
end type
type dw_1x from datawindow within w_actas_en_linea_estatus_back
end type
type gb_8 from groupbox within w_actas_en_linea_estatus_back
end type
type gb_11 from groupbox within w_actas_en_linea_estatus_back
end type
type gb_20 from groupbox within w_actas_en_linea_estatus_back
end type
type gb_2 from groupbox within w_actas_en_linea_estatus_back
end type
type gb_4 from groupbox within w_actas_en_linea_estatus_back
end type
type gb_1 from groupbox within w_actas_en_linea_estatus_back
end type
type uoi_estatus_acta from uo_estatus_acta within w_actas_en_linea_estatus_back
end type
end forward
...
global w_actas_en_linea_estatus_back w_actas_en_linea_estatus_back
...
on w_actas_en_linea_estatus_back.create
...
on w_actas_en_linea_estatus_back.destroy
