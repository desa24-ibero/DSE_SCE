$PBExportHeader$w_analisis_programacion_grupos_orig.srw
forward
global type w_analisis_programacion_grupos_orig from window
end type
type lb_tipo_grupo_clase from listbox within w_analisis_programacion_grupos_orig
end type
type st_tpo_gpo_clase from statictext within w_analisis_programacion_grupos_orig
end type
type ddlb_coordinaciones from dropdownlistbox within w_analisis_programacion_grupos_orig
end type
type st_coordinacion from statictext within w_analisis_programacion_grupos_orig
end type
type ddlb_departamentos from dropdownlistbox within w_analisis_programacion_grupos_orig
end type
type st_departamento from statictext within w_analisis_programacion_grupos_orig
end type
type ddlb_divisiones from dropdownlistbox within w_analisis_programacion_grupos_orig
end type
type st_division from statictext within w_analisis_programacion_grupos_orig
end type
type st_horario_vespertino from statictext within w_analisis_programacion_grupos_orig
end type
type st_horario_matutino from statictext within w_analisis_programacion_grupos_orig
end type
type st_tamanio_bloque_hrs from statictext within w_analisis_programacion_grupos_orig
end type
type st_horario_vesp from statictext within w_analisis_programacion_grupos_orig
end type
type st_horario_mat from statictext within w_analisis_programacion_grupos_orig
end type
type cb_imprimir from commandbutton within w_analisis_programacion_grupos_orig
end type
type cbx_mostrar_porcentajes from checkbox within w_analisis_programacion_grupos_orig
end type
type cb_consultar from commandbutton within w_analisis_programacion_grupos_orig
end type
type cbx_10_o_menos_inscritos from checkbox within w_analisis_programacion_grupos_orig
end type
type ddlb_horario from dropdownlistbox within w_analisis_programacion_grupos_orig
end type
type st_horario from statictext within w_analisis_programacion_grupos_orig
end type
type cb_1 from commandbutton within w_analisis_programacion_grupos_orig
end type
type ddlb_periodo from dropdownlistbox within w_analisis_programacion_grupos_orig
end type
type st_4 from statictext within w_analisis_programacion_grupos_orig
end type
type st_3 from statictext within w_analisis_programacion_grupos_orig
end type
type em_anio from editmask within w_analisis_programacion_grupos_orig
end type
type tab_1 from tab within w_analisis_programacion_grupos_orig
end type
...
type ddlb_clase_aula from dropdownlistbox within w_analisis_programacion_grupos_orig
end type
type st_clase_aula from statictext within w_analisis_programacion_grupos_orig
end type
type st_dia from statictext within w_analisis_programacion_grupos_orig
end type
type ddlb_dias from dropdownlistbox within w_analisis_programacion_grupos_orig
end type
type gb_3 from groupbox within w_analisis_programacion_grupos_orig
end type
type gb_1 from groupbox within w_analisis_programacion_grupos_orig
end type
type gb_2 from groupbox within w_analisis_programacion_grupos_orig
end type
type gb_4 from groupbox within w_analisis_programacion_grupos_orig
end type
type gb_5 from groupbox within w_analisis_programacion_grupos_orig
end type
end forward
...
global w_analisis_programacion_grupos_orig w_analisis_programacion_grupos_orig
...
on w_analisis_programacion_grupos_orig.create
...
on w_analisis_programacion_grupos_orig.destroy
