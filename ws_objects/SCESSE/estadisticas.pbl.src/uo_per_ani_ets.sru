$PBExportHeader$uo_per_ani_ets.sru
$PBExportComments$Objeto con el que se puede seleccionar: Periodo y Año en cuestión. Modifica variables globales.
forward
global type uo_per_ani_ets from userobject
end type
type em_per from editmask within uo_per_ani_ets
end type
type em_ani from editmask within uo_per_ani_ets
end type
type r_3 from rectangle within uo_per_ani_ets
end type
type cbx_nuevo from checkbox within uo_per_ani_ets
end type
type rr_4 from roundrectangle within uo_per_ani_ets
end type
type rr_5 from roundrectangle within uo_per_ani_ets
end type
end forward
...
global uo_per_ani_ets uo_per_ani_ets
