$PBExportHeader$w_matriz_por_asignar.srw
forward
global type w_matriz_por_asignar from window
end type
type cb_1 from commandbutton within w_matriz_por_asignar
end type
type st_destino_coordinacion from statictext within w_matriz_por_asignar
end type
type st_4 from statictext within w_matriz_por_asignar
end type
type st_2 from statictext within w_matriz_por_asignar
end type
type em_salones from editmask within w_matriz_por_asignar
end type
type em_coordinacion from editmask within w_matriz_por_asignar
end type
type dw_sdu_sab from datawindow within w_matriz_por_asignar
end type
type dw_sdu_vie from datawindow within w_matriz_por_asignar
end type
type dw_sdu_jue from datawindow within w_matriz_por_asignar
end type
type dw_sdu_mie from datawindow within w_matriz_por_asignar
end type
type dw_sdu_mar from datawindow within w_matriz_por_asignar
end type
type ddlb_cupo from dropdownlistbox within w_matriz_por_asignar
end type
type st_3 from statictext within w_matriz_por_asignar
end type
type st_nomdepto from statictext within w_matriz_por_asignar
end type
type st_1 from statictext within w_matriz_por_asignar
end type
type em_depto from editmask within w_matriz_por_asignar
end type
type dw_sdu_lun from datawindow within w_matriz_por_asignar
end type
type rr_1 from roundrectangle within w_matriz_por_asignar
end type
type rr_2 from roundrectangle within w_matriz_por_asignar
end type
end forward
...
string title = "MATRIZ DE SALONES POR ASIGNAR"
...
global w_matriz_por_asignar w_matriz_por_asignar
...
on w_matriz_por_asignar.create
...
on w_matriz_por_asignar.destroy
...
event open;// Antonio Pica.      
// Modificado			Mayo 2014
...
integer width = 837
integer height = 1356
string dataobject = "dw_matriz_por_asignar"
