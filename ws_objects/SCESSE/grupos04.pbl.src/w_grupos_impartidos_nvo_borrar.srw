$PBExportHeader$w_grupos_impartidos_nvo_borrar.srw
forward
global type w_grupos_impartidos_nvo_borrar from window
end type
type st_1 from statictext within w_grupos_impartidos_nvo_borrar
end type
type cb_porcentaje_uso from commandbutton within w_grupos_impartidos_nvo_borrar
end type
type dw_profesor_auxiliar from uo_dw_captura within w_grupos_impartidos_nvo_borrar
end type
type uo_3 from uo_nombre_profesor within w_grupos_impartidos_nvo_borrar
end type
type dw_sdw from datawindow within w_grupos_impartidos_nvo_borrar
end type
type dw_horario from uo_dw_captura within w_grupos_impartidos_nvo_borrar
end type
type st_periodo from statictext within w_grupos_impartidos_nvo_borrar
end type
type cb_1 from commandbutton within w_grupos_impartidos_nvo_borrar
end type
type uo_2 from uo_per_ani within w_grupos_impartidos_nvo_borrar
end type
type uo_1 from uo_grupos within w_grupos_impartidos_nvo_borrar
end type
type dw_1 from uo_dw_captura within w_grupos_impartidos_nvo_borrar
end type
end forward
...
global w_grupos_impartidos_nvo_borrar w_grupos_impartidos_nvo_borrar
...
on w_grupos_impartidos_nvo_borrar.create
...
on w_grupos_impartidos_nvo_borrar.destroy
...
Integer HorasReales , le_retorno, le_horas_adic_x_una_mat 
...
/////////////////////////////
// VALIDACIONES RELACIONADAS HASTA AQUI . VALIDACIONES RELACIONADAS HASTA AQUI .VALIDACIONES RELACIONADAS HASTA AQUI .VALIDACIONES RELACIONADAS HASTA AQUI .VALIDACIONES RELACIONADAS HASTA AQUI .
// VALIDACIONES RELACIONADAS HASTA AQUI . VALIDACIONES RELACIONADAS HASTA AQUI .VALIDACIONES RELACIONADAS HASTA AQUI .VALIDACIONES RELACIONADAS HASTA AQUI .VALIDACIONES RELACIONADAS HASTA AQUI .
// VALIDACIONES RELACIONADAS HASTA AQUI . VALIDACIONES RELACIONADAS HASTA AQUI .VALIDACIONES RELACIONADAS HASTA AQUI .VALIDACIONES RELACIONADAS HASTA AQUI .VALIDACIONES RELACIONADAS HASTA AQUI .
// VALIDACIONES RELACIONADAS HASTA AQUI . VALIDACIONES RELACIONADAS HASTA AQUI .VALIDACIONES RELACIONADAS HASTA AQUI .VALIDACIONES RELACIONADAS HASTA AQUI .VALIDACIONES RELACIONADAS HASTA AQUI .
/////////////////////////////
