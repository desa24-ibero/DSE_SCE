$PBExportHeader$uo_per_ani_grupos_mod.sru
$PBExportComments$Objeto con el que se puede seleccionar: Periodo y Año en cuestión. Modifica variables globales.
forward
global type uo_per_ani_grupos_mod from userobject
end type
type em_per from editmask within uo_per_ani_grupos_mod
end type
type em_ani from editmask within uo_per_ani_grupos_mod
end type
type r_3 from rectangle within uo_per_ani_grupos_mod
end type
type cbx_nuevo from checkbox within uo_per_ani_grupos_mod
end type
type rr_4 from roundrectangle within uo_per_ani_grupos_mod
end type
type rr_5 from roundrectangle within uo_per_ani_grupos_mod
end type
end forward
...
global uo_per_ani_grupos_mod uo_per_ani_grupos_mod
...
on uo_per_ani_grupos_mod.create
...
on uo_per_ani_grupos_mod.destroy
destroy(this.em_per)
destroy(this.em_ani)
destroy(this.r_3)
...
event modified;PARENT.TRIGGEREVENT("ue_modifica") 
