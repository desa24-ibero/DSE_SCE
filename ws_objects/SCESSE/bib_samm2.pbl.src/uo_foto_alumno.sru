$PBExportHeader$uo_foto_alumno.sru
...
forward
global type uo_foto_alumno from uo_gvbox
end type
end forward

global type uo_foto_alumno from uo_gvbox
end type
global uo_foto_alumno uo_foto_alumno
...
on uo_foto_alumno.create
call super::create
end on

on uo_foto_alumno.destroy
call super::destroy
end on
...
type ole_1 from uo_gvbox`ole_1 within uo_foto_alumno
end type
