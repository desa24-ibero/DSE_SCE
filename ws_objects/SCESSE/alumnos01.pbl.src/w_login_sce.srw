$PBExportHeader$w_login_sce.srw
forward
global type w_login_sce from window
end type
type st_plantel from statictext within w_login_sce
end type
type st_4 from statictext within w_login_sce
end type
type p_3 from picture within w_login_sce
end type
type st_6 from statictext within w_login_sce
end type
type st_8 from statictext within w_login_sce
end type
type st_ver from statictext within w_login_sce
end type
type st_1 from statictext within w_login_sce
end type
type sle_pass from singlelineedit within w_login_sce
end type
type cb_close from commandbutton within w_login_sce
end type
type cb_login from commandbutton within w_login_sce
end type
type sle_password from singlelineedit within w_login_sce
end type
type sle_userid from singlelineedit within w_login_sce
end type
type st_3 from statictext within w_login_sce
end type
type st_2 from statictext within w_login_sce
end type
type r_1 from rectangle within w_login_sce
end type
end forward
...
global w_login_sce w_login_sce
...
long backcolor = 12632256
boolean enabled = false
string text = "Sistema de Control Escolar PB 12"
alignment alignment = center!
boolean focusrectangle = false
end type
