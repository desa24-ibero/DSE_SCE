$PBExportHeader$w_mad_repo_01.srw
$PBExportComments$Ventana para el Reporte de Directorio de Alumnos
forward
global type w_mad_repo_01 from window
end type
type dw_pos from datawindow within w_mad_repo_01
end type
type dw_lic from datawindow within w_mad_repo_01
end type
type tab_1 from tab within w_mad_repo_01
end type
...
string title = "Reporte de Directorio de Alumnos"
...
global w_mad_repo_01 w_mad_repo_01
...
ll_coordinacion = f_coordinacion_por_usuario(gs_usuario)
tab_1.TabPage_General.lb_carreras_por_coordinacion.inicializa(ll_coordinacion)

IF ll_coordinacion <> 9999 THEN 
	tab_1.TabPage_General.lb_carreras_por_coordinacion.uo_nivel.dw_niveles.setItem(1,"cve_nivel", "S")
	tab_1.TabPage_General.lb_carreras_por_coordinacion.uo_nivel.dw_niveles.event itemchanged(1, dwo, "S")
	tab_1.TabPage_General.lb_carreras_por_coordinacion.cb_agregar_todas.event clicked( )
END IF
...
if ii_num_resize > 0 then
	...
	tab_1.tabpage_general.dw_2z.height = ll_height_dw + ll_dif_height_tab + 700
else
...
integer height = 380
integer taborder = 16
string dataobject = "dw_repo_mad_01_gy"
...
event retrieveend;///*Cuando dw_2y termine de leer los datos de la tabla...*/
//
//
//int li_Index, Carrera_F
//long Total_Renglon
//long Contador
//string Carrera_R
//
//if (dw_2y.rowcount() >= 1) then
//
//   Total_Renglon=dw_2y.rowcount()
//   FOR contador=1 to Total_Renglon	
//		  // Se obtiene el valor de la carrera
//			Carrera_F= dw_2y.GetItemNumber(contador,"academicos_cve_carrera") 
//			// Se mascarea, por razones de ordenamiento de strings, para poder encontrarlo
//			if Carrera_F < 100 then
//				Carrera_R=string(Carrera_F,"###000")
//			else
//				Carrera_R=string(Carrera_F)
//			end if
//	    
//   NEXT
//end if
...
integer height = 396
integer taborder = 15
string dataobject = "dw_repo_mad_01_gx"
boolean livescroll = true
end type
...
integer height = 1052
integer taborder = 14
string dataobject = "dw_repo_mad_01_gz"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
...
if Nuevo_SQL <> "" then
	...
	dw_2z.Reset()
	dw_2y.Reset()   
	int li_cve_carreras[], li_total_carreras, li_i   //li_seleccion, 
	...
	if rc="" then
	   ...
	   // Se Modifica el SQL para Z
		...
		if rc="" then
			...
			dw_2z.retrieve(agrupa,Plan,Carreras,prom_on,cred_on,dir_on)
		else
...
integer height = 252
integer taborder = 15
string dataobject = "dw_repo_mad_01_ly"
boolean livescroll = true
end type
...
integer height = 236
integer taborder = 14
string dataobject = "dw_repo_mad_01_lx"
boolean livescroll = true
end type
...
integer height = 1268
integer taborder = 63
string dataobject = "dw_repo_mad_01_lz"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
