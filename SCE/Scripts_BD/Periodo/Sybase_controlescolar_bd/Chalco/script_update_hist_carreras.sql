...
UPDATE hist_carreras SET periodo_ing_act = 7 -- CUATRIMESTRE 1
WHERE periodo_ing_act = 0
GO
...
UPDATE hist_carreras SET periodo_ing_act = 8 -- CUATRIMESTRE 2
WHERE periodo_ing_act = 1
GO
...
UPDATE hist_carreras SET periodo_ing_act = 9 -- CUATRIMESTRE 3
WHERE periodo_ing_act = 2
GO
