...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_8') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_8
GO

create procedure sp_contactos_ce_preu_8  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--8) El número de contactos por carrera, bachillerato y periodo escolar
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_8 TO g_admisionadm
GO
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_8 TO g_inf_admin
GO
