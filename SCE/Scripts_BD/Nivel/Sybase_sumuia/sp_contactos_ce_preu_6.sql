...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_6') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_6
GO

create procedure sp_contactos_ce_preu_6  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--6) El número de contactos por carrera, tipo de actividad y periodo
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_6 TO g_admisionadm
GO
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_6 TO g_inf_admin
GO
