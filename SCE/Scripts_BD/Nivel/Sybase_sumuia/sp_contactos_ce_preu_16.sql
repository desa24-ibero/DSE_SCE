...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_16') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_16
GO

create procedure sp_contactos_ce_preu_16  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--16)->4) El número de aspirantes por carrera y periodo escolar
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_16 TO g_admisionadm
GO

GRANT EXECUTE ON dbo.sp_contactos_ce_preu_16 TO g_inf_admin
GO
