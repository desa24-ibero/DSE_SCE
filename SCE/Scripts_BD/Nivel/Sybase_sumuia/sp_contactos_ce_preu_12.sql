...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_12') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_12
GO

create procedure sp_contactos_ce_preu_12  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--12) El número de contactos por bachillerato
	...
	GROUP BY saa_aspirantes_ce_preu.cve_escuela,
				saa_aspirantes_ce_preu.escuela  
	ORDER BY saa_aspirantes_ce_preu.escuela  
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_12 TO g_admisionadm
GO

GRANT EXECUTE ON dbo.sp_contactos_ce_preu_12 TO g_inf_admin
GO
