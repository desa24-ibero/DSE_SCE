...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_19') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_19
GO

create procedure sp_contactos_ce_preu_19  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--19)->12) El número de aspirantes por bachillerato
	...
	GROUP BY saa_solo_aspirantes.cve_escuela,
				saa_solo_aspirantes.escuela  
	ORDER BY saa_solo_aspirantes.escuela  
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_19 TO g_admisionadm
GO

GRANT EXECUTE ON dbo.sp_contactos_ce_preu_19 TO g_inf_admin
GO
