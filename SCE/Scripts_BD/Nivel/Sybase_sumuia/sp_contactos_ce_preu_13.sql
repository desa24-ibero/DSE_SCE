...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_13') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_13
GO

create procedure sp_contactos_ce_preu_13  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--13) El número de contactos por periodo y bachillerato
	SELECT num_contactos = COUNT(*),
			saa_aspirantes_ce_preu.clv_per,
			saa_aspirantes_ce_preu.anio,
	...
	GROUP BY saa_aspirantes_ce_preu.clv_per,
				saa_aspirantes_ce_preu.anio,
				saa_aspirantes_ce_preu.cve_escuela,
				saa_aspirantes_ce_preu.escuela  
	ORDER BY saa_aspirantes_ce_preu.clv_per, saa_aspirantes_ce_preu.escuela  
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_13 TO g_admisionadm
GO

GRANT EXECUTE ON dbo.sp_contactos_ce_preu_13 TO g_inf_admin
GO
