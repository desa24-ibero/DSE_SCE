...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_9') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_9
GO

create procedure sp_contactos_ce_preu_9  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--9) El número de contactos por carrera, bachillerato y tipo de actividad
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_9 TO g_admisionadm
GO
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_9 TO g_inf_admin
GO
