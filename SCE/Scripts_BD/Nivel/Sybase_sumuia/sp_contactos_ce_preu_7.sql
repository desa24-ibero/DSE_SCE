...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_7') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_7
GO

create procedure sp_contactos_ce_preu_7  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--7) El número de contactos por carrera y bachillerato
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_7 TO g_admisionadm
GO
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_7 TO g_inf_admin
GO
