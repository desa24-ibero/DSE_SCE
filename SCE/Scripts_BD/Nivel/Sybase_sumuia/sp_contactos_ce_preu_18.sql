...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_18') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_18
GO

create procedure sp_contactos_ce_preu_18  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--18)->8) El número de aspirantes por carrera, bachillerato y periodo escolar
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_18 TO g_admisionadm
GO

GRANT EXECUTE ON dbo.sp_contactos_ce_preu_18 TO g_inf_admin
GO
