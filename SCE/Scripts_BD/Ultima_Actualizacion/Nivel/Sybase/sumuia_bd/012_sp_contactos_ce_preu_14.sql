IF OBJECT_ID ('dbo.sp_contactos_ce_preu_14') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_14
GO

create procedure sp_contactos_ce_preu_14  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--14) El número de contactos por tipo de actividad
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_14 TO g_admisionadm
GO

GRANT EXECUTE ON dbo.sp_contactos_ce_preu_14 TO g_inf_admin
GO
