...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_15') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_15
GO

create procedure sp_contactos_ce_preu_15  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--15)->3) El número de aspirantes por carrera
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_15 TO g_admisionadm
GO

GRANT EXECUTE ON dbo.sp_contactos_ce_preu_15 TO g_inf_admin
GO
