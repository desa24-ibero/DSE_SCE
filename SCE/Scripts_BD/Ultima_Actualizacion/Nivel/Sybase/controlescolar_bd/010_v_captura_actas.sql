IF OBJECT_ID ('dbo.v_captura_actas') IS NOT NULL
	DROP VIEW dbo.v_captura_actas
GO

CREATE VIEW v_captura_actas
AS
SELECT  cve_mat = acta_evaluacion_preeliminar.cve_mat,   
         ...
         nombre_nivel = (SELECT UPPER(nivel) FROM nivel WHERE cve_nivel = acta_evaluacion_preeliminar.nivel), 
...
/*nombre_nivel = CASE acta_evaluacion_preeliminar.nivel WHEN 'L' THEN 'LICENCIATURA'
																					WHEN 'P' THEN 'POSGRADO'
																					ELSE '' END,*/
																					
																					
GRANT SELECT ON dbo.v_captura_actas TO g_coordinaciones
GO
GRANT SELECT ON dbo.v_captura_actas TO inscripcion
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_jef_tit_cert
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_tit_cert_ventanilla
GO
GRANT SELECT ON dbo.v_captura_actas TO g_sfeb_becas
GO
GRANT SELECT ON dbo.v_captura_actas TO g_auditoria_interna
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_administrador
GO
GRANT SELECT ON dbo.v_captura_actas TO g_inf_admin
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_ce_ventanilla
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_ce_atencion
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_jef_admision
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_admision_ventanilla
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_admision_atencion
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_jef_archivo
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_archivo_ventanilla
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_archivo_atencion
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_tit_cert_atencion
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_consultas
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_adse
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_biblioteca
GO
GRANT SELECT ON dbo.v_captura_actas TO g_se_cobranzas
GO
GRANT SELECT ON dbo.v_captura_actas TO g_DataReader
GO
