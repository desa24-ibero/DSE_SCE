...
DELETE FROM plan_puntaje_periodo
WHERE periodo_ing_min < 7

IF @@ERROR = 0 BEGIN
	PRINT 'EXITO: DELETE plan_puntaje_periodo'
END ELSE BEGIN
	PRINT 'ERROR: DELETE plan_puntaje_periodo'
END
GO

DELETE FROM plan_puntaje_periodo
WHERE periodo_ing_max < 7
