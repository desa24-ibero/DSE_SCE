...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_20') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_20
GO

create procedure sp_contactos_ce_preu_20  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--20)->13) El número de aspirantes por periodo y bachillerato
	...
	GROUP BY saa_solo_aspirantes.clv_per,
				saa_solo_aspirantes.anio,
				saa_solo_aspirantes.cve_escuela,
				saa_solo_aspirantes.escuela  
	ORDER BY saa_solo_aspirantes.clv_per, saa_solo_aspirantes.escuela  
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_20 TO g_admisionadm
GO

GRANT EXECUTE ON dbo.sp_contactos_ce_preu_20 TO g_inf_admin
GO
