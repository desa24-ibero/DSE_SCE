...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_3') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_3
GO

create procedure sp_contactos_ce_preu_3  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--3) El número de contactos por carrera
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_3 TO g_admisionadm
GO
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_3 TO g_inf_admin
GO
