...
IF OBJECT_ID ('dbo.sp_contactos_ce_preu_22') IS NOT NULL
	DROP PROCEDURE dbo.sp_contactos_ce_preu_22
GO

create procedure sp_contactos_ce_preu_22  @a_periodo int, @a_anio int, @a_criterio int 
as
...
--22)-->10 El número de contactos por carrera, tipo de actividad, bachillerato y periodo
SELECT num_contactos = COUNT(*),
      ...
      clavetipoactividad,
		...
		saa_aspirantes_ce_preu.Apaterno_asp,
		saa_aspirantes_ce_preu.Amaterno_asp,
		saa_aspirantes_ce_preu.nombre_asp,
		saa_aspirantes_ce_preu.registroaspirante,
		saa_aspirantes_ce_preu.clv_ver,
		saa_aspirantes_ce_preu.folio
...
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_22 TO g_admisionadm
GO
GRANT EXECUTE ON dbo.sp_contactos_ce_preu_22 TO g_inf_admin
GO
