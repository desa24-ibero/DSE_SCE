...
IF OBJECT_ID ('dbo.sp_cambio_nota_relaciones2') IS NOT NULL
	DROP PROCEDURE dbo.sp_cambio_nota_relaciones2
GO

CREATE PROCEDURE dbo.sp_cambio_nota_relaciones2
...
** una materia de intercambio (Parent) contra todas las

** materias que ha cursado o esté cursando un alumno (children)

** y las relaciona por su seriación.

** Parecido a sp_cambio_nota_relaciones1 pero restringido a una
...
GRANT EXECUTE ON dbo.sp_cambio_nota_relaciones2 TO g_inf_admin
GO